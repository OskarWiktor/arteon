...
export class MyFeatureAccessibilityHelp implements IAccessibleViewImplementation {
  ...
  getProvider(accessor: ServicesAccessor) {
    const helpText = [localize('myFeature.help.overview', 'You are in My Feature. …'), localize('myFeature.help.key1', '- {0}: Do something', '<keybinding:myFeature.doSomething>')].join('\n');
