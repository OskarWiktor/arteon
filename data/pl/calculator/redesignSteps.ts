          ...
          options: [
            {
              ...
              value: 'ready-design',
              price: 0,
              tooltip: 'Pracujemy na Twoim gotowym projekcie',
              icon: 'FiCheckCircle',
            },
            {
              label: 'Mam inspiracje',
              value: 'idea-redesign',
              multiplier: 1.2,
              tooltip: 'Zaprojektujemy nowy wygląd na podstawie inspiracji',
              icon: 'FiLightbulb',
            },
            {
              label: 'Potrzebuję nowego projektu',
              value: 'new-redesign',
              multiplier: 1.5,
              tooltip: 'Kompletny redesign dopasowany do marki',
              icon: 'FiEdit3',
            },
          ],
        },
