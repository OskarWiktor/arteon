  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        value: 'copy-help',
        multiplier: 1.1,
        tooltip: 'Poprawiamy tekst dla lepszej widoczności i lepszego odbioru',
        icon: 'FiEdit2',
      },
      {
        label: 'Nie',
        value: 'copy-new',
        multiplier: 1.4,
        tooltip: 'Tworzymy tekst od zera, w oparciu o to czym się zajmujesz',
        icon: 'FiPenTool',
      },
    ],
  },
    ...
    options: [
      {
        ...
        value: 'articles-0',
        price: 0,
        tooltip: 'Wprowadzasz je samodzielnie - my przygotujemy wygląd i funkcje',
        icon: 'FiMinusCircle',
      },
    ...
    options: [
      {
        ...
        price: 100,
        tooltip: 'Lepsza nawigacja i podział treści',
        icon: 'FiTag',
      },
      {
        label: 'Komentarze',
        value: 'comments',
        price: 150,
        tooltip: 'Czytelnicy mogą dyskutować pod wpisami',
        icon: 'FiMessageCircle',
      },
      {
        label: 'Profile autorów',
        value: 'authors',
        price: 100,
        tooltip: 'Pokaż zespół redakcyjny',
        icon: 'FiUser',
      },
      {
        label: 'Wyszukiwarka',
        value: 'search',
        price: 150,
        tooltip: 'Szybkie wyszukiwanie tematów i artykułów',
        icon: 'FiSearch',
      },
      {
        label: 'Płatne treści (paywall)',
        value: 'paywall',
        price: 500,
        tooltip: 'Zarabiaj na blogu dzięki subskrypcjom',
        icon: 'FiLock',
      },
      {
        label: 'Reklamy zewnętrzne',
        value: 'ads',
        price: 300,
        tooltip: 'Dodatkowy przychód z banerów reklamowych',
        icon: 'FiMonitor',
      },
      {
        label: 'Polecane wpisy',
        value: 'related-posts',
        price: 200,
        tooltip: 'Sugestie podobnych treści zwiększają czas na stronie',
        icon: 'FiThumbsUp',
      },
      {
        label: 'Newsletter',
        value: 'newsletter',
        price: 200,
        tooltip: 'Formularz zapisu do bazy mailingowej',
        icon: 'FiMail',
      },
    ],
  },
