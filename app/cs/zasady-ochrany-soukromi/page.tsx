...
export const metadata = {
  ...
  alternates,
  openGraph: { title: meta.title, description: meta.description, url: toAbsoluteUrl('/cs/zasady-ochrany-soukromi'), type: 'website' },
};
      ...
      <Wrapper as="article" id="article-root" itemScope itemType="https://schema.org/Article" className="flex flex-col-reverse gap-8 select-none lg:grid lg:grid-cols-[1fr_300px]">
        <div>
          ...
          <SectionInfo title="1. Spravce dat">
            <p>Spravcem osobnich udaju je Arteon se sidlem v obci Czernichow, Zagacie, ul. Jasminowa 36, 32-070, Polsko.</p>
            <p>
          ...
          <SectionInfo title="2. Rozsah shromazdovanych dat">
            <ul className="list-disc space-y-1 pl-6">
              <li>udaje zadane prostrednictvim kontaktniho formulare (jmeno, prijmeni, e-mail, obsah zpravy),</li>
          ...
          <SectionInfo title="3. Ucely a pravni zaklad zpracovani">
            <ol className="list-decimal space-y-1 pl-6">
              <li>
                <strong>Komunikace se zakaznikem</strong> -- odpovidani na dotazy z kontaktniho formulare (cl. 6 odst. 1 pism. b) a f) GDPR).
              </li>
              <li>
                <strong>Marketing a analytika</strong> -- statistiky webu, optimalizace obsahu (cl. 6 odst. 1 pism. f) GDPR).
              </li>
              <li>
                <strong>Poskytovani sluzeb</strong> -- priprava nabidek, smluv, faktur (cl. 6 odst. 1 pism. b) GDPR).
              </li>
              <li>
                <strong>Pravni povinnosti</strong> -- napr. uchovavani ucetni dokumentace (cl. 6 odst. 1 pism. c) GDPR).
              </li>
              <li>
          ...
          <SectionInfo title="4. Soubory cookie">
            ...
            <ul className="list-disc space-y-1 pl-6">
              ...
              <li>analyza provozu (Google Analytics 4, Ahrefs Web Analytics, Vercel Analytics, Metricool),</li>
          ...
          <SectionInfo title="5. Prijemci dat">
            <p>Data mohou byt sdilena se subjekty, ktere nas podporuji pri poskytovani sluzeb, jako jsou:</p>
            <ul className="list-disc space-y-1 pl-6">
              <li>poskytovatel hostingu/aplikaci (napr. Vercel),</li>
              <li>poskytovatele analytickych nastroju (Google Ireland Ltd., Ahrefs Pte. Ltd., Vercel Inc., Metricool S.L.),</li>
          ...
          <SectionInfo title="6. Smlouva o zpracovani dat (DPA)">
            <p>Na pozadani uzavirame smlouvu o zpracovani dat (DPA), kdyz zpracovavame data jmenem klienta (napr. v ramci udrzby webu, konfigurace nastroju nebo systemu).</p>
          </SectionInfo>
          <Gap variant="line" size="sm" />
          <SectionInfo title="7. Predavani dat mimo EHP">
            <p>
              Google a Vercel mohou zpracovavat data mimo Evropsky hospodsky prostor. Jsou aplikovany prislusne pravni zaruky (vcetne standardnich smluvnich dolozek schvalenych Evropskou komisi) a
              pokud je to mozne, technicka opatreni (pseudonymizace, minimalizace).
            </p>
          </SectionInfo>
          <Gap variant="line" size="sm" />
          <SectionInfo title="8. Doba uchovavani dat">
            <ul className="list-disc space-y-1 pl-6">
              ...
              <li>Logy -- po dobu nezbytnou pro bezpecnost a zodpovednost (obvykle az 12 mesicu, pokud predpisy nestanovi jinak).</li>
            </ul>
          </SectionInfo>
          <Gap variant="line" size="sm" />
          <SectionInfo title="9. Vase prava">
            ...
            <ul className="list-disc space-y-1 pl-6">
              ...
              <li>podani stiznosti u prislusneho dozoroveho uradu (v Polsku: predseda Uradu pro ochranu osobnich udaju, UODO).</li>
            </ul>
          </SectionInfo>
          <Gap variant="line" size="sm" />
          <SectionInfo title="10. Dobrovolne poskytovani dat">
            <p>Poskytovani osobnich udaju je dobrovolne, ale nezbytne pro komunikaci nebo poskytovani sluzeb.</p>
          </SectionInfo>
          <Gap variant="line" size="sm" />
          <SectionInfo title="11. Bezpecnostni opatreni">
            <p>Zavadime technicka a organizacni opatreni k ochrane osobnich udaju pred neopravnenym pristupem, ztratou nebo znicenim.</p>
          </SectionInfo>
          <Gap variant="line" size="sm" />
          <SectionInfo title="12. Zmeny zasad">
            <p>Tyto zasady ochrany osobnich udaju mohou byt aktualizovany, aby odrazely zmeny v legislativne nebo technologiich. Nejaktualne verze je vzdy k dispozici na teto strance.</p>
          </SectionInfo>
          <Gap size="xs" />
        </div>
