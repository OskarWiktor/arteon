      ...
      <Wrapper as="article" id="article-root" itemScope itemType="https://schema.org/Article" className="flex flex-col-reverse gap-8 select-none lg:grid lg:grid-cols-[1fr_300px]">
        <div>
          ...
          <SectionInfo title="1. Responsable du traitement">
            <p>Le responsable du traitement des données personnelles est Arteon, dont le siège se trouve dans la commune de Czernichów, Zagacie, ul. Jaśminowa 36, 32-070, Pologne.</p>
            <p>
          ...
          <SectionInfo title="2. Étendue des données collectées">
            <ul className="list-disc space-y-1 pl-6">
              <li>données fournies via le formulaire de contact (prénom, nom, e-mail, contenu du message),</li>
          ...
          <SectionInfo title="3. Finalités et bases juridiques du traitement">
            <ol className="list-decimal space-y-1 pl-6">
              <li>
                <strong>Contact client</strong> - réponse aux demandes du formulaire de contact (art. 6, par. 1, point b et f du RGPD).
              </li>
              <li>
                <strong>Marketing et analyse</strong> - statistiques du site, optimisation du contenu (art. 6, par. 1, point f du RGPD).
              </li>
              <li>
                <strong>Fourniture de services</strong> - préparation de devis, contrats, factures (art. 6, par. 1, point b du RGPD).
              </li>
              <li>
                <strong>Obligations légales</strong> - par ex. conservation de la documentation comptable (art. 6, par. 1, point c du RGPD).
              </li>
              <li>
                <strong>Sécurité et réclamations</strong> - tenue de journaux, prévention des abus, établissement/exercice/défense de réclamations (art. 6, par. 1, point f du RGPD).
              </li>
              <li>
          ...
          <SectionInfo title="4. Cookies">
            ...
            <ul className="list-disc space-y-1 pl-6">
              ...
              <li>analyse du trafic (Google Analytics 4, Ahrefs Web Analytics, Vercel Analytics, Metricool),</li>
              <li>fins marketing,</li>
              <li>affichage de publicités basées sur les centres d&apos;intérêt (Google AdSense / DoubleClick).</li>
            </ul>
            <p>
          ...
          <SectionInfo title="5. Destinataires des données">
            <p>Les données peuvent être partagées avec des entités qui nous aident dans la fourniture de services, telles que&nbsp;:</p>
            <ul className="list-disc space-y-1 pl-6">
              <li>fournisseurs d&apos;hébergement/applications (par ex. Vercel),</li>
              <li>fournisseurs d&apos;outils d&apos;analyse (Google Ireland Ltd., Ahrefs Pte. Ltd., Vercel Inc., Metricool S.L.),</li>
              <li>fournisseurs de services publicitaires (Google Ireland Ltd. - Google AdSense),</li>
              <li>cabinet comptable, prestataires de paiement ou entités juridiques - si nécessaire.</li>
            </ul>
            <p>Tous les destinataires traitent les données conformément au RGPD sur la base d&apos;accords appropriés.</p>
          </SectionInfo>
          ...
          <SectionInfo title="6. Accord de traitement des données (DPA)">
            <p>
              Sur demande, nous concluons un accord de traitement des données (DPA) lorsque nous traitons des données pour le compte d&apos;un client (par ex. dans le cadre de la maintenance du site,
              de la configuration d&apos;outils ou de systèmes).
            </p>
          </SectionInfo>
          ...
          <SectionInfo title="7. Transferts de données hors de l'EEE">
            <p>
              Google et Vercel peuvent traiter des données en dehors de l&apos;Espace économique européen. Des garanties juridiques appropriées sont appliquées (notamment les clauses contractuelles
              types approuvées par la Commission européenne) ainsi que, dans la mesure du possible, des mesures techniques (pseudonymisation, minimisation).
            </p>
          </SectionInfo>
          ...
          <SectionInfo title="8. Durée de conservation des données">
            <ul className="list-disc space-y-1 pl-6">
              <li>Données du formulaire de contact&nbsp;: jusqu&apos;à 12 mois après la fin de la correspondance.</li>
              <li>Données clients&nbsp;: pendant la durée requise par la loi (documentation comptable).</li>
              <li>Données analytiques&nbsp;: conformément à la politique de Google Analytics (par ex. 26 mois).</li>
              <li>Journaux&nbsp;: pendant la durée nécessaire à la sécurité et à la traçabilité (en règle générale jusqu&apos;à 12 mois, sauf disposition contraire).</li>
            </ul>
          </SectionInfo>
          ...
          <SectionInfo title="9. Vos droits">
            ...
            <ul className="list-disc space-y-1 pl-6">
              ...
              <li>déposer une plainte auprès de l&apos;autorité de contrôle compétente (en Pologne&nbsp;: le Président de l&apos;Office de protection des données personnelles, UODO).</li>
            </ul>
          </SectionInfo>
          ...
          <SectionInfo title="10. Caractère volontaire de la fourniture de données">
            <p>La fourniture de données personnelles est volontaire, mais nécessaire pour le contact ou la fourniture de services.</p>
          </SectionInfo>

          <Gap variant="line" size="sm" />

          <SectionInfo title="11. Mesures de sécurité">
            <p>Nous appliquons des mesures techniques et organisationnelles pour protéger les données personnelles contre tout accès non autorisé, toute perte ou destruction.</p>
          </SectionInfo>

          <Gap variant="line" size="sm" />

          <SectionInfo title="12. Modifications de la politique">
            <p>Cette politique de confidentialité peut être mise à jour pour tenir compte des évolutions législatives ou technologiques. La version actuelle est toujours disponible sur cette page.</p>
          </SectionInfo>
