...
export const metadata = {
  ...
  description:
    '10 strumenti online gratuiti: convertitore WebP, generatore di favicon, contatore di testo, estrattore di colori e codici QR. Per siti web, social media e stampa. Senza registrazione.',
