  ...
  openGraph: {
    ...
    images: [
      ...
      },
      {
        ...
        description:
          'Converti foto JPG in AVIF moderno. Compressione fino al 50% migliore di JPG mantenendo la qualita.',
      ...
      },
      {
        ...
        description:
          'Converti grafiche PNG in AVIF con supporto trasparenza. File notevolmente piu piccoli.',
      ...
      },
      {
        ...
        description:
          'Converti immagini WebP in formato GIF per massima compatibilita.',
      ...
      },
      {
        ...
        description:
          'Converti grafiche vettoriali SVG in raster TIFF di alta qualita.',
...
const schema = {
  ...
  '@type': 'CollectionPage',
  name: 'Strumenti gratuiti - convertitori di immagini, SEO, colori, favicon',
  description:
    'Strumenti gratuiti: Convertitori di immagini (JPG, PNG, WebP, SVG, BMP,, GIF, AVIF, HEIC, TIFF), generatore di favicon, editor di immagini, contatore di testo, palette di colori e codici QR. Senza registrazione.',
  url: toAbsoluteUrl('/it/strumenti'),
  inLanguage: 'it',
    ...
    itemListElement: [
      {
        '@type': 'WebApplication',
        position: 1,
        name: 'Convertitore JPG e PNG in WebP',
        description:
          'Convertitore gratuito da JPG e PNG a WebP. Riduce il peso dei file fino al 35% senza perdita di qualit\u00e0 visibile. Senza registrazione \u2013 i file restano nel tuo browser.',
      ...
      },
      {
        '@type': 'WebApplication',
        position: 2,
        name: 'Editor di immagini',
        description:
          'Ritaglia e ridimensiona le tue immagini per i social media e i siti web. Modelli pronti, dimensioni personalizzate e avatar rotondi.',
      ...
      },
      {
        ...
        description:
          'Generatore di favicon gratuito. Crea favicon.ico e icone PNG (16\u00d716 a 512\u00d7512) da una singola immagine \u2013 compatibile con tutti i browser e Lighthouse.',
      ...
      },
      {
        ...
        url: toAbsoluteUrl(
          '/it/strumenti/verificatore-meta-titolo-e-descrizione',
        ),
      ...
      },
      {
        ...
        description:
          'Generatore gratuito di firma e-mail HTML. Inserisci i tuoi dati, link CTA e profili social, poi copia il codice HTML in Gmail o Outlook.',
      ...
      },
      {
        ...
        description:
          'Verifica il contrasto e la leggibilit\u00e0 dei colori del testo e dello sfondo secondo WCAG. Calcola il rapporto di contrasto e propone un adattamento automatico.',
      ...
      },
      {
        '@type': 'WebApplication',
        position: 7,
        name: 'Estrattore di colori da immagine',
        description:
          'Estrattore di colori gratuito. Carica una foto o un logo e ottieni una palette di fino a 12 colori dominanti (HEX e RGB).',
      ...
      },
      {
        ...
        description:
          'Genera palette da un colore base. Monocromatica, triadica, analoga, complementare e altre \u2013 con varianti pastello, scure e minimaliste.',
      ...
      },
      {
        ...
        description:
          'Generatore di codici QR gratuito. Crea codici QR per siti web, vCard, menu o volantini. Esporta in PNG e SVG, senza registrazione, senza limiti.',
      ...
      },
      {
        ...
        description:
          'Converti grafiche SVG in WebP leggero. Ideale per siti web.',
      ...
      },
      {
        ...
        description:
          'Esporta il primo fotogramma GIF in WebP leggero. File piu piccolo.',
      ...
      },
      {
        ...
        description:
          'Converti file BMP in WebP leggero. Riduzione fino al 95%.',
      ...
      },
      {
        ...
        description:
          'Converti file AVIF in JPG universale. Compatibile ovunque.',
      ...
      },
      {
        ...
        description:
          'Converti foto HEIC da iPhone in JPG universale. Senza registrazione.',
      ...
      },
      {
        ...
        description:
          'Converti foto HEIC da iPhone in PNG lossless. Qualita completa.',
      ...
      },
      {
        ...
        description:
          'Converti file TIFF in JPG compatto. Ideale per scansioni.',
...
const faqItems = [
  {
    ...
    answer:
      'No. Tutti gli strumenti sono gratuiti, senza abbonamento e senza costi nascosti.',
  },
  {
    question: 'I miei file vengono inviati a un server?',
    answer:
      'No. Tutti gli strumenti funzionano interamente nel tuo browser. I file non lasciano mai il tuo computer e non vengono archiviati da nessuna parte.',
  },
  {
    question: 'Devo creare un account?',
    answer:
      'No. Puoi utilizzare gli strumenti immediatamente, senza registrarti o creare un account.',
  },
  {
    question: "C'\u00e8 un limite di utilizzo?",
    answer:
      'No. Usa gli strumenti senza restrizioni \u2013 nessun limite giornaliero, nessun limite di file, nessun limite di conversioni.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'S\u00ec, ma alcuni strumenti (es. il convertitore WebP e il generatore di favicon) sono ottimizzati per il desktop, poich\u00e9 elaborano file di grandi dimensioni.',
  },
];
    ...
    <>
      ...
      <Wrapper>
          ...
          items={[
            {
              ...
              topImageSrc:
                '/assets/tools/free-image-editor-crop-resize-and-convert/editor-di-immagini-online-it.webp',
              description: (
                <div className='flex h-full flex-col'>
                  <p>
                    Prepara il ritaglio perfetto per i social media o il tuo
                    sito. Scegli un formato pronto o inserisci dimensioni
                    personalizzate e scarica l\'immagine in PNG, JPG o WebP.
                  </p>
                  <ToolCardFooter
                    href='/it/strumenti/editor-di-immagini-online'
                    label='Apri strumento'
                  />
                </div>
              ),
            },
            {
              ...
              topImageSrc:
                '/assets/tools/favicon-generator/generatore-di-favicon-gratuito-it.webp',
              description: (
                <div className='flex h-full flex-col'>
                  <p>
                    Genera <strong>favicon.ico</strong> e icone PNG 180x180,
                    192x192 e 512x512 da una singola immagine \u2013 conforme ai
                    requisiti dei browser e di Lighthouse.
                  </p>
                  <ToolCardFooter
                    href='/it/strumenti/generatore-di-favicon-gratuito'
                    label='Apri strumento'
                  />
                </div>
              ),
          ...
          items={[
            {
              ...
              topImageSrc:
                '/assets/tools/free-meta-title-and-description-checker-pixel-width/verificatore-meta-titolo-e-descrizione-it.webp',
              description: (
                <div className='flex h-full flex-col'>
                  <p>
                    Controlla il numero di caratteri, parole e la larghezza in
                    pixel \u2013 con un&apos;anteprima dell&apos;aspetto della
                    tua pagina nei risultati Google. Evita titoli e descrizioni
                    troncati.
                  </p>
                  <ToolCardFooter
                    href='/it/strumenti/verificatore-meta-titolo-e-descrizione'
                    label='Apri strumento'
                  />
                </div>
              ),
            },
            {
              ...
              topImageSrc:
                '/assets/tools/word-and-character-counter-with-text-formatting-tools/contatore-di-parole-e-caratteri-it.webp',
              description: (
                <div className='flex h-full flex-col'>
                  <p>
                    Verifica se la lunghezza del testo \u00e8 adeguata per una
                    homepage, pagina servizi, articolo del blog o descrizione
                    prodotto. Lo strumento conta parole, caratteri, paragrafi e
                    stima il tempo di lettura.
                  </p>
                  <ToolCardFooter
                    href='/it/strumenti/contatore-di-parole-e-caratteri'
                    label='Apri strumento'
                  />
                </div>
              ),
...

            {
              ...
              topImageSrc:
                '/assets/tools/lorem-ipsum-generator/generatore-lorem-ipsum-it.webp',
              description: (
                <div className='flex h-full flex-col'>
                  <p>
                    Genera testo segnaposto in 8 stili e 9 modalità. Lorem
                    Ipsum, Hipster, Business, Bacon e altro. Copia come testo o
                    HTML.
                  </p>
                  <ToolCardFooter
                    href='/it/strumenti/generatore-lorem-ipsum'
                    label='Apri strumento'
                  />
                </div>
              ),
          ...
          items={[
            {
              ...
              topImageSrc:
                '/assets/tools/free-html-email-signature-generator/generatore-di-firma-email-gratuito-it.webp',
              description: (
                <div className='flex h-full flex-col'>
                  <p>
                    Crea una firma e-mail professionale in pochi minuti.
                    Inserisci i tuoi dati, scegli i colori e copia il codice
                    HTML in Gmail, Outlook o qualsiasi altro client di posta.
                  </p>
                  <ToolCardFooter
                    href='/it/strumenti/generatore-di-firma-email-gratuito'
                    label='Apri strumento'
                  />
                </div>
              ),
          ...
          items={[
            {
              ...
              topImageSrc:
                '/assets/tools/qr-code-generator/generatore-di-codici-qr-gratuito-it.webp',
              description: (
                <div className='flex h-full flex-col'>
                  <p>
                    Crea un codice QR per un sito web, una vCard, un menu o un
                    volantino. Esporta in PNG e SVG \u2013 senza registrazione,
                    senza limiti.
                  </p>
                  <ToolCardFooter
                    href='/it/strumenti/generatore-di-codici-qr-gratuito'
                    label='Apri strumento'
                  />
                </div>
              ),
          ...
          items={[
            {
              ...
              topImageSrc:
                '/assets/tools/color-contrast-and-readability-checker/verificatore-contrasto-colori-it.webp',
              description: (
                <div className='flex h-full flex-col'>
                  <p>
                    Verifica se i colori del testo e dello sfondo sono
                    leggibili. Inserisci i codici colore, consulta il rapporto
                    di contrasto <strong>WCAG</strong> e usa la funzione{' '}
                    <strong>Adatta</strong> per una correzione automatica.
                  </p>
                  <ToolCardFooter
                    href='/it/strumenti/verificatore-contrasto-colori'
                    label='Apri strumento'
                  />
                </div>
              ),
            },
            {
              ...
              topImageSrc:
                '/assets/tools/image-color-extractor/estrattore-di-colori-da-immagine-it.webp',
              description: (
                <div className='flex h-full flex-col'>
                  <p>
                    Carica una foto o un logo \u2013 lo strumento estrarre i
                    colori dominanti. Copia i codici HEX con un solo clic e
                    usali ovunque.
                  </p>
                  <ToolCardFooter
                    href='/it/strumenti/estrattore-di-colori-da-immagine'
                    label='Apri strumento'
                  />
                </div>
              ),
            },
            {
              ...
              topImageSrc:
                '/assets/tools/color-palette-generator/generatore-di-palette-di-colori-it.webp',
              description: (
                <div className='flex h-full flex-col'>
                  <p>
                    Scegli un colore base e genera 9 palette: monocromatica,
                    complementare, triadica, pastello, scura e altre. Copia i
                    codici HEX con un solo clic.
                  </p>
                  <ToolCardFooter
                    href='/it/strumenti/generatore-di-palette-di-colori'
                    label='Apri strumento'
                  />
                </div>
              ),
        ...
        <SectionSteps
          ...
          description='Convertitori di immagini - converti tra JPG, PNG, WebP, SVG, BMP e GIF. Conversione nel browser, senza invio di file.'
          grid='three'
          cardVariant='dark'
          items={[
            {
              ...
              topImageSrc:
                '/assets/tools/jpg-png-to-webp-converter/convertitore-jpg-png-in-webp-it.webp',
              description: (
                <div className='flex h-full flex-col'>
                  <p>
                    Converti foto JPG in WebP leggero. Riduci il peso delle
                    immagini fino al 35%.
                  </p>
                  <ToolCardFooter
                    href='/it/strumenti/convertitore-jpg-in-webp'
                    label='Apri strumento'
                  />
                </div>
              ),
            },
            {
              ...
              description: (
                <div className='flex h-full flex-col'>
                  <p>
                    Converti file PNG in JPG nel browser. Senza limiti, senza
                    registrazione.
                  </p>
                  <ToolCardFooter
                    href='/it/strumenti/convertitore-png-in-jpg'
                    label='Apri strumento'
                  />
                </div>
              ),
            },
            {
              ...
              description: (
                <div className='flex h-full flex-col'>
                  <p>
                    Converti file WebP in JPG compatibile ovunque. Senza limiti,
                    senza registrazione.
                  </p>
                  <ToolCardFooter
                    href='/it/strumenti/convertitore-webp-in-jpg'
                    label='Apri strumento'
                  />
                </div>
              ),
            },
            {
              ...
              description: (
                <div className='flex h-full flex-col'>
                  <p>
                    Converti grafiche PNG in WebP. File più piccoli mantenendo
                    la trasparenza.
                  </p>
                  <ToolCardFooter
                    href='/it/strumenti/convertitore-png-in-webp'
                    label='Apri strumento'
                  />
                </div>
              ),
            },
            {
              ...
              description: (
                <div className='flex h-full flex-col'>
                  <p>
                    Converti immagini JPG in PNG senza perdita. Conversione
                    locale nel browser.
                  </p>
                  <ToolCardFooter
                    href='/it/strumenti/convertitore-jpg-in-png'
                    label='Apri strumento'
                  />
                </div>
              ),
            },
            {
              ...
              description: (
                <div className='flex h-full flex-col'>
                  <p>
                    Converti immagini WebP in PNG senza perdita. Conversione
                    locale, niente server.
                  </p>
                  <ToolCardFooter
                    href='/it/strumenti/convertitore-webp-in-png'
                    label='Apri strumento'
                  />
                </div>
              ),
        ...
        <SectionSteps
          ...
          description='Convertitori di formati dati — converti tra CSV, JSON, XML, YAML, Markdown e HTML. Elaborazione nel browser.'
          grid='three'
          cardVariant='dark'
          items={[
            {
              ...
              description: (
                <div className='flex h-full flex-col'>
                  <p>
                    Converti CSV in formato JSON. Rilevamento automatico dei
                    separatori e formattazione.
                  </p>
                  <ToolCardFooter
                    href='/it/strumenti/convertitore-csv-in-json'
                    label='Apri strumento'
                  />
                </div>
              ),
            },
            {
              ...
              description: (
                <div className='flex h-full flex-col'>
                  <p>
                    Converti dati JSON in formato CSV. Elaborazione nel browser.
                  </p>
                  <ToolCardFooter
                    href='/it/strumenti/convertitore-json-in-csv'
                    label='Apri strumento'
                  />
                </div>
              ),
            },
            {
              ...
              description: (
                <div className='flex h-full flex-col'>
                  <p>
                    Converti dati XML in JSON. Conversione nel browser con
                    validazione.
                  </p>
                  <ToolCardFooter
                    href='/it/strumenti/convertitore-xml-in-json'
                    label='Apri strumento'
                  />
                </div>
              ),
            },
            {
              ...
              description: (
                <div className='flex h-full flex-col'>
                  <p>
                    Converti dati JSON in XML valido. Conversione nel browser
                    con formattazione.
                  </p>
                  <ToolCardFooter
                    href='/it/strumenti/convertitore-json-in-xml'
                    label='Apri strumento'
                  />
                </div>
              ),
            },
            {
              ...
              description: (
                <div className='flex h-full flex-col'>
                  <p>
                    Converti configurazione YAML in JSON. Validazione e
                    formattazione nel browser.
                  </p>
                  <ToolCardFooter
                    href='/it/strumenti/convertitore-yaml-in-json'
                    label='Apri strumento'
                  />
                </div>
              ),
            },
            {
              ...
              description: (
                <div className='flex h-full flex-col'>
                  <p>
                    Converti dati JSON in YAML leggibile. Elaborazione nel
                    browser.
                  </p>
                  <ToolCardFooter
                    href='/it/strumenti/convertitore-json-in-yaml'
                    label='Apri strumento'
                  />
                </div>
              ),
        ...
        <SectionInfo title='Cosa sono gli strumenti Arteon?'>
          <p className='mb-4'>
            34 strumenti gratuiti per creare e ottimizzare contenuti per siti
            web, social media e stampa \u2013 convertitore WebP, generatore di
            favicon, contatore di testo, estrattore di colori, generatore di
            palette e codici QR.
          </p>
          <p>
            Tutti gli strumenti funzionano nel tuo browser \u2013 i file non
            vengono mai inviati a un server. Usali senza registrazione e senza
            limiti.
          </p>
        </SectionInfo>
        ...
        <SectionSteps
          ...
          items={[
            ...
            },
            {
              ...
              description:
                'Nessun account necessario. Apri lo strumento, usalo, \u00e8 tutto qui.',
            },
            {
        ...
        <SectionFaqPanels
          items={faqItems}
          title='Domande frequenti sui nostri strumenti'
        />

        <Divider size='sm' />
      </Wrapper>

      <JsonLd id='ld-json-tools-it' schema={schema} />
    </>
  );
}
