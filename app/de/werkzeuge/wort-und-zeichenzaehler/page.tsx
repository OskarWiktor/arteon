...
export default function WordCounterPage() {
  return (
    <>
      ...
      <Breadcrumbs second={{ href: '/de/werkzeuge', label: 'Werkzeuge' }} third={{ href: '/de/werkzeuge/wort-und-zeichenzaehler', label: 'Wort- und Zeichenzähler' }} includeJsonLd locale="de" />
      ...
      <Wrapper>
        ...
        <FaqPanels title="Häufig gestellte Fragen zum Wort- und Zeichenzähler" openByDefault={1} items={faqItems} pageUrl={toAbsoluteUrl('/de/werkzeuge/wort-und-zeichenzaehler')} />
