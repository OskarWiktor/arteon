...
export const metadata = {
  title: 'Datenschutzrichtlinie - Arteon',
  description: 'Datenschutzrichtlinie der Website Arteon - erfahren Sie, wie wir Ihre personenbezogenen Daten schützen und welche Analyse- und Werbemittel wir verwenden.',
  alternates: {
    canonical: toAbsoluteUrl('/de/datenschutzrichtlinie'),
    languages: {
      ...
      <Wrapper as="article" id="article-root" itemScope itemType="https://schema.org/Article" className="flex flex-col-reverse gap-8 select-none lg:grid lg:grid-cols-[1fr_300px]">
        <div>
          ...
          <SectionInfo title="1. Verantwortlicher">
            <p>Verantwortlicher für die Verarbeitung personenbezogener Daten ist Arteon mit Sitz in Gemeinde Czernichów, Zagacie, ul. Jaśminowa 36, 32-070, Polen.</p>
            <p>
          ...
          <SectionInfo title="2. Umfang der erhobenen Daten">
            <ul className="list-disc space-y-1 pl-6">
              <li>über das Kontaktformular angegebene Daten (Vorname, Nachname, E-Mail, Nachrichteninhalt),</li>
          ...
          <SectionInfo title="3. Zwecke und Rechtsgrundlagen der Verarbeitung">
            <ol className="list-decimal space-y-1 pl-6">
              <li>
                <strong>Kundenkontakt</strong> - Beantwortung von Anfragen über das Kontaktformular (Art. 6 Abs. 1 lit. b und f DSGVO).
              </li>
              <li>
                <strong>Marketing und Analyse</strong> - Website-Statistiken, Inhaltsoptimierung (Art. 6 Abs. 1 lit. f DSGVO).
              </li>
              <li>
                <strong>Leistungserbringung</strong> - Erstellung von Angeboten, Verträgen, Rechnungen (Art. 6 Abs. 1 lit. b DSGVO).
              </li>
              <li>
                <strong>Gesetzliche Pflichten</strong> - z.{'\u00a0'}B. Aufbewahrung von Buchhaltungsunterlagen (Art. 6 Abs. 1 lit. c DSGVO).
              </li>
              <li>
          ...
          <SectionInfo title="4. Cookies">
            ...
            <ul className="list-disc space-y-1 pl-6">
              ...
              <li>Traffic-Analyse (Google Analytics 4, Ahrefs Web Analytics, Vercel Analytics, Metricool),</li>
          ...
          <SectionInfo title="5. Datenempfänger">
            <p>Daten können an Stellen weitergegeben werden, die uns bei der Erbringung von Dienstleistungen unterstützen, wie z.{'\u00a0'}B.:</p>
            <ul className="list-disc space-y-1 pl-6">
              <li>Hosting-/Anwendungsanbieter (z.{'\u00a0'}B. Vercel),</li>
              <li>Anbieter von Analysetools (Google Ireland Ltd., Ahrefs Pte. Ltd., Vercel Inc., Metricool S.L.),</li>
            ...
            <p>Alle Empfänger verarbeiten Daten gemäß der DSGVO auf Grundlage entsprechender Vereinbarungen.</p>
          </SectionInfo>
          ...
          <SectionInfo title="6. Auftragsverarbeitung (AVV)">
            <p>
              Auf Wunsch schließen wir einen Auftragsverarbeitungsvertrag (AVV), wenn wir Daten im Auftrag eines Kunden verarbeiten (z.{'\u00a0'}B. im Rahmen der Website-Wartung, Tool- oder
              Systemkonfiguration).
            </p>
          </SectionInfo>
          ...
          <SectionInfo title="7. Datenübermittlung außerhalb des EWR">
            <p>
              Google und Vercel können Daten außerhalb des Europäischen Wirtschaftsraums verarbeiten. Es werden geeignete rechtliche Garantien angewandt (u.{'\u00a0'}a. Standardvertragsklauseln der
              Europäischen Kommission) sowie - soweit möglich - technische Maßnahmen (Pseudonymisierung, Datenminimierung).
            </p>
          </SectionInfo>
          ...
          <SectionInfo title="8. Speicherdauer">
            <ul className="list-disc space-y-1 pl-6">
              ...
              <li>Kundendaten - für den gesetzlich vorgeschriebenen Zeitraum (Buchhaltungsunterlagen).</li>
              <li>Analysedaten - gemäß der Google-Analytics-Richtlinie (z.{'\u00a0'}B. 26 Monate).</li>
              <li>Protokolle - für den für Sicherheit und Rechenschaftspflicht erforderlichen Zeitraum (in der Regel bis zu 12 Monate, sofern keine abweichenden Vorschriften gelten).</li>
            </ul>
          </SectionInfo>
          ...
          <SectionInfo title="9. Ihre Rechte">
            ...
            <ul className="list-disc space-y-1 pl-6">
              ...
              <li>Beschwerde bei der zuständigen Aufsichtsbehörde (in Polen: Präsident des Amtes für den Schutz personenbezogener Daten, UODO).</li>
            </ul>
          </SectionInfo>
          ...
          <SectionInfo title="10. Freiwilligkeit der Datenangabe">
            <p>Die Angabe personenbezogener Daten ist freiwillig, jedoch für die Kontaktaufnahme oder Leistungserbringung erforderlich.</p>
          </SectionInfo>

          <Gap variant="line" size="sm" />

          <SectionInfo title="11. Sicherheitsmaßnahmen">
            <p>Wir setzen technische und organisatorische Maßnahmen ein, um personenbezogene Daten vor unbefugtem Zugriff, Verlust oder Zerstörung zu schützen.</p>
          </SectionInfo>
