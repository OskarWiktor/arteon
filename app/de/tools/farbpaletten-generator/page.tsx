...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: toAbsoluteUrl('/de/tools/farbpaletten-generator'),
    languages: {
      pl: toAbsoluteUrl('/narzedzia/generator-palet-kolorow'),
      en: toAbsoluteUrl('/en/tools/color-palette-generator'),
      de: toAbsoluteUrl('/de/tools/farbpaletten-generator'),
    },
  },
  openGraph: {
...
export default function ColorPalettePage() {
  return (
    <>
      ...
      <Breadcrumbs second={{ href: '/de/tools', label: 'Tools' }} third={{ href: '/de/tools/farbpaletten-generator', label: 'Farbpaletten-Generator' }} includeJsonLd locale="de" />
      ...
      <Wrapper>
        ...
        <FaqPanels pageUrl={toAbsoluteUrl('/de/tools/farbpaletten-generator')} title="Häufig gestellte Fragen zum Farbpaletten-Generator" openByDefault={1} items={faqItems} />
