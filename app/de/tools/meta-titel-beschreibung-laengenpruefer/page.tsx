...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: toAbsoluteUrl('/de/tools/meta-titel-beschreibung-laengenpruefer'),
    languages: {
...
export default function MetaTitleDescriptionPage() {
  return (
    <>
      ...
      <Breadcrumbs
        second={{ href: '/de/tools', label: 'Tools' }}
        third={{ href: '/de/tools/meta-titel-beschreibung-laengenpruefer', label: 'Meta-Titel- & Beschreibungs-Checker' }}
        includeJsonLd
        locale="de"
      />
      ...
      <Wrapper>
        ...
        <FaqPanels title="Häufig gestellte Fragen zum Meta-Checker" openByDefault={1} items={faqItems} pageUrl={toAbsoluteUrl('/de/tools/meta-titel-beschreibung-laengenpruefer')} />
