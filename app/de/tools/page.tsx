...
export const metadata = {
  ...
  alternates: {
    canonical: toAbsoluteUrl('/de/tools'),
    languages: {
  ...
  mainEntity: {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        url: toAbsoluteUrl('/de/tools/online-bildeditor'),
        applicationCategory: 'MultimediaApplication',
        operatingSystem: 'Any',
      },
      {
        ...
        url: toAbsoluteUrl('/de/tools/kostenloser-favicon-generator'),
      ...
      },
      {
        ...
        url: toAbsoluteUrl('/de/tools/meta-titel-beschreibung-laengenpruefer'),
      ...
      },
      {
        ...
        url: toAbsoluteUrl('/de/tools/farbkontrast-checker'),
        applicationCategory: 'DesignApplication',
        operatingSystem: 'Any',
      },
      {
      ...
      },
      {
        ...
        url: toAbsoluteUrl('/de/tools/farbpaletten-generator'),
        applicationCategory: 'DesignApplication',
        operatingSystem: 'Any',
      },
      {
      ...
      },
      {
        ...
        url: toAbsoluteUrl('/de/tools/kostenloser-qr-code-generator'),
          ...
          items={[
            {
              ...
              description: (
                <div className="flex h-full flex-col">
                  ...
                  <div className="mt-4">
                    <Button arrow link="/de/tools/jpg-png-zu-webp-konverter">
                      Tool öffnen
                    </Button>
                  </div>
                </div>
            ...
            },
            {
              ...
              description: (
                <div className="flex h-full flex-col">
                  ...
                  <div className="mt-4">
                    <Button arrow link="/de/tools/online-bildeditor">
                      Tool öffnen
                    </Button>
                  </div>
                </div>
            ...
            },
            {
              ...
              description: (
                <div className="flex h-full flex-col">
                  ...
                  <div className="mt-4">
                    <Button arrow link="/de/tools/kostenloser-favicon-generator">
                      Tool öffnen
                    </Button>
                  </div>
                </div>
          ...
          items={[
            {
              ...
              description: (
                <div className="flex h-full flex-col">
                  ...
                  <div className="mt-4">
                    <Button arrow link="/de/tools/meta-titel-beschreibung-laengenpruefer">
                      Tool öffnen
                    </Button>
                  </div>
                </div>
            ...
            },
            {
              ...
              description: (
                <div className="flex h-full flex-col">
                  ...
                  <div className="mt-4">
                    <Button arrow link="/de/tools/wort-und-zeichenzaehler">
                      Tool öffnen
                    </Button>
                  </div>
                </div>
          ...
          items={[
            {
              ...
              description: (
                <div className="flex h-full flex-col">
                  ...
                  <div className="mt-4">
                    <Button arrow link="/de/tools/kostenloser-e-mail-signatur-generator">
                      Tool öffnen
                    </Button>
                  </div>
                </div>
          ...
          items={[
            {
              ...
              description: (
                <div className="flex h-full flex-col">
                  ...
                  <div className="mt-4">
                    <Button arrow link="/de/tools/kostenloser-qr-code-generator">
                      Tool öffnen
                    </Button>
                  </div>
                </div>
          ...
          items={[
            {
              ...
              description: (
                <div className="flex h-full flex-col">
                  ...
                  <div className="mt-4">
                    <Button arrow link="/de/tools/farbkontrast-checker">
                      Tool öffnen
                    </Button>
                  </div>
                </div>
            ...
            },
            {
              ...
              description: (
                <div className="flex h-full flex-col">
                  ...
                  <div className="mt-4">
                    <Button arrow link="/de/tools/bild-farbextraktor">
                      Tool öffnen
                    </Button>
                  </div>
                </div>
            ...
            },
            {
              ...
              description: (
                <div className="flex h-full flex-col">
                  ...
                  <div className="mt-4">
                    <Button arrow link="/de/tools/farbpaletten-generator">
                      Tool öffnen
                    </Button>
                  </div>
                </div>
