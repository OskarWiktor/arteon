...
export default function ColorContrastCheckerPage() {
  return (
    <>
      ...
      <Breadcrumbs second={{ href: '/de/tools', label: 'Tools' }} third={{ href: '/de/tools/farbkontrast-checker', label: 'Farbkontrast-Checker' }} includeJsonLd locale="de" />
      ...
      <Wrapper>
        ...
        <FaqPanels pageUrl={toAbsoluteUrl('/de/tools/farbkontrast-checker')} title="Häufig gestellte Fragen zum Farbkontrast-Checker" openByDefault={1} items={faqItems} />
