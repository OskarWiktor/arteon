...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: toAbsoluteUrl('/de/tools/kostenloser-qr-code-generator'),
    languages: {
      pl: toAbsoluteUrl('/narzedzia/darmowy-generator-kodow-qr'),
      en: toAbsoluteUrl('/en/tools/free-qr-code-generator'),
      de: toAbsoluteUrl('/de/tools/kostenloser-qr-code-generator'),
    },
  },
  openGraph: {
...
export default function QrCodeGeneratorPage() {
  return (
    <>
      ...
      <Breadcrumbs second={{ href: '/de/tools', label: 'Tools' }} third={{ href: '/de/tools/kostenloser-qr-code-generator', label: 'QR-Code-Generator' }} includeJsonLd locale="de" />
      ...
      <Wrapper>
        ...
        <FaqPanels pageUrl={toAbsoluteUrl('/de/tools/kostenloser-qr-code-generator')} title="Häufig gestellte Fragen zum QR-Code-Generator" openByDefault={1} items={faqItems} />
