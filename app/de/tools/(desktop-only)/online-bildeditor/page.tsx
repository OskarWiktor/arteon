...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: toAbsoluteUrl('/de/tools/online-bildeditor'),
    languages: {
      pl: toAbsoluteUrl('/narzedzia/edytor-zdjec-online'),
      en: toAbsoluteUrl('/en/tools/online-image-editor'),
      de: toAbsoluteUrl('/de/tools/online-bildeditor'),
    },
  },
  openGraph: {
    title: 'Kostenloser Online-Bildeditor - Zuschneiden und Größe ändern',
...
export default function ImageResizePage() {
  return (
    <>
      ...
      <Breadcrumbs second={{ href: '/de/tools', label: 'Tools' }} third={{ href: '/de/tools/online-bildeditor', label: 'Online-Bildeditor' }} includeJsonLd locale="de" />
      ...
      <Wrapper>
        ...
        <FaqPanels pageUrl={toAbsoluteUrl('/de/tools/online-bildeditor')} title="Häufig gestellte Fragen zum Bildeditor" openByDefault={1} items={faqItems} />
