...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: toAbsoluteUrl('/de/tools/kostenloser-favicon-generator'),
    languages: {
      pl: toAbsoluteUrl('/narzedzia/darmowy-generator-favicon-ico'),
      en: toAbsoluteUrl('/en/tools/free-favicon-generator'),
      de: toAbsoluteUrl('/de/tools/kostenloser-favicon-generator'),
    },
  },
  openGraph: {
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      'Kopieren Sie die generierten Dateien in das Stammverzeichnis Ihrer Website. Fügen Sie dann die entsprechenden <link>-Elemente in den <head>-Bereich ein. Das ZIP-Archiv enthält eine Anleitung mit dem benötigten HTML-Code.',
...
export default function FaviconGeneratorPage() {
  return (
    <>
      ...
      <Breadcrumbs second={{ href: '/de/tools', label: 'Tools' }} third={{ href: '/de/tools/kostenloser-favicon-generator', label: 'Favicon-Generator' }} includeJsonLd locale="de" />
      ...
      <Wrapper>
        ...
        <FaqPanels pageUrl={toAbsoluteUrl('/de/tools/kostenloser-favicon-generator')} title="Häufig gestellte Fragen zum Favicon-Generator" openByDefault={1} items={faqItems} />
