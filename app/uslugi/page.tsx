...
export const metadata = {
  title: 'Usługi - strony, sklepy, treści, projektowanie graficzne i marketing | Arteon',
  description: 'Komplet usług wokół Twojej strony: projekt, wdrożenie, treści, projektowanie graficzne i marketing. Jasne pakiety i wsparcie po wdrożeniu.',
