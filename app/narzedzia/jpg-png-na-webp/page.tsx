  ...
  return (
    <>
      <HeroBanner
        ...
        description="Zoptymalizuj grafiki dla szybszej prędkości Twojej witryny. Dodaj kilka plików, wybierz poziom jakości i pobierz zdjęcia w formacie WebP. Konwersja odbywa się w całości w Twojej przeglądarce - pliki nie są
          nigdzie wysyłane."
        overlay="black"
