...
const schema = {
  ...
  name: 'Free email signature generator online',
  alternateName: ['HTML email signature generator', 'Email signature creator', 'Email footer generator online'],
  url: toAbsoluteUrl('/en/tools/free-email-signature-generator'),
  applicationCategory: 'BusinessApplication',
  applicationSubCategory: 'EmailSignatureGenerator',
  operatingSystem: 'Any',
  description: 'Free HTML email signature generator. Add contact details, CTA link, and social media profiles, then copy the ready code into Gmail, Outlook, and other email clients.',
  featureList: [
    'Contact details (name, title, company)',
    'Phone, email, and website URL',
    'Logo or profile picture with shape and size options',
    'Social media icons (12 platforms: LinkedIn, Instagram, Facebook, TikTok, YouTube, X, GitHub, Dribbble, Behance, WhatsApp, Telegram, Pinterest)',
    'Customizable colors (text, accent, background)',
    'Individual text style for each signature element',
    'CTA button with custom text and link',
    'Separator line styling (style, thickness, color)',
    'Live signature preview with background switching (light, dark, checkerboard)',
    'HTML source code preview in modal',
    'Copy HTML code to clipboard',
    'Download signature as HTML file',
    'Export and import configuration as JSON file',
...
const howToSchema = {
  '@context': 'https://schema.org',
  '@type': 'HowTo',
  name: 'How to use the email signature generator',
  description: 'How to create a professional HTML email signature using the free Arteon generator.',
  url: toAbsoluteUrl('/en/tools/free-email-signature-generator'),
  totalTime: 'PT5M',
  step: [
    {
      '@type': 'HowToStep',
      position: 1,
      name: 'Choose a signature layout',
      text: 'Select one of eight available layouts: Standard, Top bar, Labels left, Centered, Compact, Two columns, Minimalist, or Bottom bar.',
    },
    {
      '@type': 'HowToStep',
      position: 2,
    ...
    },
    {
      '@type': 'HowToStep',
      position: 3,
      name: 'Add CTA buttons',
      text: 'In the Buttons tab, add text and URL for the main button. Optionally add a second outline-style button and choose button rounding.',
    },
    {
      '@type': 'HowToStep',
      position: 4,
      name: 'Add social media links',
      text: 'In the Social Media tab, paste URLs to your profiles. Supported platforms: LinkedIn, Instagram, Facebook, TikTok, YouTube, X, GitHub, Dribbble, Behance, WhatsApp, Telegram, and Pinterest.',
    },
    {
      '@type': 'HowToStep',
      position: 5,
      name: 'Customize appearance',
      text: 'In the Appearance tab, choose a color theme, font, and text size. In the Text Style tab, change colors and sizes of individual elements.',
    },
    {
      '@type': 'HowToStep',
      position: 6,
    ...
    },
    {
      '@type': 'HowToStep',
      position: 7,
      name: 'Preview and copy signature',
      text: 'The signature preview is available on light, dark, or checkerboard background. The Copy signature (Gmail / Outlook) button copies the ready code to clipboard. Also available: Copy HTML code, Download as HTML, View HTML code, and export configuration as JSON file.',
    },
  ],
  publisher: { '@type': 'Organization', name: 'Arteon Agency', url: siteUrl },
};
...
export default function EmailSignatureGeneratorPage() {
  return (
    <>
      <Script id="ld-json-email-signature-tool-en" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schema) }} />
      <Script id="ld-json-email-signature-howto-en" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(howToSchema) }} />

      <HeroBanner
        title="Create a professional HTML email signature"
        description="Build a professional email signature in minutes. Enter your details, choose colors, and copy the ready HTML code into Gmail, Outlook, or any email client."
        overlay="black"
        backgroundImage="/assets/tools/narzedzia-darmowy-generator-stopki-mailowej.webp"
      />

      <Breadcrumbs second={{ href: '/en/tools', label: 'Tools' }} third={{ href: '/en/tools/free-email-signature-generator', label: 'Email signature generator' }} includeJsonLd locale="en" />
      ...
      <Wrapper>
        ...
        <SectionInfo title="Why have a professional email signature?">
          <p className="text-mid">
            An email signature (also called an email footer) is a block of information at the end of every sent message. It contains contact details, job title, company name, and often a link to the
        ...
        <SectionSteps
          ...
          description="Creating a professional email signature takes just a few minutes:"
          grid="three"
          items={[
            { title: '1. Enter details', description: 'Fill in your name, title, company, and contact details.' },
            { title: '2. Customize appearance', description: 'Choose a layout, colors, add a logo, and social media links.' },
            { title: '3. Copy the code', description: 'The Copy signature button copies the ready code to clipboard. Just paste it in Gmail, Outlook, or another email client.' },
          ]}
        />
          ...
          demo={
            <div className="space-y-3">
              ...
              <div className="mt-4 rounded-lg border border-neutral-200 bg-white p-4">
                <p className="text-dark font-semibold">John Smith</p>
                <p className="text-mid text-sm">Web Developer</p>
                <p className="text-mid text-sm">Arteon Agency</p>
                <div className="mt-2 text-sm">
                  <p className="text-mid">john@example.com</p>
                  <p className="text-mid">+1 555 000 000</p>
                </div>
              </div>
            </div>
          }
        ...
        <SectionInfo title="How to add CTA buttons">
          <p className="text-mid">
            A CTA button (call-to-action) is a clickable element that directs the recipient to a chosen page. It can be a link to a meeting calendar, contact form, or offer. The generator allows
            adding two CTA buttons.
          </p>

          <h3 className="h5 mt-6 mb-3">Main button</h3>
          <ol className="text-mid list-decimal space-y-2 pl-6">
            <li>
              Open the <strong>Buttons</strong> tab in the editor.
            </li>
            <li>
              In the <strong>Main button</strong> section, enter the text the recipient will see, e.g., Schedule a free consultation.
            </li>
            <li>
              In the <strong>CTA link</strong> field, paste the full URL. The address must start with https://.
            </li>
          </ol>

          <h3 className="h5 mt-6 mb-3">Secondary button</h3>
          <p className="text-mid">
            You can add a second CTA button in outline style (transparent background with border). Fill in the fields in the <strong>Secondary button</strong> section the same way as for the main
            button.
          </p>

          <h3 className="h5 mt-6 mb-3">Button rounding</h3>
          <p className="text-mid">
            At the bottom of the Buttons tab you will find the <strong>Button rounding</strong> option. Three variants are available: None (sharp corners), Slight (slightly rounded), or Full (oval
            button).
          </p>
        ...
        <SectionInfo title="How to add social media links">
          <p className="text-mid">
            In the <strong>Social Media</strong> tab you can add links to your profiles. The generator supports twelve platforms: LinkedIn, Instagram, Facebook, TikTok, YouTube, X (formerly Twitter),
            GitHub, Dribbble, Behance, WhatsApp, Telegram, and Pinterest.
          </p>

          <h3 className="h5 mt-6 mb-3">How to do it</h3>
          <ol className="text-mid list-decimal space-y-2 pl-6">
            <li>
              Open the <strong>Social Media</strong> tab in the editor.
            </li>
            <li>Next to each platform you will find a URL field. Paste the full link to your profile, e.g., https://www.linkedin.com/in/yourprofile.</li>
            <li>Fill in only the fields you need. Empty fields will not appear in the signature.</li>
          </ol>

          <h3 className="h5 mt-6 mb-3">Social media icons</h3>
          <p className="text-mid">
            At the bottom of the Social Media tab you will find the <strong>Show icons next to service names</strong> option. When enabled, links will display as colored SVG icons instead of just
            names.
          </p>
          <ul className="text-mid mt-3 list-disc space-y-2 pl-6">
            <li>
        ...
        <SectionInfo title="Appearance customization">
          <p className="text-mid">
            In the <strong>Appearance</strong> tab you can customize colors, font, and other visual elements of the signature.
          </p>

          <h3 className="h5 mt-6 mb-3">Color themes</h3>
          <p className="text-mid">
            At the top of the tab you will find five ready-made themes: Dark, Blue, Purple, Green, and Gray. Clicking a theme automatically sets the accent color and text color. This is the quickest
            way to achieve a consistent signature look.
          </p>
        ...
        <SectionInfo title="Text style — colors and sizes of individual elements">
          ...
          <h3 className="h5 mt-6 mb-3">How to change size</h3>
          <p className="text-mid">
            In the second row you will find a size control with - and + buttons. The value shows the offset relative to the base font size (set in the Appearance tab). Range: from -4 to +4 pixels.
          </p>
        </SectionInfo>

        <Gap variant="line" />

        <SectionInfo title="Spacing between elements">
          <p className="text-mid">
            In the <strong>Spacing</strong> tab you can precisely control the distances between individual signature elements.
          </p>
          ...
          <h3 className="h5 mt-6 mb-3">Spacing between elements</h3>
          <p className="text-mid">
            Below the padding you will find controls for individual signature elements. Each control has + and - buttons to increase or decrease the spacing. Only options for elements currently in the
            signature are visible.
          </p>
          <ul className="text-mid mt-3 list-disc space-y-2 pl-6">
            <li>
        ...
        <SectionInfo title="Legal disclaimer — when to add it">
          ...
          <p className="text-mid mt-4">
            By default, the field is filled with a sample confidentiality text. You can edit, delete, or replace it with your own disclaimer. If you leave the field empty, no disclaimer will appear in
            the signature.
          </p>
        ...
        <SectionInfo title="Auto-save and resetting settings">
          <p className="text-mid">
            The generator automatically saves all settings in browser memory (localStorage). After refreshing the page or reopening the tool, data, layout, colors, and all other options will be
            restored.
          </p>
          ...
          <p className="text-mid">
            Below the signature preview you will find a <strong>Reset appearance</strong> button. After clicking, a confirmation dialog will appear. Confirming the reset will restore all data and
            settings to default values. This operation cannot be undone.
          </p>

          <h3 className="h5 mt-6 mb-3">Export and import configuration</h3>
          <p className="text-mid">
            Below the signature preview you will find two additional buttons: <strong>Export settings</strong> and <strong>Import settings</strong>. Export saves all data, colors, layout, spacing, and
            text styles to a JSON file. Import loads a previously saved configuration from a file.
          </p>
          <p className="text-mid mt-3">
            This feature is especially useful when you want to transfer the signature configuration between computers, share settings with colleagues, or keep a backup of your settings before a reset.
          </p>
        </SectionInfo>
        ...
        <SectionSteps
          title="How to copy the signature to Gmail or Outlook"
          description="When the signature is ready, it only takes a few steps to add it to your email client:"
          grid="three"
          items={[
            {
              icon: <RiClipboardLine className="h-6 w-6" />,
              title: '1. Copy the code',
              description: 'The Copy signature (Gmail / Outlook) button copies the signature to clipboard as formatted HTML, ready to paste.',
            },
            {
              icon: <RiSettings3Line className="h-6 w-6" />,
              title: '2. Open signature settings',
              description: 'In Gmail: Settings → See all settings → Signature. In Outlook: File → Options → Mail → Signatures.',
            },
            {
              icon: <RiSaveLine className="h-6 w-6" />,
              title: '3. Paste and save',
              description: 'In the signature field, use Ctrl+V (Windows) or Cmd+V (Mac). The signature will appear with all colors and formatting. Save changes.',
            },
          ]}
        />
        ...
        <SectionInfo title="Signature preview and export options">
          <p className="text-mid">
            The preview panel displays on the right side of the editor and automatically updates with every change. The preview is sticky, so it remains visible even while scrolling through editing
            options.
          </p>

          <h3 className="h5 mt-6 mb-3">Switching preview background</h3>
          <p className="text-mid">
            Above the preview you will find three background change buttons: <strong>Light</strong> (default gray background), <strong>Dark</strong> (dark background, useful for checking readability
            on dark backgrounds), and <strong>Checkerboard</strong> (checkerboard pattern, lets you see transparency and signature edges).
          </p>

          <h3 className="h5 mt-6 mb-3">Action buttons</h3>
        ...
        <SectionSteps
          title="Who is the email signature creator for?"
          ...
          items={[
            { icon: <RiBriefcaseLine className="h-6 w-6" />, title: 'Entrepreneurs and freelancers', description: 'A professional signature in every message without hiring a designer.' },
            {
              ...
              title: 'Company teams',
              description: 'Each employee creates their own signature in the same style. Consistent identity across the entire company.',
            },
            {
              icon: <RiHandCoinLine className="h-6 w-6" />,
              title: 'Sales representatives',
              description: 'A CTA button with a link to a calendar or offer increases the chances of booking a meeting.',
            },
            {
              icon: <RiScales3Line className="h-6 w-6" />,
              title: 'Lawyers, accountants, doctors',
              description: 'Ability to add a legal disclaimer, license number, tax ID, or other details required in the industry.',
            },
          ]}
        />
        ...
        <SectionSteps
          title="What makes this HTML email signature generator special?"
          grid="three"
          items={[
            {
              icon: <RiInfinityLine className="h-6 w-6" />,
              title: 'Eight signature layouts',
              description: 'Standard, top bar, labels left, centered, compact, two columns, minimalist, and bottom bar.',
            },
            {
              icon: <RiUserLine className="h-6 w-6" />,
              title: 'Auto-save in browser',
              description: 'Every change is automatically saved in browser memory. After refreshing the page, the signature remains available.',
            },
            {
              icon: <RiTranslate2 className="h-6 w-6" />,
              title: 'Export and import configuration',
              description: 'The full signature configuration can be exported as a JSON file and shared with colleagues.',
            },
            {
              icon: <RiAppsLine className="h-6 w-6" />,
              title: '12 social media platforms',
              description: 'LinkedIn, Instagram, Facebook, TikTok, YouTube, X, GitHub, Dribbble, Behance, WhatsApp, Telegram, and Pinterest.',
            },
            { icon: <RiPaletteLine className="h-6 w-6" />, title: 'Advanced customization', description: 'Avatar shape and size, line styling, individual text colors and sizes.' },
            { icon: <RiFileCodeLine className="h-6 w-6" />, title: 'Multiple export options', description: 'Copy HTML, download file, source code preview, JSON configuration export/import.' },
            { icon: <RiShieldCheckLine className="h-6 w-6" />, title: 'Privacy', description: 'Data is not sent to a server. The generator works entirely in the browser.' },
            { icon: <RiMailCheckLine className="h-6 w-6" />, title: 'Compatibility', description: 'Generated HTML code works in Gmail, Outlook, Apple Mail, and Thunderbird.' },
            { icon: <RiEyeLine className="h-6 w-6" />, title: 'Live preview', description: 'Every change is instantly visible on light, dark, or checkerboard background.' },
          ]}
        />
        ...
        <FaqPanels
          pageUrl={toAbsoluteUrl('/en/tools/free-email-signature-generator')}
          title="Frequently asked questions about the email signature generator"
          items={[
            {
              question: 'Does the signature work in Gmail, Outlook, and Apple Mail?',
              answer:
                'Yes. Signatures generated by the generator use HTML tables that display correctly in all popular email clients: Gmail, Outlook (desktop and web), Apple Mail, Thunderbird. The layout adapts to different devices, including smartphones.',
            },
            {
            ...
            },
            {
              ...
              answer:
                'The Copy signature (Gmail / Outlook) button below the preview copies the signature to clipboard as formatted HTML. In Gmail or Outlook signature settings, just use Ctrl+V (Windows) or Cmd+V (Mac).',
            },
            {
            ...
            {
              question: 'How to export or import signature settings?',
              answer:
                'Below the signature preview you will find Export settings and Import settings buttons. Export saves the full configuration (data, colors, layout, spacing, text styles) to a JSON file. Import loads the configuration from a file and automatically applies all settings.',
            },
            {
              question: 'How to view the source code of the generated signature?',
              answer:
                'The View HTML code button below the signature preview opens a modal with the full HTML source code. You can review and copy the code directly from the modal. Alternatively, the Copy HTML code button copies the raw code to clipboard, and Download as HTML saves it as a file.',
            },
            {
            ...
            },
            {
              ...
              answer:
                'In the Disclaimer / Legal tab, enable the Show separator line option. Additional options will appear: line style (solid, dashed, dotted), thickness (1–3 px), and color (default gray or any color chosen from the palette).',
            },
          ]}
        />
