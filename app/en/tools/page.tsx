...
export const metadata = {
  ...
  description:
    '34 free online tools: 24 image converters (JPG, PNG, WebP, SVG, BMP,, GIF, AVIF, HEIC, TIFF), favicon generator, image editor, text counter, color palettes, and QR codes. No signup required.',
  ...
  return (
    <>
      <HeroBanner
        ...
        description="24 image format converters, image editor, favicon generator, text counter, color tools, and QR codes. No registration, no limits — everything runs in your browser."
      ...
      <Wrapper>
        ...
        <SectionSteps
          ...
          description="24 online image converters — convert between JPG, PNG, WebP, SVG, BMP, and GIF. Runs in your browser, no files sent to servers."
          grid="three"
          items={[
            {
            ...
            },
            {
              ...
              topImageAlt: 'BMP to PNG converter Arteon',
              topImageSrc: '/assets/tools/jpg-png-to-webp-converter/jpg-png-to-webp-unlimited-en.webp',
              description: (
                <div className="flex h-full flex-col">
                  <p>Convert BMP images to lossless PNG. Preserve quality at a smaller file size.</p>
                  <div className="mt-4">
                    <Button arrow link="/en/tools/bmp-to-png-converter">
                      Open tool
                    </Button>
                  </div>
                </div>
            ...
            },
            {
              ...
              topImageAlt: 'GIF to PNG converter Arteon',
              topImageSrc: '/assets/tools/jpg-png-to-webp-converter/jpg-png-to-webp-unlimited-en.webp',
              description: (
                <div className="flex h-full flex-col">
                  <p>Export the first frame of a GIF as a static PNG image. No quality loss.</p>
                  <div className="mt-4">
                    <Button arrow link="/en/tools/gif-to-png-converter">
                      Open tool
                    </Button>
                  </div>
                </div>
            ...
            },
            {
              ...
              topImageAlt: 'GIF to JPG converter Arteon',
              topImageSrc: '/assets/tools/jpg-png-to-webp-converter/jpg-png-to-webp-unlimited-en.webp',
              description: (
                <div className="flex h-full flex-col">
                  <p>Export the first frame of a GIF as a JPG. Smaller file, faster page loads.</p>
                  <div className="mt-4">
                    <Button arrow link="/en/tools/gif-to-jpg-converter">
                      Open tool
                    </Button>
                  </div>
                </div>
            ...
            },
            {
              ...
              topImageAlt: 'SVG to WebP converter Arteon',
              topImageSrc: '/assets/tools/jpg-png-to-webp-converter/jpg-png-to-webp-unlimited-en.webp',
              description: (
                <div className="flex h-full flex-col">
                  <p>Convert vector SVG to lightweight WebP. Ideal for websites and social media.</p>
                  <div className="mt-4">
                    <Button arrow link="/en/tools/svg-to-webp-converter">
                      Open tool
                    </Button>
                  </div>
                </div>
            ...
            },
            {
              ...
              topImageAlt: 'GIF to WebP converter Arteon',
              topImageSrc: '/assets/tools/jpg-png-to-webp-converter/jpg-png-to-webp-unlimited-en.webp',
              description: (
                <div className="flex h-full flex-col">
                  <p>Convert first GIF frame to lightweight WebP. Smaller file, faster loading.</p>
                  <div className="mt-4">
                    <Button arrow link="/en/tools/gif-to-webp-converter">
                      Open tool
                    </Button>
                  </div>
                </div>
            ...
            },
            {
              ...
              topImageAlt: 'BMP to WebP converter Arteon',
              topImageSrc: '/assets/tools/jpg-png-to-webp-converter/jpg-png-to-webp-unlimited-en.webp',
              description: (
                <div className="flex h-full flex-col">
                  <p>Convert uncompressed BMP to lightweight WebP. Up to 95% size reduction.</p>
                  <div className="mt-4">
                    <Button arrow link="/en/tools/bmp-to-webp-converter">
                      Open tool
                    </Button>
                  </div>
                </div>
            ...
            },
            {
              ...
              topImageAlt: 'AVIF to JPG converter Arteon',
              topImageSrc: '/assets/tools/jpg-png-to-webp-converter/jpg-png-to-webp-unlimited-en.webp',
              description: (
                <div className="flex h-full flex-col">
                  <p>Convert AVIF files to universal JPG. Compatible with every app and platform.</p>
                  <div className="mt-4">
                    <Button arrow link="/en/tools/avif-to-jpg-converter">
                      Open tool
                    </Button>
                  </div>
                </div>
            ...
            },
            {
              ...
              topImageAlt: 'AVIF to PNG converter Arteon',
              topImageSrc: '/assets/tools/jpg-png-to-webp-converter/jpg-png-to-webp-unlimited-en.webp',
              description: (
                <div className="flex h-full flex-col">
                  <p>Convert AVIF files to lossless PNG. Preserve full quality and transparency.</p>
                  <div className="mt-4">
                    <Button arrow link="/en/tools/avif-to-png-converter">
                      Open tool
                    </Button>
                  </div>
                </div>
            ...
            },
            {
              ...
              topImageAlt: 'AVIF to WebP converter Arteon',
              topImageSrc: '/assets/tools/jpg-png-to-webp-converter/jpg-png-to-webp-unlimited-en.webp',
              description: (
                <div className="flex h-full flex-col">
                  <p>Convert AVIF files to WebP. Wide compatibility at a small file size.</p>
                  <div className="mt-4">
                    <Button arrow link="/en/tools/avif-to-webp-converter">
                      Open tool
                    </Button>
                  </div>
                </div>
            ...
            },
            {
              ...
              topImageAlt: 'HEIC to JPG converter Arteon',
              topImageSrc: '/assets/tools/jpg-png-to-webp-converter/jpg-png-to-webp-unlimited-en.webp',
              description: (
                <div className="flex h-full flex-col">
                  <p>Convert iPhone HEIC photos to universal JPG. No signup, no server uploads.</p>
                  <div className="mt-4">
                    <Button arrow link="/en/tools/heic-to-jpg-converter">
                      Open tool
                    </Button>
                  </div>
                </div>
            ...
            },
            {
              ...
              topImageAlt: 'HEIC to PNG converter Arteon',
              topImageSrc: '/assets/tools/jpg-png-to-webp-converter/jpg-png-to-webp-unlimited-en.webp',
              description: (
                <div className="flex h-full flex-col">
                  <p>Convert iPhone HEIC photos to lossless PNG. Full quality and transparency.</p>
                  <div className="mt-4">
                    <Button arrow link="/en/tools/heic-to-png-converter">
                      Open tool
                    </Button>
                  </div>
                </div>
            ...
            },
            {
              ...
              topImageAlt: 'HEIC to WebP converter Arteon',
              topImageSrc: '/assets/tools/jpg-png-to-webp-converter/jpg-png-to-webp-unlimited-en.webp',
              description: (
                <div className="flex h-full flex-col">
                  <p>Convert iPhone HEIC photos to lightweight WebP. Smaller size, faster loading.</p>
                  <div className="mt-4">
                    <Button arrow link="/en/tools/heic-to-webp-converter">
                      Open tool
                    </Button>
                  </div>
                </div>
            ...
            },
            {
              ...
              topImageAlt: 'TIFF to JPG converter Arteon',
              topImageSrc: '/assets/tools/jpg-png-to-webp-converter/jpg-png-to-webp-unlimited-en.webp',
              description: (
                <div className="flex h-full flex-col">
                  <p>Convert TIFF files to compact JPG. Ideal for scans and archives.</p>
                  <div className="mt-4">
                    <Button arrow link="/en/tools/tiff-to-jpg-converter">
                      Open tool
                    </Button>
                  </div>
                </div>
            ...
            },
            {
              ...
              topImageAlt: 'TIFF to PNG converter Arteon',
              topImageSrc: '/assets/tools/jpg-png-to-webp-converter/jpg-png-to-webp-unlimited-en.webp',
              description: (
                <div className="flex h-full flex-col">
                  <p>Convert TIFF files to lossless PNG. Preserve full quality of scans.</p>
                  <div className="mt-4">
                    <Button arrow link="/en/tools/tiff-to-png-converter">
                      Open tool
                    </Button>
                  </div>
                </div>
            ...
            },
            {
              ...
              topImageAlt: 'TIFF to WebP converter Arteon',
              topImageSrc: '/assets/tools/jpg-png-to-webp-converter/jpg-png-to-webp-unlimited-en.webp',
              description: (
                <div className="flex h-full flex-col">
                  <p>Convert TIFF files to lightweight WebP. Massive size reduction.</p>
                  <div className="mt-4">
                    <Button arrow link="/en/tools/tiff-to-webp-converter">
                      Open tool
                    </Button>
                  </div>
                </div>
        ...
        <SectionInfo title="What are Arteon tools?">
          <p className="mb-4">
            A set of 34 free online tools for preparing materials for websites, social media, and print. Image-to-WebP converter, favicon generator, text length counter, color extractor, palette
