  ...
  mainEntity: {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'Billedrediger',
        url: toAbsoluteUrl('/da/vaerktojer/billedrediger'),
        applicationCategory: 'MultimediaApplication',
        operatingSystem: 'Any',
      },
      {
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      'Nej. Alle vaerktojer korer helt i browseren. Filerne forlader aldrig computeren og gemmes ikke noget sted.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Nej. Brug uden begraensninger -- ingen daglig graense, ingen filgraense, ingen konverteringsgraense.',
  },
  {
  ...
  {
    question: 'Virker vaerktojerne pa mobilen?',
    answer:
      'Ja, men nogle vaerktojer (WebP-konverter, favicon-generator) fungerer bedre pa desktop, da de behandler storre filer.',
  },
];
          ...
          items={[
            {
              ...
              topImageSrc:
                '/assets/tools/free-image-editor-crop-resize-and-convert/billedrediger-da.webp',
              description: (
          ...
          items={[
            {
              ...
              topImageSrc:
                '/assets/tools/free-meta-title-and-description-checker-pixel-width/meta-titel-og-beskrivelse-kontrol-da.webp',
              description: (
                <div className='flex h-full flex-col'>
                  <p>
            ...
            },
            {
              ...
              topImageSrc:
                '/assets/tools/word-and-character-counter-with-text-formatting-tools/ord-og-tegntaeller-da.webp',
              description: (
                <div className='flex h-full flex-col'>
                  <p>
          ...
          items={[
            {
              ...
              topImageSrc:
                '/assets/tools/free-html-email-signature-generator/gratis-e-mail-signatur-generator-da.webp',
              description: (
                <div className='flex h-full flex-col'>
                  <p>
          ...
          items={[
            {
              ...
              topImageSrc:
                '/assets/tools/color-contrast-and-readability-checker/farvekontrastkontrol-da.webp',
              description: (
                <div className='flex h-full flex-col'>
                  <p>
            ...
            },
            {
              ...
              topImageSrc:
                '/assets/tools/image-color-extractor/farveudtraekker-fra-billede-da.webp',
              description: (
                <div className='flex h-full flex-col'>
                  <p>
          ...
          items={[
            {
              ...
              description:
                'Alle vaerktojer behandler filer lokalt i browseren. Intet sendes til en server -- data forsvinder nar du lukker fanen.',
            },
            {
              icon: <RiInfinityFill className='h-6 w-6' />,
              title: 'Uden brugsgraense',
              description:
                'Brug uden begraensninger -- ingen daglig graense, ingen filgraense, ingen konverteringsgraense. Sa mange gange du har brug for.',
            },
            {
            ...
            },
            {
              ...
              title: 'Tilgaengelig pa dansk',
              description:
                'Alle vaerktojer er tilgaengelige pa dansk -- graenseflade, vejledninger og beskeder.',
            },
          ]}
        />
