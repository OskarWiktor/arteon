...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.arteonagency.pl/uslugi/marketing/optymalizacja-seo',
  },
  openGraph: {
    title: 'Optymalizacja SEO - szybsza strona, lepsza widoczność | Arteon',
    description:
  ...
  return (
    <>
      <HeroBanner
        ...
        description={
          <>
            Wprowadzimy zmiany, które poprawią pozycję Twojej strony w Google:
            przyspieszymy stronę, uporządkujemy treści i ułatwimy Google ich
            zrozumienie.
          </>
        }
      ...
      <Wrapper>
        ...
        <SectionInfo title='Na czym polega optymalizacja SEO i dlaczego działa?'>
          <p>
            <strong>Optymalizacja SEO to kolejny etap po audycie SEO.</strong>{' '}
            Optymalizacja pozwala na wprowadzenie konkretnych zmian na stronie
            lub sklepie internetowym, które skracają czas ładowania, porządkują
            treści i sprawiają, że Google łatwiej rozumie Twoją ofertę. Dzięki
            temu strona zyskuje wyższą pozycję w Google, a użytkownicy szybciej
            znajdują to, czego potrzebują.
          </p>
          <br />
          <p>
            <strong>Mierzymy efekty każdej zmiany.</strong> Przed realizacją
            dodajemy na Twojej witrynie narzędzia analityczne oraz zapisujemy
            stan bieżący, a po publikacji sprawdzamy, jak poprawił się czas
            ładowania, pozycje i wejścia z Google. Wiesz dokładnie, co
            zadziałało.
          </p>
        </SectionInfo>
        ...
        >
          <ul className='mt-4 list-disc space-y-2 pl-5 text-sm'>
            <li>
              Właścicieli nowych stron, które potrzebują solidnych fundamentów
              przed skalowaniem treści i stworzeniem reklam.
            </li>
            <li>
              Właścicieli sklepów internetowych, którym zależy na szybkiej
              stronie i lepszej widoczności produktów.
            </li>
            <li>
              Firm usługowych i B2B, które potrzebują stabilnie zwiększać liczbę
              zapytań od klientów z Google.
            </li>
          </ul>
        </SectionBasic>
        ...
        >
          <ul className='ml-5 list-disc space-y-2'>
            ...
            <li>
              <strong>Ilość fraz:</strong> patrzymy ile nowych fraz Google łączy
              z Twoją witryną i jak wpływa to na ruch oraz pozycję.
            </li>
            <li>
          ...
          items={[
              ...
              description: (
                <div className='flex h-full flex-col'>
                  <p className='mb-3 text-sm'>
                    Wybieramy zmiany, które dadzą najszybszy efekt w Twoim
                    przypadku.
                  </p>
                </div>
              ),
            },
            {
              ...
              description: (
                <div className='flex h-full flex-col'>
                  <p className='mb-3 text-sm'>
                    Wprowadzamy odpowiednie zmiany na stronie i informujemy o
                    nich Google.
                  </p>
                </div>
              ),
            },
            {
              ...
              description: (
                <div className='flex h-full flex-col'>
                  <p className='mb-3 text-sm'>
                    Dostajesz krótki raport z efektami optymalizacji i listę
                    następnych działań.
                  </p>
                </div>
              ),
          ...
          items={[
            {
              ...
              description: (
                <div className='flex h-full flex-col'>
                  <p className='mb-3 text-sm'>
                    Analizujemy stan Twojej witryny i tworzymy jasny plan
                    poprawek i rozwoju.
                  </p>
            ...
            },
            {
              ...
              description: (
                <div className='flex h-full flex-col'>
                  <p className='mb-3 text-sm'>
                    Stale pracujemy nad Twoją widocznością dostarczając raporty
                    działań co miesiąc.
                  </p>
                  <div className='mt-auto'>
                    <ButtonLink
          ...
          items={[
            {
              ...
              answer: (
                <p>
                  ...
                  wskazuje dokładne błędy na Twojej witrynie i pozwala opracować
                  efektywny plan działania - inwestujesz w to, co daje
                  najszybszy efekt i nie marnujesz budżetu.
                </p>
              ),
              answerSchemaText:
            ...
            },
            {
              ...
              answer: (
                <p>
                  ...
                  : rozwijamy treści, wzmacniamy strukturę i monitorujemy wyniki
                  miesięcznie.
                </p>
              ),
              answerSchemaText:
