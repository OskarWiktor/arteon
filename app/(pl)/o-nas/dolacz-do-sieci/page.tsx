...
export const metadata: Metadata = {
  ...
  description:
    'Stale rozwijamy sieć partnerów, mając na celu stworzenie przestrzeni, w której można zrealizować wszystko. Sprawdź, kogo szukamy teraz.',
  ...
  return (
    <>
      ...
      <Wrapper as='article' itemScope itemType='https://schema.org/WebPage'>
        ...
        >
          <p className='mt-2'>
            Naszą misją jest stworzenie przestrzeni, w której każdy może się rozwinąć w dowolnym
            kierunku, niezależnie od tego, z jakiego miejsca startuje. Dotyczy to zarówno naszych
            klientów, jak i naszych partnerów wykonawczych. Możesz być specjalistą od jednej rzeczy,
            ale możesz też łączyć kompetencje - na przykład robić projekty do druku i animacje. Nie
            narzucamy ścieżki. Interesuje nas to, co Ty lubisz tworzyć i w czym chcesz być coraz
            lepszy.
          </p>

          <p className='mt-3'>
            W praktyce działa to tak: gdy pojawia się zlecenie, dopasowujemy projekt do osoby,
            której profil i styl pracy najlepiej pasują do oczekiwań klienta. Czasem przekazujemy
            konkretny etap, a czasem cały projekt - w zależności od zakresu i od tego, co będzie dla
            obu stron najwygodniejsze.
          </p>

          <p className='mt-3'>
            Jeśli interesuje Cię rozwój w kierunku realizowania projektów dla różnych
            przedsiębiorców, napisz do nas.
          </p>
        </SectionInfo>
        ...
        <SectionInfo
          title='Inne obszary współpracy'
          description='Lista obszarów zmienia się wraz z potrzebami klientów.'
        >
          <p className='text-mid mt-2'>
            Poza wymienionymi kierunkami współpracujemy również przy projektach związanych ze
            stronami internetowymi, blogami, e-commerce, brandingiem, projektami do druku,
            treściami, SEO, UX czy działaniami marketingowymi.
          </p>

          <p className='text-mid mt-3'>
            Jeżeli Twojej specjalizacji nie ma na liście, ale wiesz, że tworzysz wartościowe
            materiały i chcesz mieć przestrzeń, która pozwoli Ci na rozwój na własnych zasadach,
            napisz do nas. Zależy nam na tym, aby znać osoby, do których możemy przekazywać naszych
            klientów.
          </p>
        </SectionInfo>
