...
const FAQ_ITEMS: FaqItem[] = [
  {
    ...
    answer: (
      <p>
        Zawsze zaczynamy od rozmowy i poznania Twoich indywidualnych potrzeb. Cały plan i wycenę
        dostosowujemy do Twoich celów, odbiorców, zakresu prac i priorytetów. Do pierwszej wyceny
        zwykle wystarczy zarys zakresu prac oraz Twoje oczekiwania - resztę dopracujemy po
        dokładniejszym zapoznaniu się z tematem. Najszybciej możesz skontaktować się przez{' '}
  ...
  {
    question:
      'Czy zajmujecie się tworzeniem treści i pozycjonowaniem? Czy mogę to zlecić po czasie?',
    answer: (
      <p>
        Tak. Po zrealizowaniu każdego projektu, w tym witryny internetowej, zawsze dajemy kilka
        porad, co można zrobić, aby zwiększyć widoczność lub ułatwić pracę (np. przez dodanie
        automatyzacji, takich jak kalendarz rezerwacji). Jeśli potrzebujesz pełnego wsparcia w
        tekstach, napisz do nas lub sprawdź naszą ofertę{' '}
  ...
  },
  {
    ...
    answer:
      'Jak najbardziej. Przed startem pracy nad stroną zawsze przygotowujemy jej wygląd. Gotowy projekt lub inspiracja mogą znacząco skrócić czas realizacji i zmniejszyć jej koszt.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Zawsze rekomendujemy analitykę, bo dzięki niej widać, jak radzi sobie witryna. Nie jest to jednak domyślna modyfikacja - wdrażamy ją po Twoim zatwierdzeniu.',
  },
  {
    question: 'Czy mogę mieć wersję wielojęzyczną strony?',
    answer:
      'Bez problemu. Wdrażamy wersje językowe w taki sposób, aby maksymalnie wzmocnić efekt SEO dla Twojej witryny.',
  },
  {
    question: 'Czy przeniesiecie treści ze starej strony (migracja)?',
    answer:
      'Tak, zajmujemy się również migracją stron bez utraty pozycji. Po zapoznaniu się z Twoją starą stroną przygotujemy dokładny plan dla takiego projektu.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Przeważnie komunikujemy się poprzez wiadomości e-mail, rozmowy wideo  oraz rozmowy telefoniczne. Proces komunikacji dopasowujemy do tego, co jest dla Ciebie najlepsze. W trakcie współpracy dostajesz od nas pełne raporty zrealizowanych prac oraz aktualny postęp bardziej złożonych etapów.',
  },
  {
...
export const metadata: Metadata = {
  ...
  description:
    'Odpowiadamy na najczęstsze pytania dotyczące współpracy: proces, terminy, wycena, treści, SEO, utrzymanie i odpowiedzialność po wdrożeniu.',
  ...
  return (
    <>
      ...
      <Breadcrumbs
        ...
        third={{ href: '/o-nas/faq', label: 'FAQ' }}
        includeJsonLd
      />
      ...
      <Wrapper as='article' itemScope itemType='https://schema.org/FAQPage'>
        ...
        <SectionFaqPanels
          ...
          pageUrl={toAbsoluteUrl('/o-nas/faq')}
        />
