      ...
      <Wrapper as="article" id="article-root" itemScope itemType="https://schema.org/Article" className="grid gap-8 select-none lg:grid-cols-[1fr_300px]">
        <div>
          ...
          <SectionInfo id="postanowienia" title="1. Postanowienia ogólne">
            <p>1.1. Usługodawca: Arteon Wiktoria Wiktor.</p>
          ...
          {/* [6] Zmiany zakresu (change request) */}
          ...
          {/* [12] Odpowiedzialność, poufność, siła wyższa */}
          ...
          {/* [13] Konsumenci i przedsiębiorcy uprzywilejowani */}
          ...
          {/* [16] Zmiany regulaminu, prawo i spory */}
