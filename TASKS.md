...
- ❌ **[IDEA-007] Licznik meta title/description: podgląd SERP desktop/mobile + wzory do skopiowania**
  ...
  - SEO:
    - URL/slug: `/narzedzia/licznik-dlugosci-meta-title-i-description`
    ...
    - OG image: `public/assets/tools/narzedzia-licznik-dlugosci-meta-title-i-description.webp`
...
- ❌ **[IDEA-008] Tester kontrastu WCAG: obsługa HSL/alpha + propozycja koloru spełniającego AA/AAA**
  - Cel i uzasadnienie:
    - Projektanci często pracują na HSL, a w UI realnie występują też kolory z alpha (RGBA) — wsparcie formatów zmniejsza tarcie.
