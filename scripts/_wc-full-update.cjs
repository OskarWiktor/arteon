...
const L = {
  pl: {
    ...
    heroDesc: 'Wklej tekst, a narzędzie policzy słowa, znaki, sylaby, zdania, akapity, unikalne wyrazy, czas czytania, czas mówienia i obliczy wynik czytelności Flesch-Kincaid. Zmień wielkość liter, usuń duplikaty lub posortuj linie jednym kliknięciem.',
    ...
    schemaDesc: 'Darmowy licznik słów i znaków z oceną czytelności Flesch-Kincaid, liczeniem sylab, szacowaniem czasu czytania i mówienia oraz 10 narzędziami do formatowania tekstu. Przetwarzanie lokalne w przeglądarce.',
    schemaFeatures: [
    ...
    metricItems: [
      ...
      { icon: 'RiSpaceShipLine', title: 'Znaki (ze spacjami)', description: 'Wszystkie znaki łącznie ze spacjami. Przydatne, gdy platforma ma limit znaków (np. opisy na Allegro, OLX, meta description).' },
      ...
      { icon: 'RiSpeedLine', title: 'Czytelność (Flesch-Kincaid)', description: 'Wynik 0\u2013100 wskazujący łatwość czytania tekstu. Powyżej 70 = łatwy, 50\u201370 = umiarkowany, poniżej 30 = akademicki. Kolorowy wskaźnik ułatwia szybką ocenę.' }
    ],
    toolItems: [
    ...
    whoItems: [
      { icon: 'RiEditLine', title: 'Copywriterzy i redaktorzy', description: 'Liczenie słów i znaków, sprawdzanie limitów platform, szybka zmiana wielkości liter i czyszczenie tekstu przed publikacją.' },
    ...
    specialItems: [
      { icon: 'RiBarChartLine', title: '11 metryk tekstu + wynik czytelności', description: 'Słowa, znaki, sylaby, zdania, akapity, unikalne słowa, czas czytania, czas mówienia i wynik Flesch-Kincaid \u2013 wszystko w jednym panelu.' },
      { icon: 'RiTextWrap', title: '10 narzędzi do formatowania', description: 'Zamiana wielkości liter, usuwanie spacji, pustych linii, duplikatów i sortowanie \u2013 bez instalowania dodatkowych programów.' },
      ...
      { icon: 'RiTimerLine', title: 'Natychmiastowe wyniki', description: 'Statystyki aktualizują się w czasie rzeczywistym podczas wpisywania lub wklejania tekstu. Bez oczekiwania na przetwarzanie.' },
    ...
    faqItems: [
      {
        ...
        answer: 'Narzędzie dzieli liczbę słów przez 200 \u2013 to średnia prędkość czytania dla typowego tekstu. Tekst techniczny lub wymagający skupienia (np. dokumentacja, regulamin) będzie czytany wolniej. Lekki artykuł lifestylowy \u2013 szybciej. Wynik to orientacyjna wartość, która pomaga ocenić, ile czasu czytelnik spędzi z tekstem.',
      ...
      },
      {
        ...
        answer: 'Znaki ze spacjami to wszystkie znaki w tekście łącznie ze spacjami, tabulatorami i znakami nowej linii. Znaki bez spacji to tylko litery, cyfry i interpunkcja. Platformy takie jak Allegro czy OLX mają limity w znakach ze spacjami. Biura tłumaczeń i drukarnie rozliczają się w znakach bez spacji.',
      ...
      },
      {
        ...
        answer: 'Unikalne słowa to liczba niepowtarzających się wyrazów w tekście. Jeśli słowo marketing pojawia się 5 razy, liczy się jako 1 unikalne słowo. Wysoki stosunek unikalnych słów do wszystkich słów wskazuje na bogate słownictwo i mniejszą powtarzalność tekstu.',
      ...
      },
      {
        ...
        answer: 'Funkcja porównuje każdą linię tekstu z pozostałymi i zachowuje tylko pierwsze wystąpienie. Powtarzające się linie są usuwane. Przydatne do czyszczenia list słów kluczowych, adresów e-mail, danych z arkuszy kalkulacyjnych i wszelkich zbiorów, w których mogą pojawić się duplikaty.',
      ...
      },
      {
        ...
        answer: 'Tak. Cała analiza i przetwarzanie tekstu odbywają się wyłącznie w przeglądarce \u2013 tekst nie jest wysyłany na żaden serwer. Narzędzie nie zapisuje ani nie przechowuje wklejonego tekstu. Po zamknięciu strony tekst znika bezpowrotnie.',
      ...
      },
      {
        ...
        answer: 'Czas mówienia to szacunek uzyskany przez podzielenie liczby słów przez 130 \u2013 średnią prędkość mówienia podczas prezentacji i wystąpień publicznych. Jest wolniejszy niż 200 słów na minutę przyjmowane dla czasu czytania, ponieważ mowa wymaga naturalnych pauz, akcentowania i oddychania.',
  ...
  de: {
    ...
    heroDesc: 'Text einfügen \u2013 das Tool zählt Wörter, Zeichen, Silben, Sätze, Absätze, einzigartige Wörter, Lesezeit, Sprechzeit und berechnet den Flesch-Kincaid-Lesbarkeitsindex. Groß-/Kleinschreibung ändern, Duplikate entfernen oder Zeilen sortieren.',
    ...
    schemaDesc: 'Kostenloser Wort- und Zeichenzähler mit Flesch-Kincaid Lesbarkeitsbewertung, Silbenzählung, Lese- und Sprechzeitschätzung und 10 Textformatierungswerkzeugen. Verarbeitung lokal im Browser.',
    schemaFeatures: [
      'Wörter zählen',
    ...
    metricItems: [
      ...
      { icon: 'RiSpaceShipLine', title: 'Zeichen (mit Leerzeichen)', description: 'Alle Zeichen einschließlich Leerzeichen. Nützlich bei Zeichenlimits auf Plattformen (z.B. Amazon-Titel, Meta-Descriptions).' },
      ...
      { icon: 'RiInputMethodLine', title: 'Silben', description: 'Gesamtzahl der Silben mit sprachspezifischen Heuristiken. Erkennt deutsche Diphthonge (ei, au, eu, äu). Schlüsselparameter für Lesbarkeitsformeln.' },
      { icon: 'RiSpeedLine', title: 'Lesbarkeit (Flesch-Kincaid)', description: 'Ein Wert von 0\u2013100, der die Lesbarkeit anzeigt. Über 70 = leicht, 50\u201370 = mittel, unter 30 = akademisch. Farbcodiert für schnelle Bewertung. Für Deutsch wird die Amstad-Formel verwendet.' }
    ],
    toolItems: [
    ...
    whoItems: [
      { icon: 'RiEditLine', title: 'Texter und Redakteure', description: 'Wörter und Zeichen zählen, Plattformlimits prüfen, Groß-/Kleinschreibung ändern und Text vor der Veröffentlichung bereinigen.' },
      ...
      { icon: 'RiGraduationCapLine', title: 'Studenten und Wissenschaftler', description: 'Wort- oder Zeichenlimits in Hausarbeiten und wissenschaftlichen Texten prüfen. Lesbarkeit der Abschlussarbeit bewerten.' },
    ...
    specialItems: [
      { icon: 'RiBarChartLine', title: '11 Textmetriken + Lesbarkeitsindex', description: 'Wörter, Zeichen, Silben, Sätze, Absätze, einzigartige Wörter, Lesezeit, Sprechzeit und Flesch-Kincaid \u2013 alles in einem Panel.' },
    ...
    faqItems: [
      {
        ...
        answer: 'Das Tool teilt die Wortanzahl durch 200 \u2013 die durchschnittliche Lesegeschwindigkeit für typischen Text. Technische Texte werden langsamer gelesen, leichte Artikel schneller. Das Ergebnis ist ein Richtwert.',
      ...
      },
      {
        ...
        answer: 'Zeichen mit Leerzeichen umfasst alle Zeichen einschließlich Leerzeichen, Tabulatoren und Zeilenumbrüchen. Zeichen ohne Leerzeichen enthält nur Buchstaben, Ziffern und Satzzeichen. Übersetzungsbüros rechnen nach Zeichen ohne Leerzeichen ab. Plattformen wie Amazon haben Limits in Zeichen mit Leerzeichen.',
      ...
      },
      {
        ...
        answer: 'Das Tool bietet 5 Modi: GROSSBUCHSTABEN (alles groß), kleinbuchstaben (alles klein), Satzanfang groß (erster Buchstabe jedes Satzes), Titelschreibweise (jedes Wort groß) und Umkehren (Groß wird klein und umgekehrt). Klicken Sie den gewünschten Button in der Werkzeugleiste.',
        answerSchemaText: 'Das Tool hat 5 Modi: GROSS, klein, Satzanfang, Titelschreibweise und Umkehren.'
      },
      {
        question: 'Ist mein Text sicher?',
        answer: 'Ja. Alle Analyse und Verarbeitung erfolgt ausschließlich in Ihrem Browser \u2013 der Text wird nie an einen Server gesendet. Das Tool speichert keinen eingefügten Text. Nach dem Schließen der Seite ist der Text unwiederbringlich weg.',
      ...
      },
      {
        ...
        answer: 'Die Sprechzeit wird berechnet, indem die Wortanzahl durch 130 geteilt wird \u2013 die durchschnittliche Sprechgeschwindigkeit bei Präsentationen und Reden. Das ist langsamer als 200 Wörter pro Minute beim Lesen, da Sprechen natürliche Pausen, Betonungen und Atempausen beinhaltet.',
      ...
      },
      {
        ...
        answer: 'Das Tool verwendet sprachspezifische Heuristiken. Für Deutsch erkennt es Diphthonge (ei, au, eu, äu), Umlaute und typische Silbenstrukturen zusammengesetzter Wörter. Für Englisch werden stille Buchstaben, Suffixe (-ed, -es, -le) und Diphthonge berücksichtigt. Die Zählung ist approximativ, aber ausreichend für Lesbarkeitsbewertungen.',
  ...
  es: {
    ...
    heroDesc: 'Pega tu texto y la herramienta contará palabras, caracteres, sílabas, oraciones, párrafos, palabras únicas, tiempo de lectura, tiempo de habla y calculará la puntuación de legibilidad Flesch-Kincaid. Cambia mayúsculas, elimina duplicados o ordena líneas con un clic.',
    ...
    schemaDesc: 'Contador gratuito de palabras y caracteres con puntuación de legibilidad Flesch-Kincaid (fórmula Fernández-Huerta para español), conteo de sílabas, estimación de tiempo de lectura y habla, y 10 herramientas de formateo. Procesamiento local en el navegador.',
    schemaFeatures: [
      'Conteo de palabras',
    ...
    howToStep2: 'En el panel izquierdo verás 11 métricas: palabras, caracteres con y sin espacios, oraciones, párrafos, palabras únicas, longitud promedio, tiempo de lectura, tiempo de habla, sílabas y puntuación Flesch-Kincaid.',
    sectionBasicHtml: '<p class="text-mid">Esta herramienta combina un contador de palabras y caracteres con análisis de legibilidad Flesch-Kincaid y funciones de formateo de texto. Pega tu texto y verás el conteo de palabras, caracteres, sílabas, oraciones, párrafos, palabras únicas, tiempo de lectura, tiempo de habla y una puntuación de legibilidad con código de color.</p><p class="text-mid mt-3">La <strong>puntuación Flesch-Kincaid</strong> (0\u2013100) indica qué tan fácil es leer tu texto. Para textos en español se usa la <strong>fórmula Fernández-Huerta</strong>: 206,84 \u2212 60 \u00d7 (sílabas/palabras) \u2212 1,02 \u00d7 (palabras/oraciones). Puntuaciones superiores a 70 indican lectura fácil; inferiores a 30 indican nivel académico.</p><p class="text-mid mt-3">Debajo del campo de texto encontrarás 10 herramientas: conversión de mayúsculas/minúsculas, eliminación de espacios, líneas vacías, duplicados y ordenación alfabética. Todo el procesamiento ocurre localmente en tu navegador.</p>',
    ...
    metricItems: [
      ...
      { icon: 'RiSpaceShipLine', title: 'Caracteres (con espacios)', description: 'Todos los caracteres incluyendo espacios. Útil cuando una plataforma tiene límite de caracteres (Amazon, meta descriptions).' },
      ...
      { icon: 'RiChatQuoteLine', title: 'Oraciones', description: 'Número de oraciones en el texto. Ayuda a evaluar la complejidad y legibilidad \u2013 las oraciones más cortas son más fáciles de absorber.' },
      ...
      { icon: 'RiRulerLine', title: 'Longitud promedio de palabra', description: 'Promedio de caracteres por palabra. Un indicador de complejidad \u2013 los textos técnicos tienen palabras más largas.' },
      ...
      { icon: 'RiInputMethodLine', title: 'Sílabas', description: 'Total de sílabas usando heurísticas del idioma español. Reconoce diptongos (ai, ei, oi, au, eu) e hiatos. Parámetro clave para fórmulas de legibilidad.' },
      { icon: 'RiSpeedLine', title: 'Legibilidad (Flesch-Kincaid)', description: 'Puntuación de 0\u2013100 que indica la facilidad de lectura. Más de 70 = fácil, 50\u201370 = moderado, menos de 30 = académico. Con código de color para evaluación rápida.' }
    ],
    toolItems: [
    ...
    whoItems: [
      ...
      { icon: 'RiBloggerLine', title: 'Bloggers y creadores de contenido', description: 'Controlar la longitud de publicaciones, verificar legibilidad y tiempo de lectura, eliminar duplicados y ordenar listas.' },
    ...
    specialItems: [
      { icon: 'RiBarChartLine', title: '11 métricas + puntuación de legibilidad', description: 'Palabras, caracteres, sílabas, oraciones, párrafos, palabras únicas, tiempo de lectura, tiempo de habla y Flesch-Kincaid \u2013 todo en un panel.' },
      { icon: 'RiTextWrap', title: '10 herramientas de formateo', description: 'Cambio de mayúsculas, eliminación de espacios, líneas vacías, duplicados y ordenación \u2013 sin instalar software adicional.' },
      { icon: 'RiUserLine', title: 'Procesamiento local en el navegador', description: 'Tu texto nunca se envía a ningún servidor. Todo el análisis y la transformación ocurren localmente en tu dispositivo.' },
    ...
    faqItems: [
      {
        ...
        answer: 'La herramienta divide el número de palabras por 200 \u2013 la velocidad de lectura promedio para texto típico. Textos técnicos se leen más lento, artículos ligeros más rápido. El resultado es un valor aproximado.',
      ...
      },
      {
        ...
        answer: 'Caracteres con espacios incluye todos los caracteres del texto incluyendo espacios, tabulaciones y saltos de línea. Caracteres sin espacios incluye solo letras, dígitos y puntuación. Las agencias de traducción facturan por caracteres sin espacios. Plataformas como Amazon tienen límites en caracteres con espacios.',
      ...
      },
      {
        ...
        answer: 'Sí. Todo el análisis y procesamiento ocurre exclusivamente en tu navegador \u2013 el texto nunca se envía a ningún servidor. La herramienta no guarda ni almacena el texto pegado. Al cerrar la página, el texto desaparece permanentemente.',
      ...
      },
      {
        ...
        answer: 'El índice Flesch Reading Ease es un número de 0 a 100 que indica qué tan fácil es leer un texto. Para español se usa la fórmula Fernández-Huerta: 206,84 \u2212 60 \u00d7 (sílabas/palabras) \u2212 1,02 \u00d7 (palabras/oraciones). Una puntuación de 90\u2013100 significa muy fácil, 70\u201389 fácil, 50\u201369 moderado, 30\u201349 difícil y 0\u201329 muy difícil.',
      ...
      },
      {
        ...
        answer: 'El tiempo de habla se estima dividiendo el número de palabras por 130 \u2013 la velocidad promedio de habla en presentaciones. Es más lento que las 200 palabras por minuto del tiempo de lectura, porque hablar incluye pausas naturales, énfasis y respiración.',
      ...
      },
      {
        ...
        answer: 'La herramienta usa heurísticas específicas del español que reconocen diptongos (ai, ei, oi, au, eu), hiatos y reglas de silabificación del castellano. El conteo es aproximado pero suficiente para puntuaciones de legibilidad y análisis de texto.',
...
for (const loc of ALL_LOCALES) {
  ...
  const t = L[loc];
  if (!t) { console.log('SKIP (no translations):', loc); continue; }
  ...
  for (let i = 0; i < data.contentBlocks.length; i++) {
    ...
    // Metrics section
    if (block.type === 'sectionSteps' && block.items && block.items.length >= 7 && block.items.length <= 11 &&
        block.items[0] && block.items[0].icon === 'RiText') {
    ...
    if (block.type === 'sectionSteps' && block.items && block.items.length === 10 &&
        block.items[0] && block.items[0].icon === 'RiArrowUpLine') {
      block.items = t.toolItems;
    }

    // "Who is this for" section
    if (block.type === 'sectionSteps' && block.items && block.items.length === 6 &&
        block.items[0] && block.items[0].icon === 'RiEditLine' &&
        block.items[1] && block.items[1].icon === 'RiBloggerLine') {
    ...
    if (block.type === 'sectionSteps' && block.items && block.items.length === 6 &&
        block.items[0] && block.items[0].icon === 'RiBarChartLine') {
    ...
    if (block.type === 'sectionSteps' && block.grid === 'four' && block.items && block.items.length === 4 &&
        block.items[0] && block.items[0].icon === 'RiFileTextLine') {
