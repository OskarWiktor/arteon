...
const L = {
  ro: {
    ...
    heroDesc:
      'Lipeste textul si instrumentul va numara cuvinte, caractere, silabe, propozitii, paragrafe, cuvinte unice, timp de citire, timp de vorbire si va calcula scorul de lizibilitate Flesch-Kincaid.',
    ...
    howToStep2:
      'In panoul din stanga vei vedea 11 metrici: cuvinte, caractere cu si fara spatii, propozitii, paragrafe, cuvinte unice, lungime medie, timp de citire, timp de vorbire, silabe si scor Flesch-Kincaid.',
    sectionBasicHtml:
      '<p class="text-mid">Acest instrument combina un contor de cuvinte si caractere cu analiza lizibilitatii Flesch-Kincaid si functii de formatare text. Lipeste textul pentru a vedea cuvinte, caractere, silabe, propozitii, paragrafe, cuvinte unice, timp de citire, timp de vorbire si un scor de lizibilitate colorat.</p><p class="text-mid mt-3"><strong>Scorul Flesch-Kincaid</strong> (0\u2013100) arata cat de usor este de citit textul. Scoruri peste 70 inseamna text usor, sub 30 nivel academic. Instrumentul foloseste formule adaptate pentru 16 limbi.</p><p class="text-mid mt-3">Sub campul de text vei gasi 10 instrumente: conversie majuscule/minuscule, eliminare spatii, linii goale, duplicate si sortare. Toata procesarea are loc local in browser.</p>',
    metricsTitle: '11 metrici text \u2013 ce masoara contorul',
    metricsDesc: 'Contorul analizeaza textul cu unsprezece indicatori:',
    speakingTitle: 'Timp de vorbire',
    speakingDesc: 'Timp estimat la 130 cuvinte pe minut. Util pentru discursuri si prezentari.',
    syllablesTitle: 'Silabe',
    syllablesDesc: 'Total silabe cu euristici lingvistice. Parametru cheie pentru formulele de lizibilitate.',
    readabilityTitle: 'Lizibilitate (Flesch-Kincaid)',
    readabilityDesc: 'Scor 0\u2013100. Peste 70 = usor, 50\u201370 = moderat, sub 30 = academic. Codat prin culori.',
    specialTitle: 'Ce face acest contor special?',
    specialMetrics: '11 metrici + scor lizibilitate',
    specialMetricsDesc: 'Cuvinte, caractere, silabe, propozitii, paragrafe, cuvinte unice, timp citire, timp vorbire si Flesch-Kincaid.',
    faqNew: [
      {
        question: 'Ce este scorul Flesch-Kincaid?',
        answer:
          'Scorul Flesch Reading Ease (0\u2013100) indica usurinta de citire. 90\u2013100 = foarte usor, 70\u201389 = usor, 50\u201369 = moderat, 30\u201349 = dificil, 0\u201329 = foarte dificil.',
        answerSchemaText: 'Flesch Reading Ease (0\u2013100) masoara lizibilitatea.',
      },
      ...
      {
        question: 'Cat de precis este contorul de silabe?',
        answer: 'Instrumentul foloseste euristici specifice limbii care recunosc diftongi si modele de vocale.',
        answerSchemaText: 'Euristici lingvistice cu diftongi si vocale.',
      },
    ],
  },
  hu: {
    ...
    heroDesc:
      'Illeszd be a szoveget, es az eszkoz megszamolja a szavakat, karaktereket, szotagokat, mondatokat, bekezdéseket, egyedi szavakat, olvasasi es beszedidot, es kiszamitja a Flesch-Kincaid olvashatosagi pontszamot.',
    ...
    howToStep2:
      'A bal oldali panelen 11 metrikat latsz: szavak, karakterek szokozokkel es nelkul, mondatok, bekezdések, egyedi szavak, atlagos szohossz, olvasasi ido, beszedido, szotagok es Flesch-Kincaid pontszam.',
    sectionBasicHtml:
      '<p class="text-mid">Ez az eszkoz otvozi a szo- es karakterszamlalot a Flesch-Kincaid olvashatosagi elemzessel es szovegformazo funkciokkal. Illeszd be a szoveget, es megjelenik a szavak, karakterek, szotagok, mondatok, bekezdések, egyedi szavak, olvasasi ido, beszedido es a szinkodolt olvashatosagi pontszam.</p><p class="text-mid mt-3">A <strong>Flesch-Kincaid olvashatosagi pontszam</strong> (0\u2013100) megmutatja, mennyire konnyu olvasni a szoveget. 70 feletti pontszam konnyu olvasast, 30 alatti akademiai szintet jelent.</p><p class="text-mid mt-3">A szovegmezo alatt 10 eszkozt talalsz: kis-nagybetu atalakitas, szokozok, ures sorok, duplikatumok eltavolitasa es rendezes. Minden feldolgozas helyben, a bongeszoben tortenik.</p>',
    metricsTitle: '11 szovegmetrika \u2013 mit mer a szamlalo?',
    metricsDesc: 'A szamlalo tizenegy mutatoval elemzi a szoveget:',
    speakingTitle: 'Beszedido',
    speakingDesc: 'Becsult beszedido 130 szo/perc sebesseggel. Eloadasokhoz es prezentaciokhoz.',
    syllablesTitle: 'Szotagok',
    syllablesDesc: 'Összesen szotagok szama nyelvspecifikus heurisztikakkal.',
    readabilityTitle: 'Olvashatosag (Flesch-Kincaid)',
    readabilityDesc: 'Pontszam 0\u2013100. 70 felett = konnyu, 50\u201370 = kozepes, 30 alatt = akademiai. Szinkodolt.',
    specialTitle: 'Mi teszi kulonlegesse ezt a szoszamlalot?',
    specialMetrics: '11 metrika + olvashatosagi pontszam',
    specialMetricsDesc: 'Szavak, karakterek, szotagok, mondatok, bekezdések, egyedi szavak, olvasasi ido, beszedido es Flesch-Kincaid.',
    faqNew: [
      {
        question: 'Mi az a Flesch-Kincaid pontszam?',
        answer:
          'A Flesch Reading Ease (0\u2013100) azt mutatja, mennyire konnyu olvasni a szoveget. 90\u2013100 = nagyon konnyu, 70\u201389 = konnyu, 50\u201369 = kozepes, 30\u201349 = nehez, 0\u201329 = nagyon nehez.',
        answerSchemaText: 'Flesch Reading Ease (0\u2013100), magasabb = konnyebb.',
      },
      ...
      {
        question: 'Mennyire pontos a szotagszamlalo?',
        answer: 'Nyelvspecifikus heurisztikakat hasznal. A magyar eseteban figyelembe veszi a maganhangzo-szabalyokat.',
        answerSchemaText: 'Nyelvspecifikus heurisztikak.',
      },
    ],
  },
  cs: {
    ...
    sectionBasicHtml:
      '<p class="text-mid">Tento nastroj kombinuje pocitadlo slov a znaku s analyzou citelnosti Flesch-Kincaid a funkcemi formatovani textu. Vlozte text a uvidite pocet slov, znaku, slabik, vet, odstavcu, unikatnich slov, dobu cteni, dobu mluveni a barevne kodovane skore citelnosti.</p><p class="text-mid mt-3"><strong>Skore Flesch-Kincaid</strong> (0\u2013100) ukazuje, jak snadno se text cte. Hodnoty nad 70 znamenaji snadne cteni, pod 30 akademickou uroven.</p><p class="text-mid mt-3">Pod textovym polem najdete 10 nastroju: prevod velkych/malych pismen, odstraneni mezer, prazdnych radku, duplicit a razeni. Vse probiha lokalne v prohlizeci.</p>',
    metricsTitle: '11 textovych metrik \u2013 co pocitadlo meri',
    metricsDesc: 'Pocitadlo analyzuje text pomoci jedenacti ukazatelu:',
    speakingTitle: 'Doba mluveni',
    speakingDesc: 'Odhadovana doba mluveni pri 130 slovech za minutu. Pro prezentace a projevy.',
    syllablesTitle: 'Slabiky',
    syllablesDesc: 'Celkovy pocet slabik s jazykovymi heuristikami. Klicovy parametr pro vzorce citelnosti.',
    readabilityTitle: 'Citelnost (Flesch-Kincaid)',
    readabilityDesc: 'Skore 0\u2013100. Nad 70 = snadne, 50\u201370 = stredni, pod 30 = akademicke. Barevne kodovano.',
    specialTitle: 'Co dela toto pocitadlo vyjimecnym?',
    specialMetrics: '11 metrik + skore citelnosti',
    specialMetricsDesc: 'Slova, znaky, slabiky, vety, odstavce, unikatni slova, doba cteni, mluveni a Flesch-Kincaid.',
    faqNew: [
      {
        question: 'Co je skore Flesch-Kincaid?',
        answer: 'Flesch Reading Ease (0\u2013100) ukazuje snadnost cteni. 90\u2013100 = velmi snadne, 70\u201389 = snadne, 50\u201369 = stredni, 30\u201349 = obtizne, 0\u201329 = velmi obtizne.',
      ...
      {
        question: 'Jak presny je pocitadlo slabik?',
        answer: 'Nastroj pouziva heuristiky specificke pro dany jazyk. Pro cestinu rozpoznava souhlaskove skupiny a slabikotvorné souhlasky (r, l).',
        answerSchemaText: 'Jazykove heuristiky.',
      },
    ],
  },
  sv: {
    ...
    faqNew: [
      ...
      {
        question: 'Hur exakt ar stavelseraknaren?',
        answer: 'Verktyget anvander sprakspecifika heuristiker som kanner igen svenska diftonger och sammansatta ord.',
        answerSchemaText: 'Sprakspecifika heuristiker.',
      },
    ],
  },
};
