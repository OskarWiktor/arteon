...
const L = {
  fr: {
    ...
    heroDesc: 'Collez votre texte et l\u2019outil comptera les mots, caractères, syllabes, phrases, paragraphes, mots uniques, temps de lecture, temps de parole et calculera le score de lisibilité Flesch-Kincaid. Changez la casse, supprimez les doublons ou triez les lignes en un clic.',
    ...
    schemaDesc: 'Compteur gratuit de mots et caractères avec score de lisibilité Flesch-Kincaid (formule Kandel-Moles pour le français), comptage de syllabes, estimation du temps de lecture et de parole, et 10 outils de formatage. Traitement local dans le navigateur.',
    schemaFeatures: [
      'Comptage de mots',
    ...
    metricItems: [
      ...
      { icon: 'RiSpaceShipLine', title: 'Caractères (avec espaces)', description: 'Tous les caractères y compris les espaces. Utile quand une plateforme a une limite de caractères (Amazon, méta-descriptions).' },
      ...
      { icon: 'RiChatQuoteLine', title: 'Phrases', description: 'Nombre de phrases dans le texte. Aide à évaluer la complexité et la lisibilité \u2013 les phrases courtes sont plus faciles à assimiler.' },
      ...
      { icon: 'RiInputMethodLine', title: 'Syllabes', description: 'Total des syllabes avec heuristiques adaptées au français. Reconnaît les diphtongues (ou, ai, oi, eau) et les lettres muettes. Paramètre clé des formules de lisibilité.' },
      { icon: 'RiSpeedLine', title: 'Lisibilité (Flesch-Kincaid)', description: 'Score de 0\u2013100 indiquant la facilité de lecture. Plus de 70 = facile, 50\u201370 = modéré, moins de 30 = académique. Codé par couleur pour une évaluation rapide.' }
    ],
    toolItems: [
    ...
    whoItems: [
      { icon: 'RiEditLine', title: 'Rédacteurs et éditeurs', description: 'Compter mots et caractères, vérifier les limites des plateformes, changer la casse et nettoyer le texte avant publication.' },
      { icon: 'RiBloggerLine', title: 'Blogueurs et créateurs de contenu', description: 'Contrôler la longueur des publications, vérifier la lisibilité et le temps de lecture, supprimer les doublons.' },
    ...
    specialItems: [
      { icon: 'RiBarChartLine', title: '11 métriques + score de lisibilité', description: 'Mots, caractères, syllabes, phrases, paragraphes, mots uniques, temps de lecture, temps de parole et Flesch-Kincaid \u2013 tout dans un panneau.' },
      ...
      { icon: 'RiUserLine', title: 'Traitement local dans le navigateur', description: 'Votre texte n\u2019est jamais envoyé à un serveur. Analyse et transformation se font localement sur votre appareil.' },
    ...
    faqItems: [
      { question: 'Comment le temps de lecture est-il calculé ?', answer: 'L\u2019outil divise le nombre de mots par 200 \u2013 la vitesse de lecture moyenne pour un texte standard. Les textes techniques sont lus plus lentement, les articles légers plus vite.', answerSchemaText: 'L\u2019outil assume 200 mots par minute comme vitesse de lecture moyenne.' },
      { question: 'Quelle est la différence entre caractères avec et sans espaces ?', answer: 'Caractères avec espaces inclut tous les caractères y compris espaces et tabulations. Caractères sans espaces inclut uniquement lettres, chiffres et ponctuation. Les agences de traduction facturent en caractères sans espaces.', answerSchemaText: 'Avec espaces inclut tout ; sans espaces uniquement lettres et chiffres.' },
      { question: 'Mon texte est-il en sécurité ?', answer: 'Oui. Toute l\u2019analyse et le traitement se font exclusivement dans votre navigateur \u2013 le texte n\u2019est jamais envoyé à un serveur. L\u2019outil ne sauvegarde rien.', answerSchemaText: 'Oui. Le texte est traité localement et jamais envoyé à un serveur.' },
      { question: 'Qu\u2019est-ce que le score Flesch-Kincaid ?', answer: 'Le Flesch Reading Ease est un nombre de 0 à 100 indiquant la facilité de lecture. Pour le français, l\u2019outil utilise la formule Kandel-Moles adaptée aux spécificités françaises (lettres muettes, liaisons). Un score de 90\u2013100 signifie très facile, 70\u201389 facile, 50\u201369 modéré, 30\u201349 difficile et 0\u201329 très difficile.', answerSchemaText: 'Le Flesch Reading Ease (0\u2013100) mesure la lisibilité. Pour le français, la formule Kandel-Moles est utilisée.' },
      { question: 'Comment le temps de parole est-il calculé ?', answer: 'Le temps de parole est estimé en divisant le nombre de mots par 130 \u2013 la vitesse moyenne lors de présentations. C\u2019est plus lent que les 200 mots/minute de lecture car la parole inclut des pauses naturelles.', answerSchemaText: 'Le temps de parole est calculé à 130 mots par minute.' },
      { question: 'Le compteur de syllabes est-il précis ?', answer: 'L\u2019outil utilise des heuristiques spécifiques au français qui reconnaissent les diphtongues (ou, ai, oi, eau), les lettres muettes et les règles de syllabification française. Le comptage est approximatif mais suffisant pour l\u2019analyse de lisibilité.', answerSchemaText: 'Le compteur utilise des heuristiques françaises reconnaissant diphtongues et lettres muettes.' }
    ]
  },
  ...
  pt: {
    ...
    heroDesc: 'Cole o seu texto e a ferramenta contará palavras, caracteres, sílabas, frases, parágrafos, palavras únicas, tempo de leitura, tempo de fala e calculará a pontuação de legibilidade Flesch-Kincaid.',
    schemaName: 'Contador de palavras com legibilidade Flesch-Kincaid e ferramentas de texto',
    schemaAltNames: ['Contador de palavras online', 'Contador de caracteres com e sem espaços', 'Ferramenta de contagem para redatores', 'Calculadora de tempo de leitura', 'Verificador de legibilidade Flesch-Kincaid', 'Contador de sílabas online', 'Calculadora de tempo de fala', 'Conversor de maiúsculas e minúsculas', 'Ferramenta de legibilidade de texto', 'Remover linhas duplicadas'],
    schemaDesc: 'Contador gratuito de palavras com pontuação Flesch-Kincaid (fórmula Fernández-Huerta para português), contagem de sílabas, tempo de leitura e fala, e 10 ferramentas de formatação. Processamento local no navegador.',
    schemaFeatures: ['Contagem de palavras', 'Contagem de caracteres com e sem espaços', 'Contagem de frases e parágrafos', 'Contagem de palavras únicas', 'Comprimento médio de palavra', 'Tempo de leitura estimado', 'Tempo de fala estimado', 'Contagem de sílabas', 'Pontuação Flesch-Kincaid (Fernández-Huerta para português)', 'Fórmulas de legibilidade adaptadas (16 idiomas)', 'Converter para maiúsculas ou minúsculas', 'Converter para formato de frase ou título', 'Inverter maiúsculas/minúsculas', 'Remover espaços extra', 'Remover linhas vazias e duplicadas', 'Ordenar linhas A\u2013Z e Z\u2013A', 'Copiar texto para a área de transferência'],
    ...
    metricItems: [
      ...
      { icon: 'RiInputMethodLine', title: 'Sílabas', description: 'Total de sílabas com heurísticas adaptadas ao português. Reconhece ditongos e hiatos. Parâmetro chave para fórmulas de legibilidade.' },
    ...
    specialItems: [
      { icon: 'RiBarChartLine', title: '11 métricas + pontuação de legibilidade', description: 'Palavras, caracteres, sílabas, frases, parágrafos, palavras únicas, tempo de leitura, tempo de fala e Flesch-Kincaid \u2013 tudo num painel.' },
    ...
    faqItems: [
      { question: 'Como é calculado o tempo de leitura?', answer: 'A ferramenta divide o número de palavras por 200 \u2013 a velocidade média de leitura. Textos técnicos são lidos mais devagar, artigos leves mais depressa.', answerSchemaText: 'A ferramenta assume 200 palavras por minuto.' },
      { question: 'O meu texto está seguro?', answer: 'Sim. Todo o processamento ocorre no navegador. O texto nunca é enviado a um servidor nem armazenado.', answerSchemaText: 'Sim. Processamento local, sem envio a servidores.' },
      { question: 'O que é a pontuação Flesch-Kincaid?', answer: 'O Flesch Reading Ease é um número de 0 a 100. Para português é usada a fórmula Fernández-Huerta. 90\u2013100 = muito fácil, 70\u201389 = fácil, 50\u201369 = moderado, 30\u201349 = difícil, 0\u201329 = muito difícil.', answerSchemaText: 'O Flesch Reading Ease (0\u2013100) mede a legibilidade. Para português usa-se Fernández-Huerta.' },
      { question: 'Como é calculado o tempo de fala?', answer: 'O tempo de fala divide o número de palavras por 130 \u2013 a velocidade média em apresentações. É mais lento que a leitura porque a fala inclui pausas e respiração.', answerSchemaText: 'Calculado a 130 palavras por minuto.' },
      { question: 'O contador de sílabas é preciso?', answer: 'A ferramenta usa heurísticas adaptadas ao português que reconhecem ditongos, hiatos e regras de silabificação. O resultado é aproximado mas suficiente para análise de legibilidade.', answerSchemaText: 'Usa heurísticas do português com reconhecimento de ditongos e hiatos.' }
    ]
  },
  ...
  it: {
    ...
    heroDesc: 'Incolla il tuo testo e lo strumento conterà parole, caratteri, sillabe, frasi, paragrafi, parole uniche, tempo di lettura, tempo di parlato e calcolerà il punteggio di leggibilità. Cambia maiuscole/minuscole, rimuovi duplicati o ordina le righe.',
    schemaName: 'Contatore di parole con leggibilità Flesch-Kincaid (Gulpease) e strumenti testo',
    schemaAltNames: ['Contatore di parole online', 'Contatore di caratteri con e senza spazi', 'Strumento conteggio parole per copywriter', 'Calcolatore tempo di lettura', 'Indice di leggibilità Gulpease', 'Contatore di sillabe online', 'Calcolatore tempo di parlato', 'Convertitore maiuscole minuscole', 'Strumento leggibilità testo', 'Rimuovi righe duplicate'],
    schemaDesc: 'Contatore gratuito di parole con indice di leggibilità Gulpease (specifico per l\u2019italiano), conteggio sillabe, stima tempo di lettura e parlato, e 10 strumenti di formattazione. Elaborazione locale nel browser.',
    schemaFeatures: ['Conteggio parole', 'Conteggio caratteri con e senza spazi', 'Conteggio frasi e paragrafi', 'Conteggio parole uniche', 'Lunghezza media parola', 'Tempo di lettura stimato', 'Tempo di parlato stimato', 'Conteggio sillabe', 'Indice Gulpease (specifico per l\u2019italiano)', 'Formule di leggibilità adattate (16 lingue)', 'Convertire in maiuscolo o minuscolo', 'Convertire in formato frase o titolo', 'Invertire maiuscole/minuscole', 'Rimuovere spazi extra', 'Rimuovere righe vuote e duplicati', 'Ordinare righe A\u2013Z e Z\u2013A', 'Copiare testo negli appunti'],
    ...
    metricItems: [
      ...
      { icon: 'RiInputMethodLine', title: 'Sillabe', description: 'Totale sillabe con euristiche italiane. L\u2019indice Gulpease utilizza il conteggio dei caratteri anziché delle sillabe, ma il dato è utile per confronti interlinguistici.' },
      { icon: 'RiSpeedLine', title: 'Leggibilità (Gulpease)', description: 'Punteggio 0\u2013100. Sopra 80 = facile (licenza elementare), 60\u201380 = medio (licenza media), sotto 40 = difficile (diploma universitario). Codice colore per valutazione rapida.' }
    ],
    toolItems: [
    ...
    specialItems: [
      { icon: 'RiBarChartLine', title: '11 metriche + indice Gulpease', description: 'Parole, caratteri, sillabe, frasi, paragrafi, parole uniche, tempo di lettura, tempo di parlato e leggibilità \u2013 tutto in un pannello.' },
    ...
    faqItems: [
      { question: 'Come viene calcolato il tempo di lettura?', answer: 'Lo strumento divide il numero di parole per 200 \u2013 la velocità media di lettura. Testi tecnici vengono letti più lentamente.', answerSchemaText: 'Lo strumento assume 200 parole al minuto.' },
      { question: 'Il mio testo è al sicuro?', answer: 'Sì. Tutta l\u2019analisi avviene nel browser. Il testo non viene mai inviato a un server.', answerSchemaText: 'Sì. Elaborazione locale, nessun invio a server.' },
      { question: 'Cos\u2019è l\u2019indice Gulpease?', answer: 'L\u2019indice Gulpease è una formula di leggibilità sviluppata specificamente per la lingua italiana. La formula è: 89 + (300 \u00d7 frasi \u2212 10 \u00d7 caratteri) / parole. A differenza del Flesch-Kincaid, usa il conteggio dei caratteri invece delle sillabe. Punteggi sopra 80 indicano testo facile per la licenza elementare, 60\u201380 per la licenza media, sotto 40 richiede un diploma universitario.', answerSchemaText: 'L\u2019indice Gulpease (0\u2013100) è specifico per l\u2019italiano. Usa caratteri anziché sillabe.' },
      { question: 'Come viene calcolato il tempo di parlato?', answer: 'Il tempo di parlato divide le parole per 130 \u2013 la velocità media nelle presentazioni.', answerSchemaText: 'Calcolato a 130 parole al minuto.' },
      { question: 'Il contatore di sillabe è preciso?', answer: 'Lo strumento usa euristiche italiane che riconoscono dittonghi, iati e regole di sillabificazione. Il risultato è approssimativo ma sufficiente per l\u2019analisi.', answerSchemaText: 'Usa euristiche italiane con dittonghi e iati.' }
    ]
  },
  ...
  nl: {
    ...
    schemaAltNames: ['Online woordteller', 'Tekenteller met en zonder spaties', 'Woordteller voor copywriters', 'Leestijdcalculator', 'Flesch-Douma leesbaarheidschecker', 'Lettergreepteller online', 'Spreektijdcalculator', 'Hoofdletterconverter', 'Leesbaarheidstool', 'Dubbele regels verwijderen'],
    schemaDesc: 'Gratis woordteller met Flesch-Douma leesbaarheidsscore (specifiek voor Nederlands), lettergreeptelling, lees- en spreektijdschatting en 10 opmaaktools. Lokale verwerking in de browser.',
    schemaFeatures: ['Woorden tellen', 'Tekens met en zonder spaties', 'Zinnen en alinea\u2019s tellen', 'Unieke woorden tellen', 'Gemiddelde woordlengte', 'Geschatte leestijd', 'Geschatte spreektijd', 'Lettergreeptelling', 'Flesch-Douma leesbaarheidsscore', 'Taalspecifieke formules (16 talen)', 'Naar hoofdletters of kleine letters', 'Zinsstijl of titelstijl', 'Hoofdletters omdraaien', 'Extra spaties verwijderen', 'Lege regels en duplicaten verwijderen', 'Regels A\u2013Z en Z\u2013A sorteren', 'Tekst kopiëren naar klembord'],
    howToDesc: 'Tel woorden, tekens, lettergrepen en zinnen. Check Flesch-Douma leesbaarheid, leestijd en spreektijd.',
    howToStep2: 'In het linkerpaneel zie je 11 statistieken: woorden, tekens met en zonder spaties, zinnen, alinea\u2019s, unieke woorden, gemiddelde woordlengte, leestijd, spreektijd, lettergrepen en Flesch-Douma leesbaarheidsscore.',
    sectionBasicHtml: '<p class="text-mid">Deze tool combineert een woord- en tekenteller met Flesch-Douma leesbaarheidanalyse en tekstopmaakfuncties. Plak je tekst en bekijk woorden, tekens, lettergrepen, zinnen, alinea\u2019s, unieke woorden, leestijd, spreektijd en een kleurgecodeerde leesbaarheidsscore.</p><p class="text-mid mt-3">De <strong>Flesch-Douma leesbaarheidsscore</strong> (0\u2013100) is specifiek ontwikkeld voor het Nederlands: 206,835 \u2212 0,93 \u00d7 ASL \u2212 77 \u00d7 ASW. Scores boven 70 duiden op makkelijk leesbare tekst, onder 30 op academisch niveau. De tool past zich automatisch aan de taal aan.</p><p class="text-mid mt-3">Onder het tekstveld vind je 10 tools: hoofdletterconversie, spaties, lege regels en duplicaten verwijderen en sorteren. Alles draait lokaal in je browser.</p>',
    ...
    metricItems: [
      ...
      { icon: 'RiInputMethodLine', title: 'Lettergrepen', description: 'Totaal lettergrepen met Nederlandse heuristieken. Herkent tweeklanken (ei, au, eu, ij, ou, oe). Sleutelparameter voor leesbaarheidformules.' },
    ...
    specialItems: [
      { icon: 'RiBarChartLine', title: '11 statistieken + leesbaarheidsscore', description: 'Woorden, tekens, lettergrepen, zinnen, alinea\u2019s, unieke woorden, leestijd, spreektijd en Flesch-Douma \u2013 alles in één paneel.' },
    ...
    faqItems: [
      { question: 'Hoe werkt de leestijdcalculator?', answer: 'De tool deelt het aantal woorden door 200 \u2013 de gemiddelde leessnelheid. Technische teksten worden langzamer gelezen.', answerSchemaText: 'De tool gaat uit van 200 woorden per minuut.' },
      { question: 'Is mijn tekst veilig?', answer: 'Ja. Alle analyse en verwerking gebeurt lokaal in je browser. De tekst wordt nooit naar een server gestuurd.', answerSchemaText: 'Ja. Lokale verwerking, geen data naar servers.' },
      { question: 'Wat is de Flesch-Douma score?', answer: 'De Flesch-Douma formule is de Nederlandse aanpassing van de Flesch Reading Ease: 206,835 \u2212 0,93 \u00d7 ASL \u2212 77 \u00d7 ASW. De aangepaste coëfficiënten houden rekening met de specifieke eigenschappen van het Nederlands, zoals samenstellingen. Scores boven 70 zijn makkelijk leesbaar, onder 30 academisch.', answerSchemaText: 'De Flesch-Douma (0\u2013100) is de Nederlandse variant van Flesch Reading Ease met aangepaste coëfficiënten.' },
      { question: 'Hoe wordt de spreektijd berekend?', answer: 'De spreektijd deelt het aantal woorden door 130 \u2013 de gemiddelde spreeksnelheid bij presentaties.', answerSchemaText: 'Berekend op 130 woorden per minuut.' },
      { question: 'Hoe nauwkeurig is de lettergreepteller?', answer: 'De tool gebruikt Nederlandse heuristieken die tweeklanken herkennen (ei, au, eu, ij, ou, oe) en rekening houden met samenstellingen. Het resultaat is een benadering die voldoende nauwkeurig is voor leesbaarheidanalyse.', answerSchemaText: 'Gebruikt Nederlandse heuristieken met tweeklanken en samenstellingen.' }
    ]
  }
};
...
for (const loc of ALL) {
  ...
  for (let i = 0; i < data.contentBlocks.length; i++) {
    ...
    if (block.type === 'sectionSteps' && block.items && block.items.length >= 7 && block.items.length <= 11 && block.items[0] && block.items[0].icon === 'RiText') {
      block.title = t.metricsTitle; block.description = t.metricsDesc; block.items = t.metricItems;
    }
    ...
    if (block.type === 'sectionSteps' && block.items && block.items.length === 6 && block.items[0] && block.items[0].icon === 'RiEditLine' && block.items[1] && block.items[1].icon === 'RiBloggerLine') {
      block.title = t.whoTitle; block.description = t.whoDesc; block.items = t.whoItems;
    }
    if (block.type === 'sectionSteps' && block.items && block.items.length === 6 && block.items[0] && block.items[0].icon === 'RiBarChartLine') {
      block.title = t.specialTitle; block.items = t.specialItems;
    }
