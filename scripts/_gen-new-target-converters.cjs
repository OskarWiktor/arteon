...
const converters = [
  // → AVIF (8)
  {
    ...
    jsonFile: 'converter-jpg-to-avif',
  },
  {
    key: 'pngToAvif',
    slug: 'konwerter-png-na-avif',
    title: 'Konwerter PNG na AVIF',
    desc: 'Zamień grafiki PNG na AVIF z zachowaniem przezroczystości. Znacznie mniejsze pliki.',
    jsonFile: 'converter-png-to-avif',
  },
  {
    key: 'webpToAvif',
    slug: 'konwerter-webp-na-avif',
    title: 'Konwerter WebP na AVIF',
    desc: 'Zamień pliki WebP na AVIF. Jeszcze lepsza kompresja w nowoczesnym formacie.',
    jsonFile: 'converter-webp-to-avif',
  },
  { key: 'svgToAvif', slug: 'konwerter-svg-na-avif', title: 'Konwerter SVG na AVIF', desc: 'Zamień grafikę wektorową SVG na nowoczesny format rastrowy AVIF.', jsonFile: 'converter-svg-to-avif' },
  {
    ...
    title: 'Konwerter BMP na AVIF',
    desc: 'Zamień nieskompresowane pliki BMP na nowoczesny AVIF. Ogromna redukcja rozmiaru.',
    jsonFile: 'converter-bmp-to-avif',
  },
  {
    key: 'gifToAvif',
    slug: 'konwerter-gif-na-avif',
    title: 'Konwerter GIF na AVIF',
    desc: 'Zamień pierwszą klatkę GIF na nowoczesny AVIF. Mniejszy plik, lepsza jakość.',
    jsonFile: 'converter-gif-to-avif',
  },
  {
    key: 'heicToAvif',
    slug: 'konwerter-heic-na-avif',
    title: 'Konwerter HEIC na AVIF',
    desc: 'Zamień zdjęcia HEIC z iPhone na AVIF. Nowoczesny format webowy o doskonałej kompresji.',
    jsonFile: 'converter-heic-to-avif',
  },
  {
    key: 'tiffToAvif',
    slug: 'konwerter-tiff-na-avif',
    title: 'Konwerter TIFF na AVIF',
    desc: 'Zamień pliki TIFF na nowoczesny AVIF. Idealne do publikacji skanów w internecie.',
    jsonFile: 'converter-tiff-to-avif',
  },
  // → GIF (5)
  {
    key: 'jpgToGif',
    ...
    desc: 'Zamień zdjęcia JPG na format GIF. Statyczny obraz w formacie obsługiwanym przez każdą platformę.',
    jsonFile: 'converter-jpg-to-gif',
  },
  {
    key: 'pngToGif',
    slug: 'konwerter-png-na-gif',
    title: 'Konwerter PNG na GIF',
    desc: 'Zamień grafiki PNG na GIF. Idealne do prostych ikon i grafik z ograniczoną paletą kolorów.',
    jsonFile: 'converter-png-to-gif',
  },
  {
    key: 'webpToGif',
    slug: 'konwerter-webp-na-gif',
    title: 'Konwerter WebP na GIF',
    desc: 'Zamień pliki WebP na GIF. Szeroka kompatybilność z programami i platformami.',
    jsonFile: 'converter-webp-to-gif',
  },
  {
    key: 'svgToGif',
    slug: 'konwerter-svg-na-gif',
    title: 'Konwerter SVG na GIF',
    desc: 'Zamień grafikę wektorową SVG na rastrowy GIF. Uniwersalny format dla prostych grafik.',
    jsonFile: 'converter-svg-to-gif',
  },
  {
    key: 'bmpToGif',
    slug: 'konwerter-bmp-na-gif',
    title: 'Konwerter BMP na GIF',
    desc: 'Zamień nieskompresowane pliki BMP na lekki GIF. Redukcja rozmiaru dla prostych grafik.',
    jsonFile: 'converter-bmp-to-gif',
  },
  // → TIFF (7)
  {
    key: 'jpgToTiff',
    slug: 'konwerter-jpg-na-tiff',
    title: 'Konwerter JPG na TIFF',
    desc: 'Zamień zdjęcia JPG na bezstratny TIFF. Idealne do druku i archiwizacji.',
    jsonFile: 'converter-jpg-to-tiff',
  },
  {
    key: 'pngToTiff',
    slug: 'konwerter-png-na-tiff',
    title: 'Konwerter PNG na TIFF',
    desc: 'Zamień grafiki PNG na profesjonalny format TIFF. Do druku i dalszej obróbki.',
    jsonFile: 'converter-png-to-tiff',
  },
  {
    key: 'webpToTiff',
    slug: 'konwerter-webp-na-tiff',
    title: 'Konwerter WebP na TIFF',
    desc: 'Zamień pliki WebP na bezstratny TIFF. Z formatu webowego do profesjonalnego.',
    jsonFile: 'converter-webp-to-tiff',
  },
  { key: 'svgToTiff', slug: 'konwerter-svg-na-tiff', title: 'Konwerter SVG na TIFF', desc: 'Zamień grafikę wektorową SVG na profesjonalny TIFF. Do druku i DTP.', jsonFile: 'converter-svg-to-tiff' },
  {
    ...
    title: 'Konwerter BMP na TIFF',
    desc: 'Zamień pliki BMP na profesjonalny TIFF. Zachowaj jakość w formacie do druku.',
    jsonFile: 'converter-bmp-to-tiff',
  },
  {
    key: 'avifToTiff',
    slug: 'konwerter-avif-na-tiff',
    title: 'Konwerter AVIF na TIFF',
    desc: 'Zamień pliki AVIF na bezstratny TIFF. Z formatu webowego do profesjonalnego.',
    jsonFile: 'converter-avif-to-tiff',
  },
  {
    key: 'heicToTiff',
    slug: 'konwerter-heic-na-tiff',
    title: 'Konwerter HEIC na TIFF',
    desc: 'Zamień zdjęcia HEIC z iPhone na profesjonalny TIFF. Do druku i archiwizacji.',
    jsonFile: 'converter-heic-to-tiff',
  },
];
...
const faqMap = {
  avif: [
    {
      q: 'Czym jest format AVIF?',
      a: 'AVIF to nowoczesny format obrazow oparty na kodeku AV1. Oferuje doskonala kompresje — pliki sa nawet o 50% mniejsze niz JPG przy zachowaniu porównywalnej jakosci. Obsluguje przezroczystosc i szerokie gamamy kolorow.',
    },
    {
      q: 'Czy AVIF dziala we wszystkich przegladarkach?',
      a: 'AVIF jest obslugiwany przez Chrome, Edge i Firefox. Safari nie wspiera kodowania AVIF — w takim przypadku narzedzie wyswietli odpowiedni komunikat.',
    },
  ...
  gif: [
    {
      q: 'Czym jest format GIF?',
      a: 'GIF to format graficzny obslugujacy max 256 kolorow. Jest uniwersalnie obslugiwany przez wszystkie przegladarki i programy. Najlepiej nadaje sie do prostych grafik, ikon i logo.',
    },
    {
      q: 'Czy zdjecia beda dobrze wygladac w GIF?',
      a: 'Zdjecia fotograficzne moga stracic na jakosci po konwersji do GIF z powodu ograniczenia do 256 kolorow. GIF sprawdza sie najlepiej dla prostych grafik z ograniczona paleta kolorow.',
    },
    { q: 'Czy moje pliki sa wysylane na serwer?', a: 'Nie. Konwersja odbywa sie w calosci w przegladarce. Pliki nie opuszczaja komputera.' },
  ],
  tiff: [
    ...
    {
      q: 'Dlaczego pliki TIFF sa takie duze?',
      a: 'TIFF przechowuje dane obrazu bez kompresji stratnej, co gwarantuje pelna jakosc, ale skutkuje wiekszymi plikami. To pozadane w profesjonalnych zastosowaniach — druku, DTP i archiwizacji.',
    },
    { q: 'Czy moje pliki sa wysylane na serwer?', a: 'Nie. Konwersja odbywa sie w calosci w przegladarce. Pliki nie opuszczaja komputera.' },
  ],
};
