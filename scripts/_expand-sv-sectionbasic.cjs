...
const PAIR = {
  'png-to-webp':
    'WebP stöder alfa-transparens precis som PNG – alla transparenta områden i din bild bevaras fullständigt. Du kan välja mellan förlustbaserad och förlustfri komprimering för att hitta den optimala balansen mellan filstorlek och kvalitet.',
  'png-to-jpg':
    'Vid konvertering från PNG till JPG förloras transparensen – transparenta områden fylls med en bakgrundsfärg. I gengäld får du avsevärt mindre filer, lämpligare för foton och webbinnehåll utan transparens.',
  ...
  'png-to-gif':
    'Konverteringen reducerar paletten till maximalt 256 färger. Resultatet är lämpligt för enkel grafik, ikoner och logotyper. Transparens stöds endast binärt (synlig eller osynlig), inte gradvis.',
  'png-to-tiff':
    'Konverteringen bevarar full kvalitet och transparens från PNG-originalet i TIFF-format. TIFF är lämpligt för vidare bearbetning i Photoshop eller professionellt tryck. TIFF-filer är större än PNG.',
  ...
  'jpg-to-png':
    'Konvertering från JPG till PNG omvandlar bilden till ett förlustfritt format. Detaljer som redan förlorats genom JPEG-komprimering kan dock inte återställas. PNG är lämpligt om du vill redigera bilden utan ytterligare kvalitetsförlust.',
  'jpg-to-avif':
    'AVIF uppnår upp till 50% bättre komprimering än JPEG vid jämförbar visuell kvalitet. Detta nästa generations format är idealiskt för prestandakritiska webbplatser och stöds av Chrome, Firefox och Safari 16+.',
  'jpg-to-gif':
    'Färgpaletten reduceras till 256, vilket vid fotografier leder till synliga kvalitetsförluster. Denna konvertering är främst lämplig för enkel grafik eller när GIF-formatet krävs av kompatibilitetsskäl.',
  'jpg-to-tiff':
    'Konverteringen bevarar den aktuella kvaliteten hos din JPEG och lagrar den förlustfritt i TIFF-format. Detaljer som förlorats genom JPEG-komprimering kan inte återställas, men TIFF möjliggör vidare redigering utan ytterligare förluster.',
  'heic-to-jpg':
    'Konvertering från HEIC till JPG omvandlar Apples proprietära format till det universellt kompatibla JPEG-formatet. Eventuell transparens och HDR-information förloras, men bildkvaliteten förblir praktiskt taget identisk med originalet vid inställningar från 85%.',
  'heic-to-png':
    'Konverteringen bevarar full kvalitet från HEIC-originalet förlustfritt i PNG-format. PNG stöds av alla enheter och är särskilt lämpligt om du vill redigera bilden eller bevara transparensen.',
  'heic-to-webp':
    'WebP erbjuder en utmärkt balans mellan filstorlek och kvalitet. Konvertering från HEIC till WebP producerar kompakta filer som stöds av alla moderna webbläsare – idealiskt för webbplatser.',
  'heic-to-avif':
    'AVIF erbjuder liknande komprimeringseffektivitet som HEIC, men stöds som öppet format mycket bredare. Konverteringen möjliggör modern komprimering utan begränsningarna i Apples ekosystem.',
  'heic-to-tiff':
    'Konverteringen omvandlar dina iPhone-foton till det professionella TIFF-formatet. Idealiskt för fotografer som vill arkivera mobilbilder i ett förlustfritt format och vidarebearbeta dem i Photoshop eller Lightroom.',
  'webp-to-jpg':
    'Konvertering från WebP till JPEG säkerställer maximal kompatibilitet. JPG stöds av alla enheter och all programvara – oumbärligt för att skicka bilder via e-post eller ladda upp till plattformar som inte accepterar WebP.',
  'webp-to-png':
    'Konvertering från WebP till PNG bevarar transparensen och lagrar bilden förlustfritt. PNG är lämpligt för vidare redigering i grafikprogram och för plattformar som inte stöder WebP.',
  'webp-to-avif':
    'AVIF erbjuder ännu bättre komprimering än WebP vid jämförbar kvalitet. Om du vill optimera dina bilder för nästa generations webbstandarder är konvertering från WebP till AVIF ett logiskt steg.',
  ...
  'webp-to-tiff':
    'Konverteringen omvandlar dina WebP-filer till det professionella TIFF-formatet. Idealiskt för tryckproduktion och långtidsarkivering där förlustfri kvalitet och fullt metadatastöd krävs.',
  'svg-to-jpg':
    'Rastrering från SVG till JPG konverterar den skalbara vektorgrafiken till en pixelbild med fast upplösning. Transparenta områden fylls med en bakgrundsfärg. Lämpligt för plattformar som inte accepterar SVG.',
  ...
  'svg-to-avif':
    'AVIF erbjuder den bästa komprimeringen för rastrering av SVG-filer. Idealiskt för prestandakritiska webbplatser där varje kilobyte bidrar till bättre laddningstider och Core Web Vitals.',
  'svg-to-gif':
    'Konverteringen omvandlar vektorbilden till en pixelbild med maximalt 256 färger. GIF är lämpligt för enkla ikoner och animerad grafik, men inte för komplexa illustrationer med färggradienter.',
  ...
  'gif-to-jpg':
    'Vid konvertering från GIF till JPG förloras animationsramar och transparens – bara den första bilden konverteras. Du får ett universellt kompatibelt fotoformat med full färgdjup (16,7 miljoner färger).',
  'gif-to-png':
    'Konverteringen bevarar kvaliteten förlustfritt och stöder binär transparens. Vid animerade GIF:ar konverteras bara den första ramen. PNG är lämpligt för vidare bearbetning av GIF-grafik.',
  ...
  'tiff-to-jpg':
    'Konverteringen reducerar de ofta mycket stora TIFF-filerna till kompakta JPEG-storlekar. Transparens och lagerinformation förloras, men du får universellt kompatibla filer för webb, e-post och sociala medier.',
  ...
  'bmp-to-png':
    'Konvertering från BMP till PNG minskar storleken avsevärt genom förlustfri komprimering. Till skillnad från JPEG bevaras full kvalitet – idealiskt för grafik med skarpa kanter och text.',
  ...
  'bmp-to-avif':
    'AVIF erbjuder den bästa komprimeringen för modernisering av okomprimerade BMP-filer. Storleken minskas med upp till 98% – idealiskt för migrering av gamla bildarkiv till moderna format.',
  'bmp-to-gif':
    'Konverteringen reducerar paletten till 256 färger och komprimerar filen avsevärt. Lämpligt för enkel grafik från äldre system, men för fotorealistiska BMP-bilder rekommenderas JPG eller WebP.',
  'bmp-to-tiff':
    'Konvertering från BMP till TIFF bevarar full kvalitet och lägger till professionellt metadatastöd. TIFF är lämpligare än BMP för långtidsarkivering och professionella tryckarbetsflöden.',
  'avif-to-jpg':
    'Konvertering från AVIF till JPEG säkerställer maximal kompatibilitet. JPG stöds av alla enheter – nödvändigt när mottagare eller plattformar ännu inte stöder det nyare AVIF-formatet.',
  ...
  'avif-to-webp':
    'WebP erbjuder bredare webbläsarstöd än AVIF med god komprimering. Konverteringen är meningsfull när din målplattform stöder WebP men ännu inte AVIF – ett vanligt scenario med äldre webbläsare och CMS-system.',
};

const PRIVACY =
  'Denna konverterare körs helt lokalt i din webbläsare – dina filer lämnar aldrig din enhet. Inga uppladdningar, inga servrar, ingen registrering. Helt GDPR-kompatibel och gratis utan några begränsningar.';
