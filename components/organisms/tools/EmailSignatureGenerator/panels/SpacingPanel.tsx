  ...
  const rows: SpacingRowConfig[] = [
    {
      key: 'afterName',
      labelKey: 'afterName',
      visible: !!config.fullName.trim() && layoutKeys.includes('afterName'),
    },
    {
      key: 'afterTitle',
      labelKey: 'afterTitle',
    ...
    },
    {
      key: 'afterExtra',
      labelKey: 'afterExtra',
      visible: !!config.extraLine.trim() && layoutKeys.includes('afterExtra'),
    },
    {
      key: 'afterContact',
    ...
    {
      key: 'afterSocials',
      labelKey: 'afterSocials',
      visible:
        Object.values(config.socials).some(url => url.trim()) &&
        layoutKeys.includes('afterSocials'),
    },
    {
      key: 'afterCta',
      labelKey: 'afterCta',
    ...
    {
      key: 'beforeLegal',
      labelKey: 'beforeLegal',
      visible: !!config.legalNote.trim() && layoutKeys.includes('beforeLegal'),
    },
  ];
    ...
    <div className='space-y-4'>
      ...
      <div>
        ...
        <div className='flex flex-wrap gap-2'>
          <ButtonPill
            value='small'
            current={styleConfig.padding}
            label='8 px'
            onChange={v => onStyleChange('padding', v as MarginOption)}
          />
          <ButtonPill
            value='medium'
            current={styleConfig.padding}
      ...
      {rows
        ...
        .map(r => (
          <SpacingRow
            key={r.key}
            label={t.spacing[r.labelKey]}
            value={spacingConfig[r.key]}
            spacingKey={r.key}
