...
function isAnalyticsAllowed(fc: any): boolean {
  try {
    ...
    return (
      status === StatusEnum.CONSENT_MODE_PURPOSE_STATUS_GRANTED ||
      status === StatusEnum.CONSENT_MODE_PURPOSE_STATUS_NOT_APPLICABLE ||
      status === StatusEnum.CONSENT_MODE_PURPOSE_STATUS_NOT_CONFIGURED
    );
  } catch {
