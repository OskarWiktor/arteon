export default function ToolEditorSkeleton() {
  return (
    <div className="animate-pulse rounded-lg border border-black/5 bg-neutral-50 p-6" role="status" aria-label="Loading tool...">
      ...
      <div className="mb-6 space-y-3">
        ...
        <div className="h-10 w-full rounded-md bg-neutral-200" />
        <div className="h-10 w-3/4 rounded-md bg-neutral-200" />
      </div>
