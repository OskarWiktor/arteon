      ...
      <article className="surface-card flex h-full flex-col overflow-hidden">
        ...
        <div className="flex flex-1 flex-col p-4 md:p-5">
          ...
          <div className="mt-auto">
            <Link
              href={props.href}
              className="inline-flex w-fit items-center rounded-2xl border border-black/10 bg-white px-3 py-1.5 text-sm font-medium shadow-md transition hover:-translate-y-0.5 hover:shadow-xl focus-visible:ring-2 focus-visible:ring-slate-800 focus-visible:ring-offset-2 md:px-4 md:py-2 md:text-base"
            >
              <span>{label}</span>
