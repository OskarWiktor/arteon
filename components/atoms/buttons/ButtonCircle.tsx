...
const buttonCircleClasses =
  'inline-flex items-center justify-center bg-primary rounded-full p-1 text-white shadow-lg md:p-2 hover:text-mid transition-colors hover:scale-105 hover:bg-white';
