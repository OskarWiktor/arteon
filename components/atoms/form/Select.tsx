...
import { NavArrowDownSLine } from '@/components/atoms/NavIcons';
 ...
 * `NavArrowDownSLine` icon, which rotates 180deg while the dropdown is open. Open
  ...
  return (
    <div className='relative w-full'>
      ...
      >
        ...
        >
          <NavArrowDownSLine className={smallIconSizeClasses} />
        </span>
      </span>
    </div>
  );
