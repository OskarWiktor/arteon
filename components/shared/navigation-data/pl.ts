...
export const TOOLS_SECTIONS_PL: ToolsSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        key: 'heicToAvif',
        href: '/narzedzia/konwerter-heic-na-avif',
      ...
      {
        key: 'heicToTiff',
        href: '/narzedzia/konwerter-heic-na-tiff',
      ...
      {
        key: 'jpgToTiff',
        href: '/narzedzia/konwerter-jpg-na-tiff',
      ...
      {
        key: 'pngToAvif',
        href: '/narzedzia/konwerter-png-na-avif',
      ...
      {
        key: 'pngToGif',
        href: '/narzedzia/konwerter-png-na-gif',
        title: 'Konwerter PNG na GIF',
        description: 'Zamień grafiki PNG na GIF. Idealne do prostych ikon i grafik.',
        image: '/assets/tools/jpg-png-to-webp-converter/jpg-png-na-webp-bez-limitu-pl.webp',
        icon: RiLoopLeftLine,
      },
      {
      ...
      {
        key: 'pngToTiff',
        href: '/narzedzia/konwerter-png-na-tiff',
      ...
      {
        key: 'tiffToAvif',
        href: '/narzedzia/konwerter-tiff-na-avif',
      ...
      {
        key: 'webpToAvif',
        href: '/narzedzia/konwerter-webp-na-avif',
