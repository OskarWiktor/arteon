...
const items: FeatureItem[] = [
  ...
  },
  {
    ...
    icon: <IoColorPalette className="h-6 w-6 text-indigo-800" />,
  },
  {
    title: 'Spójne szablony do social mediów',
    icon: <RiStackLine className="h-6 w-6 text-indigo-800" />,
  },
  {
    title: 'Profesjonalna obróbka zdjęć i grafik pod www',
    icon: <RiImageLine className="h-6 w-6 text-indigo-800" />,
  },
  {
    title: 'Materiały video i rolki promocyjne',
    icon: <RiVideoLine className="h-6 w-6 text-indigo-800" />,
  },
  {
  ...
  },
  {
    ...
    icon: <RiShoppingBag3Line className="h-6 w-6 text-indigo-800" />,
  },
  {
    title: 'Nowoczesne makiety UX/UI w Figmie',
    icon: <RiPaletteLine className="h-6 w-6 text-indigo-800" />,
  },
];
