...
export default function TechStack() {
  ...
  return (
    <section className="relative overflow-hidden" aria-labelledby="techstack-heading">
      ...
      <div
        ref={containerRef}
        className="mt-6 overflow-hidden rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white"
