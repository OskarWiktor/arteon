...
export const UNIT_CONVERSIONS: UnitConversionConfig[] = [
...

  {
    ...
    targetField: { labelKey: 'hsl', suffix: '' },
    convert: () => 0,
    reverseConvert: () => 0,
    ...
    swappable: true,
    popularValues: [
      { source: '0, 0, 0', target: 'hsl(0, 0%, 0%)', labelKey: 'black' },
      { source: '255, 255, 255', target: 'hsl(0, 0%, 100%)', labelKey: 'white' },
      { source: '255, 0, 0', target: 'hsl(0, 100%, 50%)', labelKey: 'red' },
      { source: '0, 128, 0', target: 'hsl(120, 100%, 25%)', labelKey: 'green' },
      { source: '0, 0, 255', target: 'hsl(240, 100%, 50%)', labelKey: 'blue' },
...

  {
    toolKey: 'vwToPx',
    category: 'css',
    sourceField: { labelKey: 'vw', suffix: 'vw' },
    targetField: { labelKey: 'pixels', suffix: 'px' },
    extraField: {
      key: 'viewportWidth',
      labelKey: 'viewportWidth',
      suffix: 'px',
      defaultValue: 1920,
      min: 1,
      max: 7680,
    ...
    formula: 'px = vw \u00D7 viewport \u00F7 100',
    reverseFormula: 'vw = px \u00D7 100 \u00F7 viewport',
    precision: 2,
    swappable: true,
    popularValues: [
      ...
      { source: 100, target: 1920, labelKey: 'fullWidth' },
    ],
  },

  {
    toolKey: 'twToPx',
    category: 'css',
    sourceField: { labelKey: 'tailwindSpacing', suffix: 'tw', placeholder: '4' },
    targetField: { labelKey: 'pixels', suffix: 'px' },
    convert: (v) => v * 4,
    reverseConvert: (v) => v / 4,
    formula: 'px = spacing \u00D7 4',
