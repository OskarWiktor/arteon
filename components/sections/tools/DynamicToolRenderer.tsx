...
const TOOL_COMPONENTS: Record<string, ReturnType<typeof dynamic>> = {
  ...
  kmToMiles: dynamic(() => import('./unit-wrappers/KmToMiles'), { ssr: false, loading: () => <ToolEditorSkeleton /> }),
  kgToLbs: dynamic(() => import('./unit-wrappers/KgToLbs'), { ssr: false, loading: () => <ToolEditorSkeleton /> }),
  celsiusToFahrenheit: dynamic(() => import('./unit-wrappers/CelsiusToFahrenheit'), { ssr: false, loading: () => <ToolEditorSkeleton /> }),
  cmToInches: dynamic(() => import('./unit-wrappers/CmToInches'), { ssr: false, loading: () => <ToolEditorSkeleton /> }),
  metersToFeet: dynamic(() => import('./unit-wrappers/MetersToFeet'), { ssr: false, loading: () => <ToolEditorSkeleton /> }),
  litersToGallons: dynamic(() => import('./unit-wrappers/LitersToGallons'), { ssr: false, loading: () => <ToolEditorSkeleton /> }),
  sqmToSqft: dynamic(() => import('./unit-wrappers/SqmToSqft'), { ssr: false, loading: () => <ToolEditorSkeleton /> }),
  kmhToMph: dynamic(() => import('./unit-wrappers/KmhToMph'), { ssr: false, loading: () => <ToolEditorSkeleton /> }),
  mmToInches: dynamic(() => import('./unit-wrappers/MmToInches'), { ssr: false, loading: () => <ToolEditorSkeleton /> }),
  gramsToOunces: dynamic(() => import('./unit-wrappers/GramsToOunces'), { ssr: false, loading: () => <ToolEditorSkeleton /> }),
  tonnesToPounds: dynamic(() => import('./unit-wrappers/TonnesToPounds'), { ssr: false, loading: () => <ToolEditorSkeleton /> }),
  hectaresToAcres: dynamic(() => import('./unit-wrappers/HectaresToAcres'), { ssr: false, loading: () => <ToolEditorSkeleton /> }),
  mlToFlOz: dynamic(() => import('./unit-wrappers/MlToFlOz'), { ssr: false, loading: () => <ToolEditorSkeleton /> }),
  barToPsi: dynamic(() => import('./unit-wrappers/BarToPsi'), { ssr: false, loading: () => <ToolEditorSkeleton /> }),
  kwToHp: dynamic(() => import('./unit-wrappers/KwToHp'), { ssr: false, loading: () => <ToolEditorSkeleton /> }),
  ...
  degToRad: dynamic(() => import('./unit-wrappers/DegToRad'), { ssr: false, loading: () => <ToolEditorSkeleton /> }),
  mbpsToMBs: dynamic(() => import('./unit-wrappers/MbpsToMBs'), { ssr: false, loading: () => <ToolEditorSkeleton /> }),
  whToMah: dynamic(() => import('./unit-wrappers/WhToMah'), { ssr: false, loading: () => <ToolEditorSkeleton /> }),
