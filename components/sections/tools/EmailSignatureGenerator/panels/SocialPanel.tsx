  ...
  return (
    <div className="space-y-3">
      ...
      <div className="mt-4 space-y-3 border-t border-neutral-200 pt-4">
        <ToolCheckbox id="social-icons-toggle" checked={styleConfig.socialIcons.showIcons} onChange={(v) => onStyleChange('socialIcons', { ...styleConfig.socialIcons, showIcons: v })} label={t.social.showIcons} />
          ...
          <>
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                <PillButton value="small" current={styleConfig.socialIcons.iconSize} label={t.social.iconSizeSmall} onChange={(v) => onStyleChange('socialIcons', { ...styleConfig.socialIcons, iconSize: v })} />
                <PillButton value="medium" current={styleConfig.socialIcons.iconSize} label={t.social.iconSizeMedium} onChange={(v) => onStyleChange('socialIcons', { ...styleConfig.socialIcons, iconSize: v })} />
                <PillButton value="large" current={styleConfig.socialIcons.iconSize} label={t.social.iconSizeLarge} onChange={(v) => onStyleChange('socialIcons', { ...styleConfig.socialIcons, iconSize: v })} />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                <PillButton value="platform" current={styleConfig.socialIcons.colorMode} label={t.social.iconColorPlatform} onChange={(v) => onStyleChange('socialIcons', { ...styleConfig.socialIcons, colorMode: v })} />
                <PillButton value="accent" current={styleConfig.socialIcons.colorMode} label={t.social.iconColorAccent} onChange={(v) => onStyleChange('socialIcons', { ...styleConfig.socialIcons, colorMode: v })} />
                <PillButton value="text" current={styleConfig.socialIcons.colorMode} label={t.social.iconColorText} onChange={(v) => onStyleChange('socialIcons', { ...styleConfig.socialIcons, colorMode: v })} />
              </div>
            </div>
          </>
        )}
