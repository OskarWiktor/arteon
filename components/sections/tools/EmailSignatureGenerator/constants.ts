...
export function getDefaultSignature(locale: Locale): SignatureConfig {
  ...
  if (locale === 'id') {
    return {
      ...
      website: 'https://www.situsanda.com',
      address: 'Jl. Sudirman No. 1, Jakarta 10110',
      extraLine: 'Saya membangun website cepat dan fungsional.',
      ctaLabel: 'Jadwalkan konsultasi gratis',
      ctaUrl: 'https://www.situsanda.com',
      cta2Label: '',
      cta2Url: '',
      socials: {
      ...
      legalNote: 'Pesan ini mungkin berisi informasi rahasia. Jika Anda bukan penerima yang dituju, harap beritahu pengirim dan hapus pesan ini.',
      formalLine: '',
      avatarUrl: '',
    };
  }
  if (locale === 'vi') {
    return {
      ...
      website: 'https://www.trangcuaban.com',
      address: '123 Nguyễn Huệ, Q.1, TP.HCM',
      extraLine: 'Tôi xây dựng website nhanh và chức năng.',
      ctaLabel: 'Đặt lịch tư vấn miễn phí',
      ctaUrl: 'https://www.trangcuaban.com',
      cta2Label: '',
      cta2Url: '',
      socials: {
      ...
      legalNote: 'Tin nhắn này có thể chứa thông tin mật. Nếu bạn không phải người nhận đích, vui lòng thông báo cho người gửi và xóa tin nhắn này.',
      formalLine: '',
      avatarUrl: '',
    };
  }
  ...
  if (locale === 'tl') {
    return {
      ...
      topLine: '',
      nameTag: '',
      email: 'juan.delacruz@halimbawa.ph',
      phone: '+63 917 123 4567',
      website: 'https://www.iyongwebsite.ph',
      address: 'Rizal Ave 123, Maynila 1000',
      extraLine: 'Gumagawa ako ng mabilis at modernong mga website.',
      ctaLabel: 'Mag-book ng libreng konsultasyon',
      ctaUrl: 'https://www.iyongwebsite.ph',
      cta2Label: '',
      cta2Url: '',
      socials: {
      ...
      legalNote: 'Ang mensaheng ito ay maaaring maglaman ng kumpidensyal na impormasyon. Kung hindi ikaw ang nilalayong tatanggap, mangyaring ipaalam sa nagpadala at burahin ang mensaheng ito.',
      formalLine: '',
      avatarUrl: '',
    };
  }
  if (locale === 'sw') {
    return {
      ...
      topLine: '',
      nameTag: '',
      email: 'juma.hassan@mfano.co.tz',
      phone: '+255 712 345 678',
      website: 'https://www.tovutiyako.co.tz',
      address: 'Samora Ave 10, Dar es Salaam 11000',
      extraLine: 'Naunda tovuti za kisasa na za haraka.',
      ctaLabel: 'Pata ushauri wa bure',
      ctaUrl: 'https://www.tovutiyako.co.tz',
      cta2Label: '',
      cta2Url: '',
      socials: {
        linkedin: 'https://www.linkedin.com/in/jumahassan',
        instagram: '',
        facebook: '',
        tiktok: '',
        youtube: '',
      ...
      legalNote: 'Ujumbe huu unaweza kuwa na taarifa za siri. Ikiwa wewe si mpokeaji aliyekusudiwa, tafadhali mjulishe mtumaji na ufute ujumbe huu.',
      formalLine: '',
      avatarUrl: '',
    };
  }
  if (locale === 'ms') {
    return {
      ...
      jobTitle: 'Pembangun Web',
      company: 'Arteon Agency',
      topLine: '',
      nameTag: '',
      email: 'ahmad.ismail@contoh.com.my',
      phone: '+60 12 345 6789',
      website: 'https://www.lamananda.com.my',
      address: 'Jalan Bukit Bintang 55, Kuala Lumpur 50200',
      extraLine: 'Saya membina laman web yang pantas dan berfungsi.',
      ctaLabel: 'Tempah perundingan percuma',
      ctaUrl: 'https://www.lamananda.com.my',
      cta2Label: '',
      cta2Url: '',
      socials: {
        linkedin: 'https://www.linkedin.com/in/ahmadismail',
        instagram: '',
        facebook: '',
        tiktok: '',
        youtube: '',
      ...
      legalNote: 'Mesej ini mungkin mengandungi maklumat sulit. Jika anda bukan penerima yang dimaksudkan, sila maklumkan pengirim dan padamkan mesej ini.',
      formalLine: '',
      avatarUrl: '',
    };
  }
  ...
  if (locale === 'yo') {
    return {
      fullName: 'Ad\u00e9b\u00e1y\u1ecd\u0300 Ol\u00fawaf\u1eb9\u0301mi',
      jobTitle: 'Ol\u00f9gb\u00e9kal\u1eb9\u0300 Ay\u00e9luj\u00e1ra',
      company: 'Arteon Agency',
      topLine: '',
      nameTag: '',
      email: 'adebayo.oluwafemi@apere.ng',
      phone: '+234 801 234 5678',
      website: 'https://www.ojuewere.ng',
      address: '15 Broad St, Lagos Island, Lagos',
      extraLine: 'Mo \u0144 k\u1ecd\u0301 oj\u00fa-\u00ecw\u00e9 ay\u00e9luj\u00e1ra t\u00f3 y\u00e1ra \u00e0ti t\u00f3 \u1e63i\u1e63\u1eb9\u0301 d\u00e1ad\u00e1a.',
      ctaLabel: '\u1e62e \u00ecp\u00e0d\u00e9 \u00ecgb\u00ecm\u1ecd\u0300 \u1ecd\u0300f\u1eb9\u0301',
      ctaUrl: 'https://www.ojuewere.ng',
      cta2Label: '',
      cta2Url: '',
      socials: {
        linkedin: 'https://www.linkedin.com/in/adebayooluwafemi',
        instagram: '',
        facebook: '',
        tiktok: '',
        youtube: '',
      ...
      legalNote:
        '\u00ccfiran\u1e63\u1eb9\u0301 y\u00ec\u00ed l\u00e8 n\u00ed \u00e0w\u1ecdn \u00e0l\u00e0y\u00e9 \u00e0\u1e63\u00edr\u00ed. T\u00ed \u00ecw\u1ecd k\u00ec \u00ed \u1e63e \u1eb9ni t\u00ed a \u0144 fi r\u00e1n\u1e63\u1eb9\u0301 s\u00ed, j\u1ecd\u0300w\u1ecd\u0301 s\u1ecd f\u00fan ol\u00f9fir\u00e1n\u1e63\u1eb9\u0301 k\u00ed o s\u00ec pa \u00ecfiran\u1e63\u1eb9\u0301 y\u00ec\u00ed r\u1eb9\u0301.',
      formalLine: '',
      avatarUrl: '',
    };
  }
  if (locale === 'af') {
    return {
      ...
      topLine: '',
      nameTag: '',
      email: 'jan.vandermerwe@voorbeeld.co.za',
      phone: '+27 12 345 6789',
      website: 'https://www.jouwerf.co.za',
      address: 'Hoofstraat 123, Kaapstad, 8001',
      extraLine: 'Ek bou vinnige en funksionele webwerwe.',
      ctaLabel: "Bespreek 'n gratis konsultasie",
      ctaUrl: 'https://www.jouwerf.co.za',
      cta2Label: '',
      cta2Url: '',
      socials: {
        linkedin: 'https://www.linkedin.com/in/janvandermerwe',
        instagram: '',
        facebook: '',
        tiktok: '',
        youtube: '',
      ...
      legalNote: 'Hierdie boodskap kan vertroulike inligting bevat. As jy nie die beoogde ontvanger is nie, stel asseblief die sender in kennis en vee hierdie boodskap uit.',
      formalLine: '',
      avatarUrl: '',
    };
  }
  if (locale === 'ceb') {
    return {
      fullName: 'Juan dela Cruz',
      jobTitle: 'Tigbuhat og Website',
      company: 'Arteon Agency',
      topLine: '',
      nameTag: '',
      email: 'juan.delacruz@pananglitan.ph',
      phone: '+63 917 123 4567',
      website: 'https://www.imongwebsite.ph',
      address: 'Osme\u00f1a Blvd 10, Cebu City 6000',
      extraLine: 'Naghimo ko og paspas ug functional nga mga website.',
      ctaLabel: 'Mag-book og libre nga konsultasyon',
      ctaUrl: 'https://www.imongwebsite.ph',
      cta2Label: '',
      cta2Url: '',
      socials: {
        linkedin: 'https://www.linkedin.com/in/juandelacruz',
      ...
      legalNote: 'Kini nga mensahe mahimong adunay kompidensyal nga impormasyon. Kung dili ikaw ang gituyo nga makadawat, palihug pahibaloa ang nagpadala ug papasa kini nga mensahe.',
      formalLine: '',
      avatarUrl: '',
    };
  }
  if (locale === 'ha') {
    return {
      ...
      jobTitle: 'Mai gina shafin yanar gizo',
      company: 'Arteon Agency',
      topLine: '',
      nameTag: '',
      email: 'abdullahi.musa@misali.ng',
      phone: '+234 803 456 7890',
      website: 'https://www.shafinka.ng',
      address: '10 Ahmadu Bello Way, Abuja',
      extraLine: 'Ina gina shafukan yanar gizo masu sauri da aiki.',
      ctaLabel: 'Yi alƙawarin tuntuɓar kyauta',
      ctaUrl: 'https://www.shafinka.ng',
      cta2Label: '',
      cta2Url: '',
      socials: {
        linkedin: 'https://www.linkedin.com/in/abdullahimusa',
        instagram: '',
        facebook: '',
        tiktok: '',
        youtube: '',
      ...
      legalNote: 'Wannan sa\u0199on na iya \u0199unshe da bayanan sirri. Idan ba kai ne wanda aka yi niyyar aika masa ba, da fatan za a sanar da mai aikawa ka kuma goge wannan sa\u0199on.',
      formalLine: '',
      avatarUrl: '',
    };
  }
  ...
  if (locale === 'bn') {
    return {
      fullName: 'রাহুল দাস',
      jobTitle: 'ওয়েব ডেভেলপার',
      company: 'Arteon Agency',
      topLine: '',
      nameTag: '',
      email: 'rahul.das@example.com',
      phone: '+880 1712 345678',
      website: 'https://www.example.com.bd',
      address: '42 গুলশান অ্যাভিনিউ, ঢাকা 1212',
      extraLine: 'দ্রুত ও কার্যকর ওয়েবসাইট তৈরি করি।',
      ctaLabel: 'বিনামূল্যে পরামর্শ বুক করুন',
      ctaUrl: 'https://www.example.com.bd',
      cta2Label: '',
      cta2Url: '',
      socials: {
      ...
      legalNote: 'এই বার্তায় গোপনীয় তথ্য থাকতে পারে। আপনি উদ্দিষ্ট প্রাপক না হলে, দয়া করে প্রেরককে জানান এবং এই বার্তাটি মুছে ফেলুন।',
      formalLine: '',
      avatarUrl: '',
    };
  }
