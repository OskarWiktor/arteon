...
export default function FormatSelector({ currentSource, currentTarget, hasFiles, unitToolKey }: FormatSelectorProps) {
  ...
  return (
    <div className="mb-5 flex justify-center">
      <div className="inline-flex items-center gap-4 rounded-lg border border-neutral-200 bg-white px-4 py-3">
        ...
        <FormatPickerModal side="target" currentSource={currentSource} currentTarget={currentTarget} hasFiles={hasFiles} confirmMessage={t.formatChangeConfirm} unitToolKey={unitToolKey} />
      </div>
    </div>
  );
}
