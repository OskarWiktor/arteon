...
const faqItems = [
  ...
  },
  {
    ...
    answer: 'Prosty projekt graficzny (np. wizytówka, post) trwa do 5 dni roboczych. Logo i identyfikacja wizualna - do 15 dni roboczych. Konkretne terminy ustalamy indywidualnie.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Dostarczamy pliki wektorowe, rastrowe (JPG, PNG) oraz pliki źródłowe (AI, PDS)',
  },
  {
