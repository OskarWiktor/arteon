...
const stepsHome = [
  ...
  },
  {
    title: (
      <>
        <span className="font-extrabold text-slate-600">4 </span>Publikacja i wsparcie
      </>
    ),
...
const stepsWeb = [
  ...
  },
  {
    title: (
      <>
        <span className="font-extrabold text-slate-600">4 </span>Publikacja i wzrost
      </>
    ),
    description: (
      <p>
...
const stepsMarketing = [
  {
    title: (
      <>
        <span className="font-extrabold text-slate-600">1 </span>Analiza
      </>
    ),
  ...
  },
  {
    title: (
      <>
        <span className="font-extrabold text-slate-600">3 </span>Kreacje
      </>
    ),
  ...
  },
  {
    title: (
      <>
        <span className="font-extrabold text-slate-600">4 </span>Pomiar i wzrost
      </>
    ),
...
const stepsContent = [
  ...
  },
  {
    title: (
      <>
        <span className="font-extrabold text-slate-600">3 </span>Tworzenie
      </>
    ),
  ...
  },
  {
    title: (
      <>
        <span className="font-extrabold text-slate-600">4 </span>Publikacja
      </>
    ),
...
const stepsDesign = [
  ...
  },
  {
    title: (
      <>
        <span className="font-extrabold text-slate-600">2 </span>Koncepcje
      </>
    ),
  ...
  },
  {
    title: (
      <>
        <span className="font-extrabold text-slate-600">4 </span>Dostarczenie
      </>
    ),
