...
const missionItems = [
  {
    ...
    title: 'Efemeryczny',
    description: <p>Zaczynamy od Twojej oferty. Dopasowujemy strategię i technologię do Twoich odbiorców i celów</p>,
  },
  {
    imageSrc: '/assets/ziemia.png',
    imageAlt: 'Ziemia - symbol stabilnych fundamentów',
    title: 'Stabilny',
    description: <p>Budujemy solidne fundamenty: czytelna struktura, dostępność i zgodność z prawem. Szybkość działania i widoczność w wyszukiwarce od startu.</p>,
  },
  {
  ...
  },
  {
    ...
    title: 'Transparentny',
    description: <p>Mówimy prostym językiem i transparentnie prowadzimy każdy etap współpracy. Masz pełną kontrolę nad projektem i spokojną głowę.</p>,
  },
];
