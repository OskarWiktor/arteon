  ...
  no: [
    {
      ...
      minWords: 80,
      maxWords: 400,
      description: 'Jo enklere produktet, desto kortere beskrivelsen. Komplekse produkter (f.eks. elektronikk) krever flere forklaringer og spesifikasjoner.',
    },
    { key: 'service', label: 'Tjenesteside', minWords: 500, maxWords: 1500, description: 'En enkel lokal tjeneste krever f\u00e6rre ord. Et komplekst tilbud med flere trinn krever mer.' },
    {
      key: 'homepage',
      label: 'Forside',
      minWords: 400,
      maxWords: 1000,
      description: 'Forsiden leder bes\u00f8kende til undersider. Et klart budskap og lesbar struktur gj\u00f8r navigasjonen enklere.',
    },
    { key: 'landing', label: 'Landingsside', minWords: 600, maxWords: 2500, description: 'Dyrere tilbud krever mer forklaring og tillitsbygging. Et enkelt tilbud kan v\u00e6re kortere.' },
    {
      key: 'blog',
      label: 'Blogginnlegg',
      minWords: 1200,
      maxWords: 3000,
      description: 'Lengden avhenger av emnets kompleksitet. Teksten b\u00f8r besvare leserens sp\u00f8rsm\u00e5l grundig og konkret.',
    },
    { key: 'guide', label: 'Guide / veiledning', minWords: 2500, maxWords: 6000, description: 'En detaljert gjennomgang av et emne med mange aspekter. Lengden avhenger av emnets omfang.' },
  ],
  fi: [
    {
      key: 'product',
      ...
      minWords: 80,
      maxWords: 400,
      description: 'Mit\u00e4 yksinkertaisempi tuote, sit\u00e4 lyhyempi kuvaus. Monimutkaiset tuotteet (esim. elektroniikka) vaativat enemm\u00e4n selityksi\u00e4 ja teknisi\u00e4 tietoja.',
    },
    {
      key: 'service',
      label: 'Palvelusivu',
      minWords: 500,
      maxWords: 1500,
      description: 'Yksinkertainen paikallinen palvelu vaatii v\u00e4hemm\u00e4n sanoja. Monivaiheinen tarjous vaatii enemm\u00e4n.',
    },
    {
      key: 'homepage',
      label: 'Etusivu',
      minWords: 400,
      maxWords: 1000,
      description: 'Etusivu ohjaa k\u00e4vij\u00f6it\u00e4 alasivuille. Selke\u00e4 viesti ja luettava rakenne helpottavat navigointia.',
    },
    {
      key: 'landing',
      ...
      minWords: 600,
      maxWords: 2500,
      description: 'Kalliimpi tarjous vaatii enemm\u00e4n selityst\u00e4 ja luottamuksen rakentamista. Yksinkertainen tarjous voi olla lyhyempi.',
    },
    {
      key: 'blog',
      label: 'Blogikirjoitus',
      minWords: 1200,
      maxWords: 3000,
      description: 'Pituus riippuu aiheen monimutkaisuudesta. Tekstin tulisi vastata lukijan kysymyksiin perusteellisesti ja konkreettisesti.',
    },
    { key: 'guide', label: 'Opas / ohje', minWords: 2500, maxWords: 6000, description: 'Yksityiskohtainen katsaus aiheeseen, jossa on monia n\u00e4k\u00f6kulmia. Pituus riippuu aiheen laajuudesta.' },
  ],
  sk: [
    {
      key: 'product',
      ...
      maxWords: 400,
      description:
        '\u010c\u00edm jednoduch\u0161\u00ed produkt, t\u00fdm krat\u0161\u00ed popis. Zlo\u017eit\u00e9 produkty (napr. elektronika) vy\u017eaduj\u00fa viac vysvetlen\u00ed a technick\u00fdch \u00fadajov.',
    },
    {
      key: 'service',
      label: 'Str\u00e1nka slu\u017eby',
      minWords: 500,
      maxWords: 1500,
      description: 'Jednoduch\u00e1 lok\u00e1lna slu\u017eba vy\u017eaduje menej slov. Viacf\u00e1zov\u00e1 ponuka vy\u017eaduje viac.',
    },
    {
      key: 'homepage',
      ...
      maxWords: 1000,
      description:
        '\u00davodn\u00e1 str\u00e1nka usmer\u0148uje n\u00e1v\u0161tevn\u00edkov na podstr\u00e1nky. Jasn\u00e9 posolstvo a \u010ditate\u013en\u00e1 \u0161trukt\u00fara u\u013eah\u010duj\u00fa navig\u00e1ciu.',
    },
    {
      key: 'landing',
      label: 'Prista\u0301vacia str\u00e1nka',
      minWords: 600,
      maxWords: 2500,
      description: 'Drah\u0161ia ponuka vy\u017eaduje viac vysvetlen\u00ed a budovania d\u00f4very. Jednoduch\u00e1 ponuka m\u00f4\u017ee by\u0165 krat\u0161ia.',
    },
    {
      key: 'blog',
      label: 'Blogov\u00fd \u010dl\u00e1nok',
      minWords: 1200,
      maxWords: 3000,
      description: 'D\u013a\u017eka z\u00e1vis\u00ed od zlo\u017eitosti t\u00e9my. Text by mal d\u00f4kladne a konkr\u00e9tne odpoveda\u0165 na ot\u00e1zky \u010ditate\u013ea.',
    },
    {
      key: 'guide',
      label: 'Sprievodca / n\u00e1vod',
      minWords: 2500,
      maxWords: 6000,
      description: 'Podrobn\u00fd preh\u013ead t\u00e9my s mnoh\u00fdmi aspektmi. D\u013a\u017eka z\u00e1vis\u00ed od rozsahu t\u00e9my.',
    },
  ],
  hr: [
    {
      ...
      minWords: 80,
      maxWords: 400,
      description: '\u0160to je proizvod jednostavniji, opis je kra\u0107i. Slo\u017eeni proizvodi (npr. elektronika) zahtijevaju vi\u0161e obja\u0161njenja i tehni\u010dkih podataka.',
    },
    { key: 'service', label: 'Stranica usluge', minWords: 500, maxWords: 1500, description: 'Jednostavna lokalna usluga zahtijeva manje rije\u010di. Vi\u0161efazna ponuda zahtijeva vi\u0161e.' },
    {
      key: 'homepage',
      label: 'Po\u010detna stranica',
      minWords: 400,
      maxWords: 1000,
      description: 'Po\u010detna stranica usmjerava posjetitelje na podstranice. Jasna poruka i \u010ditljiva struktura olak\u0161avaju navigaciju.',
    },
    {
      key: 'landing',
      label: 'Odredi\u0161na stranica',
      minWords: 600,
      maxWords: 2500,
      description: 'Skuplja ponuda zahtijeva vi\u0161e obja\u0161njenja i izgradnje povjerenja. Jednostavna ponuda mo\u017ee biti kra\u0107a.',
    },
    {
      key: 'blog',
      label: 'Blog objava',
      minWords: 1200,
      maxWords: 3000,
      description: 'Duljina ovisi o slo\u017eenosti teme. Tekst bi trebao temeljito i konkretno odgovoriti na pitanja \u010ditatelja.',
    },
    { key: 'guide', label: 'Vodi\u010d / upute', minWords: 2500, maxWords: 6000, description: 'Detaljan pregled teme s mnogih aspekata. Duljina ovisi o opsegu teme.' },
  ],
  lt: [
    {
      key: 'product',
      ...
      minWords: 80,
      maxWords: 400,
      description: 'Kuo paprastesnis produktas, tuo trumpesnis apra\u0161ymas. Sud\u0117tingi produktai (pvz. elektronika) reikalauja daugiau paai\u0161kinim\u0173 ir technini\u0173 duomen\u0173.',
    },
    {
      key: 'service',
      label: 'Paslaugos puslapis',
      minWords: 500,
      maxWords: 1500,
      description: 'Paprasta vietin\u0117 paslauga reikalauja ma\u017eiau \u017eod\u017ei\u0173. Daugiapakop\u0117 pasi\u016blymas reikalauja daugiau.',
    },
    {
      key: 'homepage',
      ...
      minWords: 400,
      maxWords: 1000,
      description: 'Pagrindinis puslapis nukreipia lankytojus \u012f puslapius. Ai\u0161ki \u017einut\u0117 ir skaitoma strukt\u016bra palengvina navigacij\u0105.',
    },
    {
      key: 'landing',
      label: 'Nukreipimo puslapis',
      minWords: 600,
      maxWords: 2500,
      description: 'Brangesnis pasi\u016blymas reikalauja daugiau paai\u0161kinim\u0173 ir pasitik\u0117jimo k\u016brimo. Paprastas pasi\u016blymas gali b\u016bti trumpesnis.',
    },
    {
      key: 'blog',
      label: 'Tinklaras\u030ctio \u012fra\u0161as',
      minWords: 1200,
      maxWords: 3000,
      description: 'Ilgis priklauso nuo temos sud\u0117tingumo. Tekstas tur\u0117t\u0173 i\u0161samiai ir konkre\u010diai atsakyti \u012f skaitytojo klausimus.',
    },
    { key: 'guide', label: 'Vadovas / instrukcija', minWords: 2500, maxWords: 6000, description: 'I\u0161sami temos ap\u017evalga su daugybe aspekt\u0173. Ilgis priklauso nuo temos apimties.' },
  ],
  sl: [
    {
      key: 'product',
      ...
      minWords: 80,
      maxWords: 400,
      description: '\u010cim enostavnej\u0161i je izdelek, tem kraj\u0161i je opis. Kompleksni izdelki (npr. elektronika) zahtevajo ve\u010d pojasnil in tehni\u010dnih podatkov.',
    },
    { key: 'service', label: 'Stran storitve', minWords: 500, maxWords: 1500, description: 'Enostavna lokalna storitev zahteva manj besed. Ve\u010dfazna ponudba zahteva ve\u010d.' },
    {
      key: 'homepage',
      label: 'Za\u010detna stran',
      minWords: 400,
      maxWords: 1000,
      description: 'Za\u010detna stran usmerja obiskovalce na podstrani. Jasno sporo\u010dilo in berljiva struktura olaj\u0161ata navigacijo.',
    },
    {
      key: 'landing',
      label: 'Pristajalna stran',
      minWords: 600,
      maxWords: 2500,
      description: 'Dra\u017eja ponudba zahteva ve\u010d pojasnil in gradnje zaupanja. Enostavna ponudba je lahko kraj\u0161a.',
    },
    {
      key: 'blog',
      label: 'Blog objava',
      minWords: 1200,
      maxWords: 3000,
      description: 'Dol\u017eina je odvisna od zahtevnosti teme. Besedilo naj bi temeljito in konkretno odgovorilo na vpra\u0161anja bralca.',
    },
    { key: 'guide', label: 'Vodnik / navodila', minWords: 2500, maxWords: 6000, description: 'Podroben pregled teme z ve\u010d vidikov. Dol\u017eina je odvisna od obsega teme.' },
  ],
};
...
const EVAL_UI: Record<Locale, EvalUi> = {
  ...
  no: {
    ...
    tooShort: (min, unit, missing) => `Teksten er under det estimerte minimum (${min} ${unit}). Hvis emnet er dekket, kan det være tilstrekkelig. Det mangler ca. ${missing} ${unit}.`,
    tooLong: (excess, unit) => `Teksten overskrider det estimerte maksimum med ${excess} ${unit}. Hvis hver setning tilfører verdi, er lengden berettiget.`,
    idealInRange: 'Lengden er innenfor det anbefalte intervallet. Verdien for leseren er avgjørende: intervallene fungerer som referanse.',
    idealGoodLength: (label) => `God lengde for ${label.toLowerCase()}. Hvert avsnitt bør tilby konkret verdi til leseren.`,
    readingTime: (m) => (m === 1 ? '1 minutt' : `${m} minutter`),
    report: {
      title: '\ud83d\udcca RAPPORT TEKSTLENGDE',
      pageType: 'Sidetype',
    ...
    tooShort: (min, unit, missing) => `Teksti on alle arvioidun minimin (${min} ${unit}). Jos aihe on katettu, se voi riitt\u00e4\u00e4. Puuttuu n. ${missing} ${unit}.`,
    tooLong: (excess, unit) => `Teksti ylitt\u00e4\u00e4 arvioidun maksimin ${excess} ${unit}. Jos jokainen lause tuo arvoa, pituus on perusteltu.`,
    idealInRange: 'Pituus on suositellulla v\u00e4lill\u00e4. Lukijalle tuotettu arvo on ratkaiseva: v\u00e4lit toimivat viitearvoina.',
    idealGoodLength: (label) => `Hyv\u00e4 pituus sivutyypille ${label.toLowerCase()}. Jokaisen kappaleen tulisi tarjota konkreettista arvoa lukijalle.`,
    readingTime: (m) => (m === 1 ? '1 minuutti' : `${m} minuuttia`),
    report: {
      title: '\ud83d\udcca TEKSTIN PITUUSRAPORTTI',
      pageType: 'Sivutyyppi',
      range: 'Suositeltu v\u00e4li',
      statistics: '\ud83d\udcdd TILASTOT:',
      words: 'Sanat',
  ...
  sk: {
    wordsUnit: 'slov',
    emptyMessage: 'Vlo\u017ete alebo nap\u00ed\u0161te text, aby ste videli anal\u00fdzu.',
    tooShort: (min, unit, missing) =>
      `Text je pod orienta\u010dn\u00fdm minimom (${min} ${unit}). Ak je t\u00e9ma vy\u010derpan\u00e1, m\u00f4\u017ee to sta\u010di\u0165. Ch\u00fdba pribli\u017ene ${missing} ${unit}.`,
    tooLong: (excess, unit) => `Text presahuje orienta\u010dn\u00e9 maximum o ${excess} ${unit}. Ak ka\u017ed\u00e1 veta prin\u00e1\u0161a hodnotu, d\u013a\u017eka je od\u00f4vodnen\u00e1.`,
    idealInRange: 'D\u013a\u017eka je v odpor\u00fa\u010danom rozsahu. K\u013e\u00fa\u010dov\u00e1 je hodnota pre \u010ditate\u013ea; rozsahy sl\u00fa\u017eia ako orient\u00e1cia.',
    idealGoodLength: (label) => `Dobr\u00e1 d\u013a\u017eka pre ${label.toLowerCase()}. Ka\u017ed\u00fd odsek by mal prin\u00e1\u0161a\u0165 konkr\u00e9tnu hodnotu pre \u010ditate\u013ea.`,
    readingTime: (m) => (m === 1 ? '1 min\u00fata' : m >= 2 && m <= 4 ? `${m} min\u00faty` : `${m} min\u00fat`),
    report: {
      title: '\ud83d\udcca SPR\u00c1VA O D\u013d\u017dKE TEXTU',
      pageType: 'Typ str\u00e1nky',
      ...
      statusShort: '\u26a0\ufe0f Pr\u00edli\u0161 kr\u00e1tke',
      statusLong: '\u26a0\ufe0f Pr\u00edli\u0161 dlh\u00e9',
      generatedBy: 'Vygeneroval: arteonagency.pl/sk/nastroje/pocitadlo-slov-a-znakov',
    },
  },
  hr: {
    wordsUnit: 'rije\u010di',
    emptyMessage: 'Zalijepite ili upi\u0161ite tekst da biste vidjeli analizu.',
    tooShort: (min, unit, missing) => `Tekst je ispod okvirnog minimuma (${min} ${unit}). Ako je tema iscrpljena, to mo\u017ee biti dovoljno. Nedostaje oko ${missing} ${unit}.`,
    tooLong: (excess, unit) => `Tekst prema\u0161uje okvirni maksimum za ${excess} ${unit}. Ako svaka re\u010denica donosi vrijednost, duljina je opravdana.`,
    idealInRange: 'Duljina je u preporu\u010denom rasponu. Klju\u010dna je vrijednost za \u010ditatelja; rasponi slu\u017ee kao smjernica.',
    idealGoodLength: (label) => `Dobra duljina za ${label.toLowerCase()}. Svaki odlomak trebao bi donositi konkretnu vrijednost \u010ditatelju.`,
    ...
    report: {
      ...
      generatedBy: 'Generirao: arteonagency.pl/hr/alati/brojac-rijeci-i-znakova',
    },
  },
  lt: {
    wordsUnit: '\u017eod\u017ei\u0173',
    emptyMessage: '\u012eklijuokite arba \u012fveskite tekst\u0105, kad pamatytum\u0117te analiz\u0119.',
    tooShort: (min, unit, missing) => `Tekstas yra \u017eemiau orientacinio minimumo (${min} ${unit}). Jei tema i\u0161semta, to gali u\u017etekti. Tr\u016bksta apie ${missing} ${unit}.`,
    tooLong: (excess, unit) => `Tekstas vir\u0161ija orientacin\u012f maksimum\u0105 ${excess} ${unit}. Jei kiekvienas sakinys kuria vert\u0119, ilgis yra pateisinamas.`,
    idealInRange: 'Ilgis yra rekomenduojamame diapazone. Vert\u0117 skaitytojui yra esmin\u0117: diapazonai yra orientaciniai.',
    idealGoodLength: (label) => `Geras ilgis tipui ${label.toLowerCase()}. Kiekviena pastraipa tur\u0117t\u0173 teikti konkre\u010di\u0105 vert\u0119 skaitytojui.`,
  ...
  sl: {
    wordsUnit: 'besed',
    emptyMessage: 'Prilepite ali vnesite besedilo, da vidite analizo.',
    tooShort: (min, unit, missing) => `Besedilo je pod orientacijskim minimumom (${min} ${unit}). \u010ce je tema iz\u010drpana, je to lahko dovolj. Manjka pribli\u017eno ${missing} ${unit}.`,
    tooLong: (excess, unit) => `Besedilo presega orientacijski maksimum za ${excess} ${unit}. \u010ce vsak stavek prina\u0161a vrednost, je dol\u017eina upravi\u010dena.`,
    idealInRange: 'Dol\u017eina je v priporo\u010denem obsegu. Klju\u010dna je vrednost za bralca; obsegi slu\u017eijo kot orientacija.',
    idealGoodLength: (label) => `Dobra dol\u017eina za ${label.toLowerCase()}. Vsak odstavek naj bi prina\u0161al konkretno vrednost bralcu.`,
    readingTime: (m) => (m === 1 ? '1 minuta' : m === 2 ? '2 minuti' : m >= 3 && m <= 4 ? `${m} minute` : `${m} minut`),
    report: {
      title: '\ud83d\udcca PORO\u010cILO O DOL\u017dINI BESEDILA',
      pageType: 'Tip strani',
      range: 'Priporo\u010den obseg',
      statistics: '\ud83d\udcdd STATISTIKE:',
      words: 'Besede',
      ...
      generatedBy: 'Ustvaril: arteonagency.pl/sl/orodja/stevec-besed-in-znakov',
    },
  },
};
