...
export const TOOL_REGISTRY: ToolDefinition[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    locales: {
      ...
      de: { slug: 'svg-zu-webp-konverter', title: 'SVG zu WebP Konverter', description: 'SVG-Vektorgrafiken in leichtes WebP umwandeln. Ideal fur Websites und Social Media.' },
      ...
      ro: { slug: 'convertor-svg-in-webp', title: 'Convertor SVG in WebP', description: 'Converteste grafice SVG in WebP usor. Ideal pentru site-uri si retele sociale.' },
      ...
      hu: { slug: 'svg-webp-konverter', title: 'SVG WebP konverter', description: 'SVG grafika konvertalasa konnyu WebP-re. Idealis weboldalakon es kozossegi mediaban.' },
      cs: { slug: 'prevodnik-svg-na-webp', title: 'Převodník SVG na WebP', description: 'Prevedte grafiku SVG na lehke WebP. Idealni pro weby a socialni site.' },
      sv: { slug: 'svg-till-webp-konverterare', title: 'SVG till WebP-konverterare', description: 'Konvertera SVG-grafik till lattvikts-WebP. Idealiskt for webbplatser och sociala medier.' },
      ...
      el: { slug: 'metatropeas-svg-se-webp', title: 'Μετατροπέας SVG σε WebP', description: 'Μετατρεψτε γραφικα SVG σε ελαφρυ WebP. Ιδανικο για ιστοσελιδες και κοινωνικα δικτυα.' },
    },
  },
  {
    key: 'gifToWebp',
    ...
    locales: {
      ...
      fr: { slug: 'convertisseur-gif-en-webp', title: 'Convertisseur GIF en WebP', description: 'Exportez la premiere image GIF en WebP leger. Fichier plus petit, chargement plus rapide.' },
      ...
      it: { slug: 'convertitore-gif-in-webp', title: 'Convertitore GIF in WebP', description: 'Esporta il primo fotogramma GIF in WebP leggero. File piu piccolo, caricamento rapido.' },
      ...
      cs: { slug: 'prevodnik-gif-na-webp', title: 'Převodník GIF na WebP', description: 'Exportujte prvni snimek GIFu jako lehke WebP. Mensi soubor, rychlejsi nacitani.' },
      sv: { slug: 'gif-till-webp-konverterare', title: 'GIF till WebP-konverterare', description: 'Exportera forsta GIF-bildrutan som lattvikts-WebP. Mindre fil, snabbare laddning.' },
  ...
  },
  {
    ...
    locales: {
      ...
      de: { slug: 'bmp-zu-webp-konverter', title: 'BMP zu WebP Konverter', description: 'Unkomprimierte BMP-Dateien in leichtes WebP umwandeln. Bis zu 95% Grossenreduktion.' },
      pt: { slug: 'conversor-bmp-para-webp', title: 'Conversor BMP para WebP', description: 'Converta ficheiros BMP para WebP leve. Reducao de tamanho ate 95%.' },
      ...
      ro: { slug: 'convertor-bmp-in-webp', title: 'Convertor BMP in WebP', description: 'Converteste fisiere BMP in WebP usor. Reducere de pana la 95%.' },
      ...
      hu: { slug: 'bmp-webp-konverter', title: 'BMP WebP konverter', description: 'BMP fajlok konvertalasa konnyu WebP-re. Akar 95%-os meretcsokkentes.' },
      cs: { slug: 'prevodnik-bmp-na-webp', title: 'Převodník BMP na WebP', description: 'Prevedte soubory BMP na lehke WebP. Snizeni velikosti az o 95%.' },
      ...
      el: { slug: 'metatropeas-bmp-se-webp', title: 'Μετατροπέας BMP σε WebP', description: 'Μετατρεψτε αρχεια BMP σε ελαφρυ WebP. Μειωση μεγεθους εως 95%.' },
    },
  },
  // -------------------------------------------------------------------------
  ...
  // -------------------------------------------------------------------------
  {
    ...
    locales: {
      ...
      ro: { slug: 'convertor-avif-in-jpg', title: 'Convertor AVIF in JPG', description: 'Converteste fisiere AVIF in JPG universal. Compatibil cu orice program si platforma.' },
      ...
      hu: { slug: 'avif-jpg-konverter', title: 'AVIF JPG konverter', description: 'AVIF fajlok konvertalasa univerzalis JPG-re. Kompatibilis minden programmal.' },
      cs: { slug: 'prevodnik-avif-na-jpg', title: 'Převodník AVIF na JPG', description: 'Prevedte soubory AVIF na univerzalni JPG. Kompatibilni s kazdym programem.' },
      ...
      el: { slug: 'metatropeas-avif-se-jpg', title: 'Μετατροπέας AVIF σε JPG', description: 'Μετατρεψτε αρχεια AVIF σε καθολικο JPG. Συμβατο με καθε προγραμμα και πλατφορμα.' },
    },
  },
  {
    key: 'avifToPng',
    ...
    locales: {
      ...
      es: { slug: 'convertidor-avif-a-png', title: 'Convertidor AVIF a PNG', description: 'Convierte archivos AVIF a PNG sin perdidas. Conserva calidad y transparencia.' },
      ...
      de: { slug: 'avif-zu-png-konverter', title: 'AVIF zu PNG Konverter', description: 'AVIF-Dateien in verlustfreies PNG umwandeln. Volle Qualitat und Transparenz erhalten.' },
      pt: { slug: 'conversor-avif-para-png', title: 'Conversor AVIF para PNG', description: 'Converta ficheiros AVIF para PNG sem perdas. Qualidade e transparencia preservadas.' },
      ...
      ro: { slug: 'convertor-avif-in-png', title: 'Convertor AVIF in PNG', description: 'Converteste fisiere AVIF in PNG fara pierderi. Calitate si transparenta pastrate.' },
      ...
      hu: { slug: 'avif-png-konverter', title: 'AVIF PNG konverter', description: 'AVIF fajlok konvertalasa vesztesgmentes PNG-re. Teljes minoseg es atlatszosag megorzese.' },
      cs: { slug: 'prevodnik-avif-na-png', title: 'Převodník AVIF na PNG', description: 'Prevedte soubory AVIF na bezztratove PNG. Zachovani plne kvality a pruhlednosti.' },
      sv: { slug: 'avif-till-png-konverterare', title: 'AVIF till PNG-konverterare', description: 'Konvertera AVIF-filer till forlustfri PNG. Behall full kvalitet och transparens.' },
      ...
      el: { slug: 'metatropeas-avif-se-png', title: 'Μετατροπέας AVIF σε PNG', description: 'Μετατρεψτε αρχεια AVIF σε PNG χωρις απωλειες. Διατηρηση πληρους ποιοτητας.' },
    },
  },
  {
    key: 'avifToWebp',
    ...
    locales: {
      ...
      it: { slug: 'convertitore-avif-in-webp', title: 'Convertitore AVIF in WebP', description: 'Converti file AVIF in WebP. Ampia compatibilita con dimensioni ridotte.' },
      ro: { slug: 'convertor-avif-in-webp', title: 'Convertor AVIF in WebP', description: 'Converteste fisiere AVIF in WebP. Compatibilitate larga la dimensiuni mici.' },
      ...
      hu: { slug: 'avif-webp-konverter', title: 'AVIF WebP konverter', description: 'AVIF fajlok konvertalasa WebP-re. Szeles kompatibilitas kis fajlmerettel.' },
      cs: { slug: 'prevodnik-avif-na-webp', title: 'Převodník AVIF na WebP', description: 'Prevedte soubory AVIF na WebP. Siroka kompatibilita pri male velikosti.' },
      ...
      el: { slug: 'metatropeas-avif-se-webp', title: 'Μετατροπέας AVIF σε WebP', description: 'Μετατρεψτε αρχεια AVIF σε WebP. Ευρεια συμβατοτητα με μικρο μεγεθος.' },
    },
  },
  // -------------------------------------------------------------------------
  ...
  // -------------------------------------------------------------------------
  {
    ...
    locales: {
      ...
      ro: { slug: 'convertor-heic-in-jpg', title: 'Convertor HEIC in JPG', description: 'Converteste fotografii HEIC de pe iPhone in JPG universal. Fara inregistrare, fara upload.' },
      ...
      hu: { slug: 'heic-jpg-konverter', title: 'HEIC JPG konverter', description: 'iPhone HEIC fotok konvertalasa univerzalis JPG-re. Regisztracio nelkul, szerverre kuldes nelkul.' },
      cs: { slug: 'prevodnik-heic-na-jpg', title: 'Převodník HEIC na JPG', description: 'Prevedte fotky HEIC z iPhonu na univerzalni JPG. Bez registrace, bez nahravani na server.' },
      ...
      el: { slug: 'metatropeas-heic-se-jpg', title: 'Μετατροπέας HEIC σε JPG', description: 'Μετατρεψτε φωτογραφιες HEIC απο iPhone σε JPG. Χωρις εγγραφη, χωρις αποστολη στο server.' },
    },
  },
  {
    key: 'heicToPng',
    ...
    locales: {
      ...
      es: { slug: 'convertidor-heic-a-png', title: 'Convertidor HEIC a PNG', description: 'Convierte fotos HEIC de iPhone a PNG sin perdidas. Calidad y transparencia completas.' },
      ...
      de: { slug: 'heic-zu-png-konverter', title: 'HEIC zu PNG Konverter', description: 'iPhone HEIC-Fotos in verlustfreies PNG umwandeln. Volle Qualitat und Transparenz.' },
      pt: { slug: 'conversor-heic-para-png', title: 'Conversor HEIC para PNG', description: 'Converta fotos HEIC do iPhone para PNG sem perdas. Qualidade e transparencia completas.' },
      ...
      ro: { slug: 'convertor-heic-in-png', title: 'Convertor HEIC in PNG', description: 'Converteste fotografii HEIC de pe iPhone in PNG fara pierderi. Calitate si transparenta.' },
      ...
      hu: { slug: 'heic-png-konverter', title: 'HEIC PNG konverter', description: 'iPhone HEIC fotok konvertalasa vesztesgmentes PNG-re. Teljes minoseg es atlatszosag.' },
      cs: { slug: 'prevodnik-heic-na-png', title: 'Převodník HEIC na PNG', description: 'Prevedte fotky HEIC z iPhonu na bezztratove PNG. Plna kvalita a pruhlednost.' },
      sv: { slug: 'heic-till-png-konverterare', title: 'HEIC till PNG-konverterare', description: 'Konvertera iPhone HEIC-foton till forlustfri PNG. Full kvalitet och transparens.' },
      ...
      el: { slug: 'metatropeas-heic-se-png', title: 'Μετατροπέας HEIC σε PNG', description: 'Μετατρεψτε φωτογραφιες HEIC απο iPhone σε PNG χωρις απωλειες. Πληρης ποιοτητα.' },
    },
  },
  {
    key: 'heicToWebp',
    ...
    locales: {
      ...
      ro: { slug: 'convertor-heic-in-webp', title: 'Convertor HEIC in WebP', description: 'Converteste fotografii HEIC de pe iPhone in WebP usor. Dimensiuni mai mici.' },
      ...
      hu: { slug: 'heic-webp-konverter', title: 'HEIC WebP konverter', description: 'iPhone HEIC fotok konvertalasa konnyu WebP-re. Kisebb meret, gyorsabb betoltes.' },
      cs: { slug: 'prevodnik-heic-na-webp', title: 'Převodník HEIC na WebP', description: 'Prevedte fotky HEIC z iPhonu na lehke WebP. Mensi velikost, rychlejsi nacitani.' },
      ...
      el: { slug: 'metatropeas-heic-se-webp', title: 'Μετατροπέας HEIC σε WebP', description: 'Μετατρεψτε φωτογραφιες HEIC απο iPhone σε ελαφρυ WebP. Μικροτερο μεγεθος.' },
    },
  },
  // -------------------------------------------------------------------------
  ...
  // -------------------------------------------------------------------------
  {
    ...
    locales: {
      ...
      de: { slug: 'tiff-zu-jpg-konverter', title: 'TIFF zu JPG Konverter', description: 'TIFF-Dateien in kompaktes JPG umwandeln. Ideal fur Scans, Dokumente und Fotoarchive.' },
      ...
      ro: { slug: 'convertor-tiff-in-jpg', title: 'Convertor TIFF in JPG', description: 'Converteste fisiere TIFF in JPG compact. Ideal pentru scanari si arhive foto.' },
      ...
      hu: { slug: 'tiff-jpg-konverter', title: 'TIFF JPG konverter', description: 'TIFF fajlok konvertalasa kompakt JPG-re. Idealis szkenekhez es fotoarchivumokhoz.' },
      cs: { slug: 'prevodnik-tiff-na-jpg', title: 'Převodník TIFF na JPG', description: 'Prevedte soubory TIFF na kompaktni JPG. Idealni pro skeny a fotoarchivy.' },
      sv: { slug: 'tiff-till-jpg-konverterare', title: 'TIFF till JPG-konverterare', description: 'Konvertera TIFF-filer till kompakt JPG. Idealiskt for skanningar och fotoarkiv.' },
      ...
      el: { slug: 'metatropeas-tiff-se-jpg', title: 'Μετατροπέας TIFF σε JPG', description: 'Μετατρεψτε αρχεια TIFF σε συμπαγες JPG. Ιδανικο για σαρωσεις και αρχεια φωτογραφιων.' },
    },
  },
  {
    key: 'tiffToPng',
    ...
    locales: {
      ...
      es: { slug: 'convertidor-tiff-a-png', title: 'Convertidor TIFF a PNG', description: 'Convierte archivos TIFF a PNG sin perdidas. Conserva la calidad de escaneos y graficos.' },
      ...
      de: { slug: 'tiff-zu-png-konverter', title: 'TIFF zu PNG Konverter', description: 'TIFF-Dateien in verlustfreies PNG umwandeln. Volle Qualitat von Scans erhalten.' },
      ...
      it: { slug: 'convertitore-tiff-in-png', title: 'Convertitore TIFF in PNG', description: 'Converti file TIFF in PNG lossless. Preserva la qualita di scansioni e grafiche.' },
      ro: { slug: 'convertor-tiff-in-png', title: 'Convertor TIFF in PNG', description: 'Converteste fisiere TIFF in PNG fara pierderi. Pastreaza calitatea scanarilor.' },
      ...
      hu: { slug: 'tiff-png-konverter', title: 'TIFF PNG konverter', description: 'TIFF fajlok konvertalasa vesztesgmentes PNG-re. Szkenek teljes minosege megorzese.' },
      cs: { slug: 'prevodnik-tiff-na-png', title: 'Převodník TIFF na PNG', description: 'Prevedte soubory TIFF na bezztratove PNG. Zachovejte plnou kvalitu skenu.' },
      sv: { slug: 'tiff-till-png-konverterare', title: 'TIFF till PNG-konverterare', description: 'Konvertera TIFF-filer till forlustfri PNG. Behall full kvalitet pa skanningar.' },
      ...
      el: { slug: 'metatropeas-tiff-se-png', title: 'Μετατροπέας TIFF σε PNG', description: 'Μετατρεψτε αρχεια TIFF σε PNG χωρις απωλειες. Διατηρηση ποιοτητας σαρωσεων.' },
    },
  },
  {
    key: 'tiffToWebp',
    ...
    locales: {
      ...
      de: { slug: 'tiff-zu-webp-konverter', title: 'TIFF zu WebP Konverter', description: 'TIFF-Dateien in leichtes WebP umwandeln. Massive Grossenreduktion bei erhaltener Qualitat.' },
      ...
      it: { slug: 'convertitore-tiff-in-webp', title: 'Convertitore TIFF in WebP', description: 'Converti file TIFF in WebP leggero. Enorme riduzione con qualita preservata.' },
      ro: { slug: 'convertor-tiff-in-webp', title: 'Convertor TIFF in WebP', description: 'Converteste fisiere TIFF in WebP usor. Reducere masiva cu calitate pastrata.' },
      ...
      hu: { slug: 'tiff-webp-konverter', title: 'TIFF WebP konverter', description: 'TIFF fajlok konvertalasa konnyu WebP-re. Hatalmas meretcsokkentes minoseg megorzesevel.' },
      cs: { slug: 'prevodnik-tiff-na-webp', title: 'Převodník TIFF na WebP', description: 'Prevedte soubory TIFF na lehke WebP. Masivni snizeni velikosti se zachovanim kvality.' },
      ...
      el: { slug: 'metatropeas-tiff-se-webp', title: 'Μετατροπέας TIFF σε WebP', description: 'Μετατρεψτε αρχεια TIFF σε ελαφρυ WebP. Τεραστια μειωση μεγεθους με διατηρηση ποιοτητας.' },
    },
  },
  {
    key: 'jpgToAvif',
