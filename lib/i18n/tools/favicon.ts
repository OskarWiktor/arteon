...
import id from '@/data/id/tools-ui/favicon.json';
import vi from '@/data/vi/tools-ui/favicon.json';
import tr from '@/data/tr/tools-ui/favicon.json';
import tl from '@/data/tl/tools-ui/favicon.json';
import sw from '@/data/sw/tools-ui/favicon.json';
import ms from '@/data/ms/tools-ui/favicon.json';
...
import ha from '@/data/ha/tools-ui/favicon.json';
import yo from '@/data/yo/tools-ui/favicon.json';
...
import hi from '@/data/hi/tools-ui/favicon.json';
import bn from '@/data/bn/tools-ui/favicon.json';
