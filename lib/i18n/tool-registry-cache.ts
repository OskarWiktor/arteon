...
export const getToolSectionByKey = cache(async (key: string): Promise<ToolsSectionDefinition | undefined> => {
  'use cache';
...
export const getLocalizedToolSection = cache(async (key: string, locale: Locale): Promise<ToolsSectionLocaleText | undefined> => {
  'use cache';
