...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    const redirects = [
      ...
      { source: '/edukacja/design', destination: '/edukacja/grafika', permanent: true },
      { source: '/edukacja/design/:path*', destination: '/edukacja/grafika/:path*', permanent: true },
      { source: '/edukacja/psychologia/jak-kolorystyka-wplywa-na-decyzje-zakupowe-klientow', destination: '/edukacja/grafika/jak-kolorystyka-wplywa-na-decyzje-zakupowe-klientow', permanent: true },
      {
      ...
      { source: '/edukacja/branding/jak-identyfikacja-wizualna-zwieksza-zaufanie-klientow', destination: '/edukacja/grafika/jak-identyfikacja-wizualna-zwieksza-zaufanie-klientow', permanent: true },
      {
